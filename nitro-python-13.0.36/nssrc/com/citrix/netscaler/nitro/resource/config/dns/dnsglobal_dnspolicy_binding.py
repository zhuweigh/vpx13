...
class dnsglobal_dnspolicy_binding(base_resource) :
	...
	@property
	def priority(self) :
		r"""Specifies the priority of the policy with which it is bound. Maximum allowed priority should be less than 65535.
		"""
		try :
	...
	@property
	def type(self) :
		r"""Type of global bind point for which to show bound policies.<br/>Possible values = REQ_OVERRIDE, REQ_DEFAULT, RES_OVERRIDE, RES_DEFAULT.
		"""
		try :
			return self._type
		except Exception as e:
	...
	@classmethod
	def get(cls, service) :
		r""" Use this API to fetch a dnsglobal_dnspolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		r""" Use this API to fetch filtered set of dnsglobal_dnspolicy_binding resources.
	...
	def count(cls, service) :
		r""" Use this API to count dnsglobal_dnspolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = dnsglobal_dnspolicy_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		r""" Use this API to count the filtered set of dnsglobal_dnspolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = dnsglobal_dnspolicy_binding()
