...
class sslcipher_individualcipher_binding(base_resource) :
	...
	def get(cls, service, ciphergroupname="", option_="") :
		r""" Use this API to fetch sslcipher_individualcipher_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, ciphergroupname, filter_) :
		r""" Use this API to fetch filtered set of sslcipher_individualcipher_binding resources.
	...
	def count(cls, service, ciphergroupname) :
		r""" Use this API to count sslcipher_individualcipher_binding resources configued on NetScaler.
		"""
		try :
			obj = sslcipher_individualcipher_binding()
			obj.ciphergroupname = ciphergroupname
	...
	def count_filtered(cls, service, ciphergroupname, filter_) :
		r""" Use this API to count the filtered set of sslcipher_individualcipher_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslcipher_individualcipher_binding()
