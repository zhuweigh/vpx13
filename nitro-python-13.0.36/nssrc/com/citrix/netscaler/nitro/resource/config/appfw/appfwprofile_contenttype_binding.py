...
class appfwprofile_contenttype_binding(base_resource) :
	...
	def contenttype(self) :
		r"""A regular expression that designates a content-type on the content-types list.
		"""
		try :
	...
	def add(cls, client, resource) :
		try :
			if resource and type(resource) is not list :
				...
				updateresource.contenttype = resource.contenttype
	...
	def get(cls, service, name="", option_="") :
		r""" Use this API to fetch appfwprofile_contenttype_binding resources.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, service, name, filter_) :
		r""" Use this API to fetch filtered set of appfwprofile_contenttype_binding resources.
	...
	def count(cls, service, name) :
		r""" Use this API to count appfwprofile_contenttype_binding resources configued on NetScaler.
		"""
		try :
			obj = appfwprofile_contenttype_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		r""" Use this API to count the filtered set of appfwprofile_contenttype_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appfwprofile_contenttype_binding()
...
class appfwprofile_contenttype_binding_response(base_response) :
	def __init__(self, length=1) :
		...
		self.severity = ""
		self.sessionid = ""
		self.appfwprofile_contenttype_binding = [appfwprofile_contenttype_binding() for _ in range(length)]
