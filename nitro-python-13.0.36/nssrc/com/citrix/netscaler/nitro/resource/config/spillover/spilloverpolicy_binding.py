...
class spilloverpolicy_binding(base_resource):
	...
	def spilloverpolicy_csvserver_bindings(self) :
		r"""csvserver that can be bound to spilloverpolicy.
		"""
		try :
	...
	def spilloverpolicy_lbvserver_bindings(self) :
		r"""lbvserver that can be bound to spilloverpolicy.
		"""
		try :
	...
	def spilloverpolicy_gslbvserver_bindings(self) :
		r"""gslbvserver that can be bound to spilloverpolicy.
		"""
		try :
	...
	def get(self, service, name="", option_="") :
		r""" Use this API to fetch spilloverpolicy_binding resource.
		"""
		try :
			if not name :
