...
class lldpneighbors(base_resource) :
	...
	def __init__(self) :
		self._ifnum = None
		self._nodeid = None
		self._chassisidsubtype = None
		self._chassisid = None
		self._portidsubtype = None
		self._portid = None
		self._ttl = None
		self._portdescription = None
		self._sys = None
		self._sysdesc = None
		self._mgmtaddresssubtype = None
		self._mgmtaddress = None
		self._iftype = None
		self._ifnumber = None
		self._vlan = None
		self._vlanid = None
		self._portprotosupported = None
		self._portprotoenabled = None
		self._portprotoid = None
		self._portvlanid = None
		self._protocolid = None
		self._linkaggrcapable = None
		self._linkaggrenabled = None
		self._linkaggrid = None
		self._flag = None
		self._syscapabilities = None
		self._syscapenabled = None
		self._autonegsupport = None
		self._autonegenabled = None
		self._autonegadvertised = None
		self._autonegmautype = None
		self._mtu = None
		self.___count = None
	...
	def chassisidsubtype(self) :
		r"""Chassis id sub type.<br/>Possible values = NONE, Component, Interface Alias, Port Component, MAC Address, Network Address, Interface Name, Locally Assigned.
		"""
		try :
	...
	def portidsubtype(self) :
		r"""Port id subtype.<br/>Possible values = NONE, Interface Alias, Port Component, MAC Address, Network Address, Interface Name, Agent Circuit ID, Locally Assigned.
		"""
		try :
	...
	def mgmtaddresssubtype(self) :
		r"""Management Address Type.<br/>Possible values = OTHER, IPv4, IPv6.
		"""
		try :
	...
	@property
	def iftype(self) :
		r"""Interface subtype.<br/>Possible values = UNKNOWN, ifIndex, system port number.
		"""
		try :
			return self._iftype
		except Exception as e:
	...
	def portprotosupported(self) :
		r"""Flag to show Port Protocol Support.
		"""
		try :
	...
	def portprotoenabled(self) :
		r"""Flag to show Port Protocol support enabled.
		"""
		try :
	...
	def linkaggrcapable(self) :
		r"""Is neighbor Link Aggregation Capable.<br/>Possible values = NO, YES.
		"""
		try :
	...
	def linkaggrenabled(self) :
		r"""Is link aggregation Enabled.<br/>Possible values = NO, YES.
		"""
		try :
	...
	def syscapabilities(self) :
		r"""Acronyms for remote system capabilities:
		OT : Other.
	...
	def syscapenabled(self) :
		r"""Acronyms for remote system enabled capabilities:
		OT : Other.
		RE : Repeater(IETF RFC 2108).
		BR : MAC Bridge(IEEE Std 802.1D).
		WL : WLAN Access Point(IEEE Std 802.11 MIB).
	...
	def autonegsupport(self) :
		r"""MAC/PHY autonegotiation support.<br/>Possible values = NO, YES.
		"""
		try :
	...
	def autonegenabled(self) :
		r"""MAC/PHY autonegotiation enabled.<br/>Possible values = NO, YES.
		"""
		try :
	...
	def autonegadvertised(self) :
		r"""MAC/PHY autonegotiation advetised.
		"""
		try :
	...
	def autonegmautype(self) :
		r"""MAC/PHY Medium Attachment Unit (MAU) type of the port. Description listed below:
	...
	def clear(cls, client, resource="") :
		r""" Use this API to clear lldpneighbors.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the lldpneighbors resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = lldpneighbors()
	...
	def get_args(cls, client, args) :
		r""" Use this API to fetch all the lldpneighbors resources that are configured on netscaler.
	# This uses lldpneighbors_args which is a way to provide additional arguments while fetching the resources.
		"""
		try :
			obj = lldpneighbors()
			option_ = options()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of lldpneighbors resources.
	...
	def count(cls, client) :
		r""" Use this API to count the lldpneighbors resources configured on NetScaler.
		"""
		try :
			obj = lldpneighbors()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of lldpneighbors resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = lldpneighbors()
