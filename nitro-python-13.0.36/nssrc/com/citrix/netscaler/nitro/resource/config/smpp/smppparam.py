...
class smppparam(base_resource) :
	...
	def msgqueuesize(self) :
		r"""Maximum number of SMPP messages that can be queued. After the limit is reached, the Citrix ADC sends a deliver_sm_resp PDU, with an appropriate error message, to the message center.<br/>Default value: 10000.
		"""
		try :
