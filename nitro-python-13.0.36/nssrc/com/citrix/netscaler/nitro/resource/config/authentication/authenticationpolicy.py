...
class authenticationpolicy(base_resource) :
	...
	def __init__(self) :
		...
		self._policysubtype = None
		self.___count = None

	@property
	def name(self) :
		r"""Name for the advance AUTHENTICATION policy. 
	...
	@property
	def rule(self) :
		r"""Name of the Citrix ADC named rule, or an expression, that the policy uses to determine whether to attempt to authenticate the user with the AUTHENTICATION server.
		"""
		try :
			return self._rule
		except Exception as e:
	...
	@property
	def action(self) :
		r"""Name of the authentication action to be performed if the policy matches.
		"""
		try :
			return self._action
		except Exception as e:
	...
	@property
	def newname(self) :
		r"""New name for the authentication policy. Must begin with a letter, number, or the underscore character (_), and must contain only letters, numbers, and the hyphen (-), period (.) hash (#), space ( ), at (@), equals (=), colon (:), and underscore characters. 
		The following requirement applies only to the Citrix ADC CLI:
		If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my authentication policy" or 'my authentication policy').<br/>Minimum length =  1.
		"""
		try :
	...
	def policysubtype(self) :
		r""".<br/>Possible values = LOCAL, RADIUS, LDAP, TACACS, CERT, NEGOTIATE, SAML, PROFILE, DFA, SAMLIDP, WEBAUTH, OAUTH, NO_AUTHN, EPA, SFAUTH, AZUREVAULT, EMAIL, CAPTCHA.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add authenticationpolicy.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete authenticationpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update authenticationpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of authenticationpolicy resource.
	...
	def rename(cls, client, resource, new_name) :
		r""" Use this API to rename a authenticationpolicy resource.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the authenticationpolicy resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of authenticationpolicy resources.
	...
	def count(cls, client) :
		r""" Use this API to count the authenticationpolicy resources configured on NetScaler.
		"""
		try :
			obj = authenticationpolicy()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of authenticationpolicy resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = authenticationpolicy()
