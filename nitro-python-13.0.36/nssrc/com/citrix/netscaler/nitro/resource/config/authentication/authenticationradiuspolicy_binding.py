...
class authenticationradiuspolicy_binding(base_resource):
	...
	def authenticationradiuspolicy_systemglobal_bindings(self) :
		r"""systemglobal that can be bound to authenticationradiuspolicy.
		"""
		try :
	...
	def authenticationradiuspolicy_authenticationvserver_bindings(self) :
		r"""authenticationvserver that can be bound to authenticationradiuspolicy.
		"""
		try :
	...
	def authenticationradiuspolicy_vpnglobal_bindings(self) :
		r"""vpnglobal that can be bound to authenticationradiuspolicy.
		"""
		try :
	...
	def authenticationradiuspolicy_vpnvserver_bindings(self) :
		r"""vpnvserver that can be bound to authenticationradiuspolicy.
		"""
		try :
	...
	def get(self, service, name="", option_="") :
		r""" Use this API to fetch authenticationradiuspolicy_binding resource.
		"""
		try :
			if not name :
