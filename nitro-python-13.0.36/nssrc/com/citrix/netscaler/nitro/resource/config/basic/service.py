...
class service(base_resource) :
	...
	def __init__(self) :
		...
		self._contentinspectionprofilename = None
		self._hashid = None
		self._comment = None
	...
	@property
	def contentinspectionprofilename(self) :
		r"""Name of the ContentInspection profile that contains IPS/IDS communication related setting for the service.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
			return self._contentinspectionprofilename
		except Exception as e:
			raise e

	@contentinspectionprofilename.setter
	def contentinspectionprofilename(self, contentinspectionprofilename) :
		r"""Name of the ContentInspection profile that contains IPS/IDS communication related setting for the service.<br/>Minimum length =  1<br/>Maximum length =  127
		"""
		try :
			self._contentinspectionprofilename = contentinspectionprofilename
		except Exception as e:
			raise e
	...
	def add(cls, client, resource) :
		...
		try :
			if type(resource) is not list :
				...
				addresource.contentinspectionprofilename = resource.contentinspectionprofilename
				...
				if (resource and len(resource) > 0) :
					...
					for i in range(len(resource)) :
						...
						addresources[i].contentinspectionprofilename = resource[i].contentinspectionprofilename
	...
	def update(cls, client, resource) :
		...
		try :
			if type(resource) is not list :
				...
				updateresource.contentinspectionprofilename = resource.contentinspectionprofilename
				...
				if (resource and len(resource) > 0) :
					...
					for i in range(len(resource)) :
						...
						updateresources[i].contentinspectionprofilename = resource[i].contentinspectionprofilename
