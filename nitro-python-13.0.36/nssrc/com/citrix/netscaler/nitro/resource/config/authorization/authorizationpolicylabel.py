...
class authorizationpolicylabel(base_resource) :
	...
	@property
	def labelname(self) :
		r"""Name for the new authorization policy label. 
	...
	@property
	def flowtype(self) :
		r"""Flowtype of the bound authorization policy.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add authorizationpolicylabel.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete authorizationpolicylabel.
		"""
		try :
			if type(resource) is not list :
	...
	def rename(cls, client, resource, new_labelname) :
		r""" Use this API to rename a authorizationpolicylabel resource.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the authorizationpolicylabel resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of authorizationpolicylabel resources.
	...
	def count(cls, client) :
		r""" Use this API to count the authorizationpolicylabel resources configured on NetScaler.
		"""
		try :
			obj = authorizationpolicylabel()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of authorizationpolicylabel resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = authorizationpolicylabel()
