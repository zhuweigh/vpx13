...
class hanode_routemonitor6_binding(base_resource) :
	...
	def get(cls, service, id="", option_="") :
		r""" Use this API to fetch hanode_routemonitor6_binding resources.
		"""
		try :
			if not id :
	...
	def get_filtered(cls, service, id, filter_) :
		r""" Use this API to fetch filtered set of hanode_routemonitor6_binding resources.
	...
	def count(cls, service, id) :
		r""" Use this API to count hanode_routemonitor6_binding resources configued on NetScaler.
		"""
		try :
			obj = hanode_routemonitor6_binding()
			obj.id = id
	...
	def count_filtered(cls, service, id, filter_) :
		r""" Use this API to count the filtered set of hanode_routemonitor6_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = hanode_routemonitor6_binding()
