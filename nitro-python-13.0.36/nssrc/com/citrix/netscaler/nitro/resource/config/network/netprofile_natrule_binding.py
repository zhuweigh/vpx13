...
class netprofile_natrule_binding(base_resource) :
	...
	@property
	def natrule(self) :
		r"""IPv4 network address on whose traffic you want the Citrix ADC to do rewrite ip prefix.
		"""
		try :
	...
	def get(cls, service, name="", option_="") :
		r""" Use this API to fetch netprofile_natrule_binding resources.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, service, name, filter_) :
		r""" Use this API to fetch filtered set of netprofile_natrule_binding resources.
	...
	def count(cls, service, name) :
		r""" Use this API to count netprofile_natrule_binding resources configued on NetScaler.
		"""
		try :
			obj = netprofile_natrule_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		r""" Use this API to count the filtered set of netprofile_natrule_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = netprofile_natrule_binding()
