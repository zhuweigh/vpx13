...
class channel_binding(base_resource):
	...
	@property
	def id(self) :
		r"""ID of an LA channel or LA channel in cluster configuration whose details you want the Citrix ADC to display.
	...
	def channel_interface_bindings(self) :
		r"""interface that can be bound to channel.
		"""
		try :
	...
	def get(self, service, id="", option_="") :
		r""" Use this API to fetch channel_binding resource.
		"""
		try :
			if not id :
				obj = channel_binding()
