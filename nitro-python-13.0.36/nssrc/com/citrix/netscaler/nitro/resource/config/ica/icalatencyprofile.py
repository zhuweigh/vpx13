...
class icalatencyprofile(base_resource) :
	...
	def l7latencywaittime(self) :
		r"""L7 Latency Wait time. This is the time for which the Citrix ADC waits after the threshold is exceeded before it sends out a Notification to the Insight Center.<br/>Default value: 20<br/>Minimum length =  1<br/>Maximum length =  65535.
		"""
		try :
	...
	def l7latencynotifyinterval(self) :
		r"""L7 Latency Notify Interval. This is the interval at which the Citrix ADC sends out notifications to the Insight Center after the wait time has passed.<br/>Default value: 20<br/>Minimum length =  1<br/>Maximum length =  65535.
		"""
		try :
