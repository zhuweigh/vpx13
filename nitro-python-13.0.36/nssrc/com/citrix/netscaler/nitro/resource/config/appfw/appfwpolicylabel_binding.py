...
class appfwpolicylabel_binding(base_resource):
	...
	def appfwpolicylabel_appfwpolicy_bindings(self) :
		r"""appfwpolicy that can be bound to appfwpolicylabel.
		"""
		try :
	...
	def appfwpolicylabel_policybinding_bindings(self) :
		r"""policybinding that can be bound to appfwpolicylabel.
		"""
		try :
	...
	def get(self, service, labelname="", option_="") :
		r""" Use this API to fetch appfwpolicylabel_binding resource.
		"""
		try :
			if not labelname :
