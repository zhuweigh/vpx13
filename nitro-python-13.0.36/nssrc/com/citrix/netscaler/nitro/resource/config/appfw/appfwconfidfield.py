...
class appfwconfidfield(base_resource) :
	...
	@property
	def fieldname(self) :
		r"""Name of the form field to designate as confidential.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def url(self) :
		r"""URL of the web page that contains the web form.<br/>Minimum length =  1.
		"""
		try :
			return self._url
		except Exception as e:
	...
	@property
	def isregex(self) :
		r"""Method of specifying the form field name. Available settings function as follows:
	...
	@property
	def comment(self) :
		r"""Any comments to preserve information about the form field designation.
		"""
		try :
	...
	@property
	def state(self) :
		r"""Enable or disable the confidential field designation.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._state
		except Exception as e:
	...
	def add(cls, client, resource) :
		r""" Use this API to add appfwconfidfield.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete appfwconfidfield.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update appfwconfidfield.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of appfwconfidfield resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the appfwconfidfield resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of appfwconfidfield resources.
	...
	def count(cls, client) :
		r""" Use this API to count the appfwconfidfield resources configured on NetScaler.
		"""
		try :
			obj = appfwconfidfield()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of appfwconfidfield resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appfwconfidfield()
