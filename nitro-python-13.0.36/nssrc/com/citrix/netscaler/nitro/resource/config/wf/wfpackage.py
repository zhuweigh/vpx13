...
class wfpackage(base_resource) :
	...
	@property
	def wf(self) :
		r"""Complete path to the WebFront tar file for installing the WebFront on the Citrix ADC. This file includes Apache Tomcat Web server. The file name has the following format: nswf-<version number>.tar (for example, nswf-1.5.tar).<br/>Minimum length =  1<br/>Maximum length =  255.
		"""
		try :
			return self._wf
		except Exception as e:
