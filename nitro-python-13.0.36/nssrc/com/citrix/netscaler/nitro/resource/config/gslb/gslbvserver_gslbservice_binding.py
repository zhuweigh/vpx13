...
class gslbvserver_gslbservice_binding(base_resource) :
	...
	def gslbboundsvctype(self) :
		r"""Protocol used by services bound to the GSLBvirtual server.<br/>Possible values = HTTP, FTP, TCP, UDP, SSL, SSL_BRIDGE, SSL_TCP, NNTP, ANY, SIP_UDP, SIP_TCP, SIP_SSL, RADIUS, RDP, RTSP, MYSQL, MSSQL, ORACLE.
		"""
		try :
	...
	def dynamicconfwt(self) :
		r"""Weight obtained by the virtue of bound service count or weight.
		"""
		try :
	...
	def cumulativeweight(self) :
		r"""Cumulative weight is the weight of GSLB service considering both its configured weight and dynamic weight. It is equal to product of dynamic weight and configured weight of the gslb service .
		"""
		try :
	...
	def get(cls, service, name="", option_="") :
		r""" Use this API to fetch gslbvserver_gslbservice_binding resources.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, service, name, filter_) :
		r""" Use this API to fetch filtered set of gslbvserver_gslbservice_binding resources.
	...
	def count(cls, service, name) :
		r""" Use this API to count gslbvserver_gslbservice_binding resources configued on NetScaler.
		"""
		try :
			obj = gslbvserver_gslbservice_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		r""" Use this API to count the filtered set of gslbvserver_gslbservice_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = gslbvserver_gslbservice_binding()
