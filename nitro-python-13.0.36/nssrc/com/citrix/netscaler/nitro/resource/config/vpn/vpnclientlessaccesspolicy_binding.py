...
class vpnclientlessaccesspolicy_binding(base_resource):
	...
	def vpnclientlessaccesspolicy_vpnglobal_bindings(self) :
		r"""vpnglobal that can be bound to vpnclientlessaccesspolicy.
		"""
		try :
	...
	def vpnclientlessaccesspolicy_vpnvserver_bindings(self) :
		r"""vpnvserver that can be bound to vpnclientlessaccesspolicy.
		"""
		try :
	...
	def get(self, service, name="", option_="") :
		r""" Use this API to fetch vpnclientlessaccesspolicy_binding resource.
		"""
		try :
			if not name :
