...
class transformpolicylabel_binding(base_resource):
	...
	def transformpolicylabel_policybinding_bindings(self) :
		r"""policybinding that can be bound to transformpolicylabel.
		"""
		try :
	...
	def transformpolicylabel_transformpolicy_bindings(self) :
		r"""transformpolicy that can be bound to transformpolicylabel.
		"""
		try :
	...
	def get(self, service, labelname="", option_="") :
		r""" Use this API to fetch transformpolicylabel_binding resource.
		"""
		try :
			if not labelname :
