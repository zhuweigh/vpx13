...
class snmpcommunity(base_resource) :
	...
	def communityname(self) :
		r"""The SNMP community string. Can consist of 1 to 31 characters that include uppercase and lowercase letters,numbers and special characters.
	...
	def permissions(self) :
		r"""The SNMP V1 or V2 query-type privilege that you want to associate with this SNMP community.<br/>Possible values = GET, GET_NEXT, GET_BULK, SET, ALL.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add snmpcommunity.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete snmpcommunity.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the snmpcommunity resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = snmpcommunity()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of snmpcommunity resources.
	...
	def count(cls, client) :
		r""" Use this API to count the snmpcommunity resources configured on NetScaler.
		"""
		try :
			obj = snmpcommunity()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of snmpcommunity resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = snmpcommunity()
