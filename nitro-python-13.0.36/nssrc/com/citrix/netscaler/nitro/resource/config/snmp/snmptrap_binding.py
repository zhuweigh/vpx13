...
class snmptrap_binding(base_resource):
	...
	def trapdestination(self) :
		r"""IP address specified in the trap listener entry.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def version(self) :
		r"""The SNMP version of the trap specified in the trap listener entry.<br/>Possible values = V1, V2, V3.
		"""
		try :
	...
	@property
	def trapclass(self) :
		r"""Trap type specified in the trap listener entry.<br/>Possible values = generic, specific.
		"""
		try :
	...
	def snmptrap_snmpuser_bindings(self) :
		r"""snmpuser that can be bound to snmptrap.
		"""
		try :
	...
	def get(self, service, obj) :
		r""" Use this API to fetch a snmptrap_binding resource.
		"""
		try :
