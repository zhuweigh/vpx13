...
class appfwprofile_xmlwsiurl_binding(base_resource) :
	...
	def xmlwsichecks(self) :
		r"""Specify a comma separated list of relevant WS-I rule IDs. (R1140, R1141).
		"""
		try :
	...
	@property
	def xmlwsiurl(self) :
		r"""XML WS-I URL regular expression length.
		"""
		try :
	...
	def get(cls, service, name="", option_="") :
		r""" Use this API to fetch appfwprofile_xmlwsiurl_binding resources.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, service, name, filter_) :
		r""" Use this API to fetch filtered set of appfwprofile_xmlwsiurl_binding resources.
	...
	def count(cls, service, name) :
		r""" Use this API to count appfwprofile_xmlwsiurl_binding resources configued on NetScaler.
		"""
		try :
			obj = appfwprofile_xmlwsiurl_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		r""" Use this API to count the filtered set of appfwprofile_xmlwsiurl_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appfwprofile_xmlwsiurl_binding()
