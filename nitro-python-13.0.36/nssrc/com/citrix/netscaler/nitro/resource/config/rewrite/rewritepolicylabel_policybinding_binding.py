...
class rewritepolicylabel_policybinding_binding(base_resource) :
	...
	def _get_nitro_response(self, service, response) :
		...
		"""
		try :
			result = service.payload_formatter.string_to_resource(rewritepolicylabel_policybinding_binding_response, response, self.__class__.__name__)
	...
	def get(cls, service, labelname="", option_="") :
		r""" Use this API to fetch rewritepolicylabel_policybinding_binding resources.
		"""
		try :
			if not labelname :
				obj = rewritepolicylabel_policybinding_binding()
	...
	def get_filtered(cls, service, labelname, filter_) :
		r""" Use this API to fetch filtered set of rewritepolicylabel_policybinding_binding resources.
	...
	def count(cls, service, labelname) :
		r""" Use this API to count rewritepolicylabel_policybinding_binding resources configued on NetScaler.
		"""
		try :
			obj = rewritepolicylabel_policybinding_binding()
			obj.labelname = labelname
	...
	def count_filtered(cls, service, labelname, filter_) :
		r""" Use this API to count the filtered set of rewritepolicylabel_policybinding_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = rewritepolicylabel_policybinding_binding()
...
class rewritepolicylabel_policybinding_binding_response(base_response) :
	def __init__(self, length=1) :
		...
		self.severity = ""
		self.sessionid = ""
		self.rewritepolicylabel_policybinding_binding = [rewritepolicylabel_policybinding_binding() for _ in range(length)]
