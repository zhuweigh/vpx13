			...
			if type(resource) is not list :
				...
				if (resource and len(resource) > 0) :
					...
					for i in range(len(resource)) :
						...
						addresources[i].trofscode = resource[i].trofscode
						addresources[i].trofsstring = resource[i].trofsstring
						addresources[i].feature = resource[i].feature
						addresources[i].sslprofile = resource[i].sslprofile
			...
			if type(resource) is not list :
				...
				if (resource and len(resource) > 0) :
					...
					for i in range(len(resource)) :
						...
						updateresources[i].storedb = resource[i].storedb
						updateresources[i].trofscode = resource[i].trofscode
						updateresources[i].trofsstring = resource[i].trofsstring
