...
class auditsyslogpolicy_binding(base_resource):
	...
	@property
	def auditsyslogpolicy_auditsyslogglobal_bindings(self) :
		r"""auditsyslogglobal that can be bound to auditsyslogpolicy.
		"""
		try :
			return self._auditsyslogpolicy_auditsyslogglobal_binding
		except Exception as e:
			raise e
