...
class transformprofile(base_resource) :
	...
	@property
	def name(self) :
		r"""Name for the URL transformation profile. Must begin with a letter, number, or the underscore character (_), and must contain only letters, numbers, and the hyphen (-), period (.) pound (#), space ( ), at (@), equals (=), colon (:), and underscore characters. Cannot be changed after the URL transformation profile is added.
	...
	@property
	def type(self) :
		r"""Type of transformation. Always URL for URL Transformation profiles.<br/>Possible values = URL.
		"""
		try :
			return self._type
		except Exception as e:
	...
	def onlytransformabsurlinbody(self) :
		r"""In the HTTP body, transform only absolute URLs. Relative URLs are ignored.<br/>Possible values = ON, OFF.
		"""
		try :
	...
	@property
	def comment(self) :
		r"""Any comments to preserve information about this URL Transformation profile.
		"""
		try :
	...
	def regexforfindingurlinjavascript(self) :
		r"""Patclass having regexes to find the URLs in JavaScript.
		"""
		try :
	...
	def regexforfindingurlincss(self) :
		r"""Patclass having regexes to find the URLs in CSS.
		"""
		try :
	...
	def regexforfindingurlinxcomponent(self) :
		r"""Patclass having regexes to find the URLs in X-Component.
		"""
		try :
	...
	def regexforfindingurlinxml(self) :
		r"""Patclass having regexes to find the URLs in XML.
		"""
		try :
	...
	def additionalreqheaderslist(self) :
		r"""Patclass having a list of additional request header names that should transformed.
		"""
		try :
	...
	def additionalrespheaderslist(self) :
		r"""Patclass having a list of additional response header names that should transformed.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add transformprofile.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete transformprofile.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update transformprofile.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of transformprofile resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the transformprofile resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of transformprofile resources.
	...
	def count(cls, client) :
		r""" Use this API to count the transformprofile resources configured on NetScaler.
		"""
		try :
			obj = transformprofile()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of transformprofile resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = transformprofile()
