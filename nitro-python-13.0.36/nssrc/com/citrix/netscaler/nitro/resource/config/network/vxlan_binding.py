...
class vxlan_binding(base_resource):
	...
	def vxlan_nsip6_bindings(self) :
		r"""nsip6 that can be bound to vxlan.
		"""
		try :
	...
	def vxlan_nsip_bindings(self) :
		r"""nsip that can be bound to vxlan.
		"""
		try :
	...
	def vxlan_iptunnel_bindings(self) :
		r"""iptunnel that can be bound to vxlan.
		"""
		try :
	...
	@property
	def vxlan_srcip_bindings(self) :
		r"""srcip that can be bound to vxlan.
		"""
		try :
			return self._vxlan_srcip_binding
		except Exception as e:
			raise e
	...
	def get(self, service, id="", option_="") :
		r""" Use this API to fetch vxlan_binding resource.
		"""
		try :
			if not id :
				obj = vxlan_binding()
