...
class inatparam(base_resource) :
	...
	def update(cls, client, resource) :
		r""" Use this API to update inatparam.
		"""
		try :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of inatparam resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the inatparam resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = inatparam()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of inatparam resources.
	...
	def count(cls, client) :
		r""" Use this API to count the inatparam resources configured on NetScaler.
		"""
		try :
			obj = inatparam()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of inatparam resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = inatparam()
