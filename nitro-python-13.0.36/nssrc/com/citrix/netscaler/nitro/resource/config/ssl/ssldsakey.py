...
class ssldsakey(base_resource) :
	...
	@property
	def keyfile(self) :
		r"""Name for and, optionally, path to the DSA key file. /nsconfig/ssl/ is the default path.<br/>Maximum length =  63.
		"""
		try :
	...
	@property
	def bits(self) :
		r"""Size, in bits, of the DSA key.<br/>Minimum length =  512<br/>Maximum length =  2048.
		"""
		try :
			return self._bits
		except Exception as e:
	...
	@property
	def keyform(self) :
		r"""Format in which the DSA key file is stored on the appliance.<br/>Default value: PEM<br/>Possible values = DER, PEM.
		"""
		try :
	...
	@property
	def des(self) :
		r"""Encrypt the generated DSA key by using the DES algorithm. On the command line, you are prompted to enter the pass phrase (password) that will be used to encrypt the key.
		"""
		try :
			return self._des
		except Exception as e:
	...
	@property
	def des3(self) :
		r"""Encrypt the generated DSA key by using the Triple-DES algorithm. On the command line, you are prompted to enter the pass phrase (password) that will be used to encrypt the key.
		"""
		try :
			return self._des3
		except Exception as e:
	...
	@property
	def aes256(self) :
		r"""Encrypt the generated DSA key by using the AES algorithm.
		"""
		try :
			return self._aes256
		except Exception as e:
	...
	def create(cls, client, resource) :
		r""" Use this API to create ssldsakey.
		"""
		try :
