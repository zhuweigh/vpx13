...
class dnspolicylabel_policybinding_binding(base_resource) :
	...
	def get(cls, service, labelname="", option_="") :
		r""" Use this API to fetch dnspolicylabel_policybinding_binding resources.
		"""
		try :
			if not labelname :
	...
	def get_filtered(cls, service, labelname, filter_) :
		r""" Use this API to fetch filtered set of dnspolicylabel_policybinding_binding resources.
	...
	def count(cls, service, labelname) :
		r""" Use this API to count dnspolicylabel_policybinding_binding resources configued on NetScaler.
		"""
		try :
			obj = dnspolicylabel_policybinding_binding()
			obj.labelname = labelname
	...
	def count_filtered(cls, service, labelname, filter_) :
		r""" Use this API to count the filtered set of dnspolicylabel_policybinding_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = dnspolicylabel_policybinding_binding()
