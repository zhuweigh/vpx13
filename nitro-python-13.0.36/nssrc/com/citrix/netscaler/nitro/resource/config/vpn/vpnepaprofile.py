...
class vpnepaprofile(base_resource) :
	...
	@property
	def name(self) :
		r"""name of device profile.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	@property
	def filename(self) :
		r"""filename of the deviceprofile data xml.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def data(self) :
		r"""deviceprofile data xml.<br/>Minimum length =  1.
		"""
		try :
			return self._data
		except Exception as e:
	...
	def add(cls, client, resource) :
		r""" Use this API to add vpnepaprofile.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete vpnepaprofile.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the vpnepaprofile resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = vpnepaprofile()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of vpnepaprofile resources.
	...
	def count(cls, client) :
		r""" Use this API to count the vpnepaprofile resources configured on NetScaler.
		"""
		try :
			obj = vpnepaprofile()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of vpnepaprofile resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnepaprofile()
