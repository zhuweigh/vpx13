...
class cachepolicylabel_binding(base_resource):
	...
	@property
	def labelname(self) :
		r"""Name of the cache-policy label about which to display information.
		"""
		try :
	...
	def cachepolicylabel_policybinding_bindings(self) :
		r"""policybinding that can be bound to cachepolicylabel.
		"""
		try :
	...
	def cachepolicylabel_cachepolicy_bindings(self) :
		r"""cachepolicy that can be bound to cachepolicylabel.
		"""
		try :
	...
	def get(self, service, labelname="", option_="") :
		r""" Use this API to fetch cachepolicylabel_binding resource.
		"""
		try :
			if not labelname :
