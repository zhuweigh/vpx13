...
class systemuser_binding(base_resource):
	...
	@property
	def username(self) :
		r"""Name of a system user about whom to display information.<br/>Minimum length =  1.
		"""
		try :
	...
	def systemuser_systemgroup_bindings(self) :
		r"""systemgroup that can be bound to systemuser.
		"""
		try :
	...
	@property
	def systemuser_nspartition_bindings(self) :
		r"""nspartition that can be bound to systemuser.
		"""
		try :
			return self._systemuser_nspartition_binding
		except Exception as e:
			raise e

	@property
	def systemuser_systemcmdpolicy_bindings(self) :
		r"""systemcmdpolicy that can be bound to systemuser.
		"""
		try :
	...
	def get(self, service, username="", option_="") :
		r""" Use this API to fetch systemuser_binding resource.
		"""
		try :
			if not username :
