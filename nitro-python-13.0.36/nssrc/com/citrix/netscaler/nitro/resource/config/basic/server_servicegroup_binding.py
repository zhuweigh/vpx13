...
class server_servicegroup_binding(base_resource) :
	...
	def servicegroupentname2(self) :
		r"""Used for show server of SRV type to indicate target FQDNs.
		"""
		try :
	...
	def svcitmpriority(self) :
		r"""Indicates the Priority of the SRV target FQDN.
		"""
		try :
	...
	def svcitmboundsvcs(self) :
		r"""Indicates the total number of bound IPs for the SRV target FQDN.
		"""
		try :
	...
	@property
	def weight(self) :
		r"""Indicates the weight of bound IPs.
		"""
		try :
			return self._weight
		except Exception as e:
	...
	def svcitmactsvcs(self) :
		r"""Indicates the total number of active IPs for SRV target FQDN.
		"""
		try :
