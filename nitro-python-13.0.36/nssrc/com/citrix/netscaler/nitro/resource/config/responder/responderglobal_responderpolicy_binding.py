...
class responderglobal_responderpolicy_binding(base_resource) :
	...
	@property
	def flowtype(self) :
		r"""flowtype of the bound responder policy.
		"""
		try :
	...
	@classmethod
	def get(cls, service) :
		r""" Use this API to fetch a responderglobal_responderpolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		r""" Use this API to fetch filtered set of responderglobal_responderpolicy_binding resources.
	...
	def count(cls, service) :
		r""" Use this API to count responderglobal_responderpolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = responderglobal_responderpolicy_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		r""" Use this API to count the filtered set of responderglobal_responderpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = responderglobal_responderpolicy_binding()
