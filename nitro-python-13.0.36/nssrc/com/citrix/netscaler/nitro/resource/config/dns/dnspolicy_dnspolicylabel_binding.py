...
class dnspolicy_dnspolicylabel_binding(base_resource) :
	...
	def get(cls, service, name="", option_="") :
		r""" Use this API to fetch dnspolicy_dnspolicylabel_binding resources.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, service, name, filter_) :
		r""" Use this API to fetch filtered set of dnspolicy_dnspolicylabel_binding resources.
	...
	def count(cls, service, name) :
		r""" Use this API to count dnspolicy_dnspolicylabel_binding resources configued on NetScaler.
		"""
		try :
			obj = dnspolicy_dnspolicylabel_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		r""" Use this API to count the filtered set of dnspolicy_dnspolicylabel_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = dnspolicy_dnspolicylabel_binding()
