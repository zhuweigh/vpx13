...
class vpnglobal_authenticationnegotiatepolicy_binding(base_resource) :
	...
	def add(cls, client, resource) :
		try :
			if resource and type(resource) is not list :
				updateresource = vpnglobal_authenticationnegotiatepolicy_binding()
				...
				if resource and len(resource) > 0 :
					updateresources = [vpnglobal_authenticationnegotiatepolicy_binding() for _ in range(len(resource))]
	...
	def delete(cls, client, resource) :
		try :
			if resource and type(resource) is not list :
				deleteresource = vpnglobal_authenticationnegotiatepolicy_binding()
				...
				if resource and len(resource) > 0 :
					deleteresources = [vpnglobal_authenticationnegotiatepolicy_binding() for _ in range(len(resource))]
					for i in range(len(resource)) :
	...
	@classmethod
	def get(cls, service) :
		r""" Use this API to fetch a vpnglobal_authenticationnegotiatepolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		r""" Use this API to fetch filtered set of vpnglobal_authenticationnegotiatepolicy_binding resources.
	...
	def count(cls, service) :
		r""" Use this API to count vpnglobal_authenticationnegotiatepolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = vpnglobal_authenticationnegotiatepolicy_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		r""" Use this API to count the filtered set of vpnglobal_authenticationnegotiatepolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnglobal_authenticationnegotiatepolicy_binding()
