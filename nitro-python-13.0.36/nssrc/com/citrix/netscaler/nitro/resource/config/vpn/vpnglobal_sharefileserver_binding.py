...
class vpnglobal_sharefileserver_binding(base_resource) :
	...
	@property
	def sharefile(self) :
		r"""Configured Sharefile server, in the format IP:PORT / FQDN:PORT.
		"""
		try :
	...
	@classmethod
	def get(cls, service) :
		r""" Use this API to fetch a vpnglobal_sharefileserver_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		r""" Use this API to fetch filtered set of vpnglobal_sharefileserver_binding resources.
	...
	def count(cls, service) :
		r""" Use this API to count vpnglobal_sharefileserver_binding resources configued on NetScaler.
		"""
		try :
			obj = vpnglobal_sharefileserver_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		r""" Use this API to count the filtered set of vpnglobal_sharefileserver_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnglobal_sharefileserver_binding()
