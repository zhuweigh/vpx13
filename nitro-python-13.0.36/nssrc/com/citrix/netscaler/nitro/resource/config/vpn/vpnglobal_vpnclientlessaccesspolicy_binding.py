...
class vpnglobal_vpnclientlessaccesspolicy_binding(base_resource) :
	""" Binding class showing the vpnclientlessaccesspolicy that can be bound to vpnglobal.
	"""
	def __init__(self) :
	...
	def globalbindtype(self) :
		r""".<br/>Possible values = SYSTEM_GLOBAL, VPN_GLOBAL, RNAT_GLOBAL.
		"""
		try :
	...
	@property
	def type(self) :
		r"""Bindpoint to which the policy is bound.<br/>Possible values = REQ_OVERRIDE, REQ_DEFAULT, RES_OVERRIDE, RES_DEFAULT.
		"""
		try :
			return self._type
		except Exception as e:
	...
	def _get_nitro_response(self, service, response) :
		...
		"""
		try :
			result = service.payload_formatter.string_to_resource(vpnglobal_vpnclientlessaccesspolicy_binding_response, response, self.__class__.__name__)
			if(result.errorcode != 0) :
				...
				if result.severity :
					...
					raise nitro_exception(result.errorcode, str(result.message), str(result.severity))
			return result.vpnglobal_vpnclientlessaccesspolicy_binding
		except Exception as e :
			raise e
	...
	def add(cls, client, resource) :
		try :
			if resource and type(resource) is not list :
				updateresource = vpnglobal_vpnclientlessaccesspolicy_binding()
				...
				if resource and len(resource) > 0 :
					updateresources = [vpnglobal_vpnclientlessaccesspolicy_binding() for _ in range(len(resource))]
	...
	def delete(cls, client, resource) :
		try :
			if resource and type(resource) is not list :
				deleteresource = vpnglobal_vpnclientlessaccesspolicy_binding()
				...
				if resource and len(resource) > 0 :
					deleteresources = [vpnglobal_vpnclientlessaccesspolicy_binding() for _ in range(len(resource))]
					for i in range(len(resource)) :
	...
	@classmethod
	def get(cls, service) :
		r""" Use this API to fetch a vpnglobal_vpnclientlessaccesspolicy_binding resources.
		"""
		try :
			obj = vpnglobal_vpnclientlessaccesspolicy_binding()
	...
	def get_filtered(cls, service, filter_) :
		r""" Use this API to fetch filtered set of vpnglobal_vpnclientlessaccesspolicy_binding resources.
	...
	def count(cls, service) :
		r""" Use this API to count vpnglobal_vpnclientlessaccesspolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = vpnglobal_vpnclientlessaccesspolicy_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		r""" Use this API to count the filtered set of vpnglobal_vpnclientlessaccesspolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnglobal_vpnclientlessaccesspolicy_binding()
...
class vpnglobal_vpnclientlessaccesspolicy_binding_response(base_response) :
	def __init__(self, length=1) :
		...
		self.severity = ""
		self.sessionid = ""
		self.vpnglobal_vpnclientlessaccesspolicy_binding = [vpnglobal_vpnclientlessaccesspolicy_binding() for _ in range(length)]
