...
class vrid6_binding(base_resource):
	...
	def vrid6_nsip6_bindings(self) :
		r"""nsip6 that can be bound to vrid6.
		"""
		try :
	...
	def vrid6_nsip_bindings(self) :
		r"""nsip that can be bound to vrid6.
		"""
		try :
	...
	@property
	def vrid6_channel_bindings(self) :
		r"""channel that can be bound to vrid6.
		"""
		try :
			return self._vrid6_channel_binding
		except Exception as e:
			raise e

	@property
	def vrid6_interface_bindings(self) :
		r"""interface that can be bound to vrid6.
		"""
		try :
	...
	@property
	def vrid6_trackinterface_bindings(self) :
		r"""trackinterface that can be bound to vrid6.
		"""
		try :
			return self._vrid6_trackinterface_binding
		except Exception as e:
			raise e
	...
	def get(self, service, id="", option_="") :
		r""" Use this API to fetch vrid6_binding resource.
		"""
		try :
			if not id :
				obj = vrid6_binding()
