...
class appfwglobal_appfwpolicy_binding(base_resource) :
	...
	@property
	def flowtype(self) :
		r"""flowtype of the bound application firewall policy.
		"""
		try :
	...
	@classmethod
	def get(cls, service) :
		r""" Use this API to fetch a appfwglobal_appfwpolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		r""" Use this API to fetch filtered set of appfwglobal_appfwpolicy_binding resources.
	...
	def count(cls, service) :
		r""" Use this API to count appfwglobal_appfwpolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = appfwglobal_appfwpolicy_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		r""" Use this API to count the filtered set of appfwglobal_appfwpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appfwglobal_appfwpolicy_binding()
