...
class gslbdomain_gslbvserver_binding(base_resource) :
	...
	def backuplbmethod(self) :
		r"""Indicates the backup method in case the primary fails.<br/>Possible values = ROUNDROBIN, LEASTCONNECTION, LEASTRESPONSETIME, SOURCEIPHASH, LEASTBANDWIDTH, LEASTPACKETS, STATICPROXIMITY, RTT, CUSTOMLOAD.
		"""
		try :
	...
	@property
	def lbmethod(self) :
		r"""The load balancing method set for the virtual server.<br/>Possible values = ROUNDROBIN, LEASTCONNECTION, LEASTRESPONSETIME, SOURCEIPHASH, LEASTBANDWIDTH, LEASTPACKETS, STATICPROXIMITY, RTT, CUSTOMLOAD.
		"""
		try :
