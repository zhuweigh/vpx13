...
class nd6ravariables(base_resource) :
	...
	def __init__(self) :
		self._vlan = None
		self._ceaserouteradv = None
		self._sendrouteradv = None
		self._srclinklayeraddroption = None
		self._onlyunicastrtadvresponse = None
		self._managedaddrconfig = None
		self._otheraddrconfig = None
		self._currhoplimit = None
		self._maxrtadvinterval = None
		self._minrtadvinterval = None
		self._linkmtu = None
		self._reachabletime = None
		self._retranstime = None
		self._defaultlifetime = None
		self._lastrtadvtime = None
		self._nextrtadvdelay = None
		self.___count = None

	@property
	def vlan(self) :
		r"""The VLAN number.<br/>Minimum length =  1<br/>Maximum length =  4094.
		"""
		try :
			return self._vlan
	...
	def ceaserouteradv(self) :
		r"""Cease router advertisements on this vlan.<br/>Default value: NO<br/>Possible values = YES, NO.
		"""
		try :
	...
	def sendrouteradv(self) :
		r"""whether the router sends periodic RAs and responds to Router Solicitations.<br/>Default value: NO<br/>Possible values = YES, NO.
		"""
		try :
	...
	def srclinklayeraddroption(self) :
		r"""Include source link layer address option in RA messages.<br/>Default value: YES<br/>Possible values = YES, NO.
		"""
		try :
	...
	def onlyunicastrtadvresponse(self) :
		r"""Send only Unicast Router Advertisements in respond to Router Solicitations.<br/>Default value: NO<br/>Possible values = YES, NO.
		"""
		try :
	...
	def managedaddrconfig(self) :
		r"""Value to be placed in the Managed address configuration flag field.<br/>Default value: NO<br/>Possible values = YES, NO.
		"""
		try :
	...
	def otheraddrconfig(self) :
		r"""Value to be placed in the Other configuration flag field.<br/>Default value: NO<br/>Possible values = YES, NO.
		"""
		try :
	...
	def currhoplimit(self) :
		r"""Current Hop limit.<br/>Default value: 64<br/>Maximum length =  255.
		"""
		try :
	...
	def maxrtadvinterval(self) :
		r"""Maximum time allowed between unsolicited multicast RAs, in seconds.<br/>Default value: 600<br/>Minimum length =  4<br/>Maximum length =  1800.
		"""
		try :
	...
	def minrtadvinterval(self) :
		r"""Minimum time interval between RA messages, in seconds.<br/>Default value: 198<br/>Minimum length =  3<br/>Maximum length =  1350.
		"""
		try :
	...
	@property
	def linkmtu(self) :
		r"""The Link MTU.<br/>Default value: 0<br/>Maximum length =  1500.
		"""
		try :
	...
	def reachabletime(self) :
		r"""Reachable time, in milliseconds.<br/>Default value: 0<br/>Maximum length =  3600000.
		"""
		try :
	...
	def retranstime(self) :
		r"""Retransmission time, in milliseconds.<br/>Default value: 0.
		"""
		try :
	...
	def defaultlifetime(self) :
		r"""Default life time, in seconds.<br/>Default value: 1800<br/>Maximum length =  9000.
		"""
		try :
	...
	def update(cls, client, resource) :
		r""" Use this API to update nd6ravariables.
		"""
		try :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of nd6ravariables resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the nd6ravariables resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = nd6ravariables()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of nd6ravariables resources.
	...
	def count(cls, client) :
		r""" Use this API to count the nd6ravariables resources configured on NetScaler.
		"""
		try :
			obj = nd6ravariables()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of nd6ravariables resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = nd6ravariables()
