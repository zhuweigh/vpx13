...
class onlinkipv6prefix(base_resource) :
	...
	def __init__(self) :
		...
		self._onlinkprefix = None
		self._autonomusprefix = None
		self._depricateprefix = None
		self._decrementprefixlifetimes = None
		self._prefixvalidelifetime = None
		self._prefixpreferredlifetime = None
		self._prefixcurrvalidelft = None
		self._prefixcurrpreferredlft = None
		self.___count = None
	...
	def onlinkprefix(self) :
		r"""RA Prefix onlink flag.<br/>Default value: YES<br/>Possible values = YES, NO.
		"""
		try :
	...
	def autonomusprefix(self) :
		r"""RA Prefix Autonomus flag.<br/>Default value: YES<br/>Possible values = YES, NO.
		"""
		try :
	...
	def depricateprefix(self) :
		r"""Depricate the prefix.<br/>Default value: NO<br/>Possible values = YES, NO.
		"""
		try :
	...
	def decrementprefixlifetimes(self) :
		r"""RA Prefix Autonomus flag.<br/>Default value: NO<br/>Possible values = YES, NO.
		"""
		try :
	...
	def prefixvalidelifetime(self) :
		r"""Valide life time of the prefix, in seconds.<br/>Default value: 2592000.
		"""
		try :
	...
	def prefixpreferredlifetime(self) :
		r"""Preferred life time of the prefix, in seconds.<br/>Default value: 604800.
		"""
		try :
	...
	def prefixcurrvalidelft(self) :
		r"""Prefix current valid life time.
		"""
		try :
	...
	def prefixcurrpreferredlft(self) :
		r"""Prefix current prefered life time.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add onlinkipv6prefix.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete onlinkipv6prefix.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update onlinkipv6prefix.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of onlinkipv6prefix resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the onlinkipv6prefix resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of onlinkipv6prefix resources.
	...
	def count(cls, client) :
		r""" Use this API to count the onlinkipv6prefix resources configured on NetScaler.
		"""
		try :
			obj = onlinkipv6prefix()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of onlinkipv6prefix resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = onlinkipv6prefix()
