...
class authenticationradiuspolicy(base_resource) :
	...
	@property
	def name(self) :
		r"""Name for the RADIUS authentication policy. 
	...
	@property
	def rule(self) :
		r"""Name of the Citrix ADC named rule, or an expression, that the policy uses to determine whether to attempt to authenticate the user with the RADIUS server.
		"""
		try :
			return self._rule
		except Exception as e:
	...
	@property
	def reqaction(self) :
		r"""Name of the RADIUS action to perform if the policy matches.<br/>Minimum length =  1.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add authenticationradiuspolicy.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete authenticationradiuspolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update authenticationradiuspolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of authenticationradiuspolicy resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the authenticationradiuspolicy resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of authenticationradiuspolicy resources.
	...
	def count(cls, client) :
		r""" Use this API to count the authenticationradiuspolicy resources configured on NetScaler.
		"""
		try :
			obj = authenticationradiuspolicy()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of authenticationradiuspolicy resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = authenticationradiuspolicy()
