...
class auditnslogparams(base_resource) :
	...
	@property
	def tcp(self) :
		r"""Configure auditing to log TCP messages.<br/>Possible values = NONE, ALL.
		"""
		try :
			return self._tcp
		except Exception as e:
	...
	@property
	def acl(self) :
		r"""Configure auditing to log access control list (ACL) messages.<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._acl
		except Exception as e:
	...
	def update(cls, client, resource) :
		r""" Use this API to update auditnslogparams.
		"""
		try :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of auditnslogparams resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the auditnslogparams resources that are configured on netscaler.
		"""
		try :
			if not name :
