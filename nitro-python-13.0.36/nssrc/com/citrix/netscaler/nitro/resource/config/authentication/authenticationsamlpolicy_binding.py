...
class authenticationsamlpolicy_binding(base_resource):
	...
	@property
	def authenticationsamlpolicy_vpnvserver_bindings(self) :
		r"""vpnvserver that can be bound to authenticationsamlpolicy.
		"""
		try :
			return self._authenticationsamlpolicy_vpnvserver_binding
		except Exception as e:
			raise e

	@property
	def authenticationsamlpolicy_vpnglobal_bindings(self) :
		r"""vpnglobal that can be bound to authenticationsamlpolicy.
		"""
		try :
			return self._authenticationsamlpolicy_vpnglobal_binding
		except Exception as e:
			raise e

	@property
	def authenticationsamlpolicy_authenticationvserver_bindings(self) :
		r"""authenticationvserver that can be bound to authenticationsamlpolicy.
		"""
		try :
	...
	def get(self, service, name="", option_="") :
		r""" Use this API to fetch authenticationsamlpolicy_binding resource.
		"""
		try :
			if not name :
