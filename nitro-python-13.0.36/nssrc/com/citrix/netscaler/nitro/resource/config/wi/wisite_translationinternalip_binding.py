...
class wisite_translationinternalip_binding(base_resource) :
	...
	"""
	def __init__(self) :
		self._translationinternalip = None
		self._accesstype = None
		self._translationinternalport = None
		self._translationexternalip = None
		self._translationexternalport = None
		self._sitepath = None
		self.___count = None
	...
	@property
	def accesstype(self) :
		r"""Type of access to the XenApp or XenDesktop server. 
	...
	def translationexternalport(self) :
		r"""External port number associated with the server's port number.<br/>Range 1 - 65535<br/>* in CLI is represented as 65535 in NITRO API.
		"""
		try :
	...
	def translationinternalip(self) :
		r"""IP address of the server for which you want to associate an external IP address. (Clients access the server through the associated external address and port.).<br/>Default value: 0.
		"""
		try :
	...
	def translationexternalip(self) :
		r"""External IP address associated with server's IP address.
		"""
		try :
	...
	def translationinternalport(self) :
		r"""Port number of the server for which you want to associate an external port.  (Clients access the server through the associated external address and port.).<br/>Range 1 - 65535<br/>* in CLI is represented as 65535 in NITRO API.
		"""
		try :
	...
	def get(cls, service, sitepath="", option_="") :
		r""" Use this API to fetch wisite_translationinternalip_binding resources.
		"""
		try :
			if not sitepath :
	...
	def get_filtered(cls, service, sitepath, filter_) :
		r""" Use this API to fetch filtered set of wisite_translationinternalip_binding resources.
	...
	def count(cls, service, sitepath) :
		r""" Use this API to count wisite_translationinternalip_binding resources configued on NetScaler.
		"""
		try :
			obj = wisite_translationinternalip_binding()
			obj.sitepath = sitepath
