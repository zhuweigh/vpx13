...
class vpntrafficpolicy(base_resource) :
	...
	@property
	def name(self) :
		r"""Name for the traffic policy. Must begin with an ASCII alphabetic or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@), equals (=), and hyphen (-) characters. Cannot be changed after the policy is created.
	...
	@property
	def action(self) :
		r"""Action to apply to traffic that matches the policy.<br/>Minimum length =  1.
		"""
		try :
			return self._action
		except Exception as e:
	...
	def add(cls, client, resource) :
		r""" Use this API to add vpntrafficpolicy.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete vpntrafficpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update vpntrafficpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of vpntrafficpolicy resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the vpntrafficpolicy resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of vpntrafficpolicy resources.
	...
	def count(cls, client) :
		r""" Use this API to count the vpntrafficpolicy resources configured on NetScaler.
		"""
		try :
			obj = vpntrafficpolicy()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of vpntrafficpolicy resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpntrafficpolicy()
