...
class tmsessionpolicy(base_resource) :
	...
	@property
	def name(self) :
		r"""Name for the session policy. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at sign (@), equal sign (=), and hyphen (-) characters. Cannot be changed after a session policy is created.
	...
	@property
	def rule(self) :
		r"""Expression, against which traffic is evaluated. Both classic and advance expressions are supported in default partition but only advance expressions in non-default partition.
	...
	@property
	def action(self) :
		r"""Action to be applied to connections that match this policy.<br/>Minimum length =  1.
		"""
		try :
			return self._action
		except Exception as e:
	...
	def add(cls, client, resource) :
		r""" Use this API to add tmsessionpolicy.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete tmsessionpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update tmsessionpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of tmsessionpolicy resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the tmsessionpolicy resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = tmsessionpolicy()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of tmsessionpolicy resources.
	...
	def count(cls, client) :
		r""" Use this API to count the tmsessionpolicy resources configured on NetScaler.
		"""
		try :
			obj = tmsessionpolicy()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of tmsessionpolicy resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = tmsessionpolicy()
