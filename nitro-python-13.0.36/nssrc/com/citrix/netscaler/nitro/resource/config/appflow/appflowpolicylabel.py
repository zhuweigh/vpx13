...
class appflowpolicylabel(base_resource) :
	...
	@property
	def labelname(self) :
		r"""Name of the AppFlow policy label. Must begin with an ASCII alphabetic or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at
	...
	def policylabeltype(self) :
		r"""Type of traffic evaluated by the policies bound to the policy label.<br/>Default value: HTTP<br/>Possible values = HTTP, OTHERTCP.
		"""
		try :
	...
	@property
	def newname(self) :
		r"""New name for the policy label. Must begin with an ASCII alphabetic or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@), equals (=), and hyphen (-) characters. 
		The following requirement applies only to the Citrix ADC CLI:
		If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my appflow policylabel" or 'my appflow policylabel').<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def numpol(self) :
		r"""Number of polices bound to the policy label.
		"""
		try :
			return self._numpol
		except Exception as e:
	...
	@property
	def hits(self) :
		r"""Number of times the policy label was invoked.
		"""
		try :
			return self._hits
		except Exception as e:
	...
	@property
	def labeltype(self) :
		r"""Type of policy label to be invoked.<br/>Possible values = vserver, policylabel.
		"""
		try :
	...
	@property
	def flowtype(self) :
		r"""Flowtype of the bound AppFlow policy.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add appflowpolicylabel.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete appflowpolicylabel.
		"""
		try :
			if type(resource) is not list :
	...
	def rename(cls, client, resource, new_labelname) :
		r""" Use this API to rename a appflowpolicylabel resource.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the appflowpolicylabel resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of appflowpolicylabel resources.
	...
	def count(cls, client) :
		r""" Use this API to count the appflowpolicylabel resources configured on NetScaler.
		"""
		try :
			obj = appflowpolicylabel()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of appflowpolicylabel resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appflowpolicylabel()
