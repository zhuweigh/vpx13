...
class rnatparam(base_resource) :
	...
	@property
	def tcpproxy(self) :
		r"""Enable TCP proxy, which enables the Citrix ADC to optimize the RNAT TCP traffic by using Layer 4 features.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def srcippersistency(self) :
		r"""Enable source ip persistency, which enables the Citrix ADC to use the RNAT ips using source ip.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
