...
class nsrpcnode(base_resource) :
	...
	@property
	def ipaddress(self) :
		r"""IP address of the node. This has to be in the same subnet as the NSIP address.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def password(self) :
		r"""Password to be used in authentication with the peer system node.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def srcip(self) :
		r"""Source IP address to be used to communicate with the peer system node. The default value is 0, which means that the appliance uses the NSIP address as the source IP address.
		"""
		try :
			return self._srcip
		except Exception as e:
	...
	@property
	def secure(self) :
		r"""State of the channel when talking to the node.<br/>Possible values = YES, NO.
		"""
		try :
			return self._secure
		except Exception as e:
	...
	def update(cls, client, resource) :
		r""" Use this API to update nsrpcnode.
		"""
		try :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of nsrpcnode resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the nsrpcnode resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = nsrpcnode()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of nsrpcnode resources.
	...
	def count(cls, client) :
		r""" Use this API to count the nsrpcnode resources configured on NetScaler.
		"""
		try :
			obj = nsrpcnode()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of nsrpcnode resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = nsrpcnode()
