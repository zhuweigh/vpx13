...
class dnsptrrec(base_resource) :
	...
	def reversedomain(self) :
		r"""Reversed domain name representation of the IPv4 or IPv6 address for which to create the PTR record. Use the "in-addr.arpa." suffix for IPv4 addresses and the "ip6.arpa." suffix for IPv6 addresses.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def domain(self) :
		r"""Domain name for which to configure reverse mapping.<br/>Minimum length =  1.
		"""
		try :
			return self._domain
		except Exception as e:
	...
	@property
	def ecssubnet(self) :
		r"""Subnet for which the cached PTR record need to be removed.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add dnsptrrec.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete dnsptrrec.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the dnsptrrec resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = dnsptrrec()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of dnsptrrec resources.
	...
	def count(cls, client) :
		r""" Use this API to count the dnsptrrec resources configured on NetScaler.
		"""
		try :
			obj = dnsptrrec()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of dnsptrrec resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = dnsptrrec()
