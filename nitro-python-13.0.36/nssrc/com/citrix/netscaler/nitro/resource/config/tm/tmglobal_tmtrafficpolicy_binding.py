...
class tmglobal_tmtrafficpolicy_binding(base_resource) :
	...
	@classmethod
	def get(cls, service) :
		r""" Use this API to fetch a tmglobal_tmtrafficpolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		r""" Use this API to fetch filtered set of tmglobal_tmtrafficpolicy_binding resources.
	...
	def count(cls, service) :
		r""" Use this API to count tmglobal_tmtrafficpolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = tmglobal_tmtrafficpolicy_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		r""" Use this API to count the filtered set of tmglobal_tmtrafficpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = tmglobal_tmtrafficpolicy_binding()
