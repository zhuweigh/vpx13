...
class appqoecustomresp(base_resource) :
	...
	@property
	def src(self) :
		r""".<br/>Minimum length =  1<br/>Maximum length =  2047.
		"""
		try :
			return self._src
	...
	@property
	def name(self) :
		r"""Indicates name of the custom response HTML page to import/update.<br/>Minimum length =  1<br/>Maximum length =  31.
		"""
		try :
			return self._name
		except Exception as e:
	...
	def Import(cls, client, resource) :
		r""" Use this API to Import appqoecustomresp.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete appqoecustomresp.
		"""
		try :
			if type(resource) is not list :
	...
	def change(cls, client, resource) :
		r""" Use this API to change appqoecustomresp.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the appqoecustomresp resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of appqoecustomresp resources.
	...
	def count(cls, client) :
		r""" Use this API to count the appqoecustomresp resources configured on NetScaler.
		"""
		try :
			obj = appqoecustomresp()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of appqoecustomresp resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appqoecustomresp()
