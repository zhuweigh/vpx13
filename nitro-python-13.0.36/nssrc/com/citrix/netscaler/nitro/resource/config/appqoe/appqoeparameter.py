...
class appqoeparameter(base_resource) :
	...
	def __init__(self) :
		...
		self._avgwaitingclient = None
		self._maxaltrespbandwidth = None
		self._dosattackthresh = None
	...
	def avgwaitingclient(self) :
		r"""average number of client connections, that can sit in service waiting queue.<br/>Default value: 1000000<br/>Maximum length =  0xFFFFFFFE.
		"""
		try :
	...
	def maxaltrespbandwidth(self) :
		r"""maximum bandwidth which will determine whether to send alternate content response.<br/>Default value: 100<br/>Minimum length =  1<br/>Maximum length =  0xFFFFFFFE.
		"""
		try :
	...
	def dosattackthresh(self) :
		r"""average number of client connection that can queue up on vserver level without triggering DoS mitigation module.<br/>Default value: 2000<br/>Maximum length =  0xFFFFFFFE.
		"""
		try :
	...
	def update(cls, client, resource) :
		r""" Use this API to update appqoeparameter.
		"""
		try :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of appqoeparameter resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the appqoeparameter resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = appqoeparameter()
