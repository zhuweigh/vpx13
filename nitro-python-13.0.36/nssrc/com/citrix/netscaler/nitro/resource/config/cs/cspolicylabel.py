...
class cspolicylabel(base_resource) :
	...
	def cspolicylabeltype(self) :
		...
		* MSSQL - Supports policies that process Microsoft SQL traffic.<br/>Possible values = HTTP, TCP, RTSP, SSL, SSL_TCP, UDP, DNS, SIP_UDP, SIP_TCP, ANY, RADIUS, RDP, MYSQL, MSSQL, ORACLE, DIAMETER, SSL_DIAMETER, FTP, DNS_TCP, SMPP.
		"""
		try :
