...
class sslpolicylabel_sslpolicy_binding(base_resource) :
	...
	@property
	def labelname(self) :
		r"""Name of the SSL policy label to which to bind policies.
		"""
		try :
	...
	@property
	def invoke(self) :
		r"""Invoke policies bound to a policy label. After the invoked policies are evaluated, the flow returns to the policy with the next priority.
		"""
		try :
			return self._invoke
		except Exception as e:
	...
	def get(cls, service, labelname="", option_="") :
		r""" Use this API to fetch sslpolicylabel_sslpolicy_binding resources.
		"""
		try :
			if not labelname :
	...
	def get_filtered(cls, service, labelname, filter_) :
		r""" Use this API to fetch filtered set of sslpolicylabel_sslpolicy_binding resources.
	...
	def count(cls, service, labelname) :
		r""" Use this API to count sslpolicylabel_sslpolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = sslpolicylabel_sslpolicy_binding()
			obj.labelname = labelname
	...
	def count_filtered(cls, service, labelname, filter_) :
		r""" Use this API to count the filtered set of sslpolicylabel_sslpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslpolicylabel_sslpolicy_binding()
