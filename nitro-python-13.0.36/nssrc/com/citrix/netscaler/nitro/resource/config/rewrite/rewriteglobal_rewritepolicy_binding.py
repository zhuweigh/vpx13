...
class rewriteglobal_rewritepolicy_binding(base_resource) :
	...
	@classmethod
	def get(cls, service) :
		r""" Use this API to fetch a rewriteglobal_rewritepolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		r""" Use this API to fetch filtered set of rewriteglobal_rewritepolicy_binding resources.
	...
	def count(cls, service) :
		r""" Use this API to count rewriteglobal_rewritepolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = rewriteglobal_rewritepolicy_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		r""" Use this API to count the filtered set of rewriteglobal_rewritepolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = rewriteglobal_rewritepolicy_binding()
	...
	class Type:
		...
		SIPTCP_RES_OVERRIDE = "SIPTCP_RES_OVERRIDE"
		SIPTCP_RES_DEFAULT = "SIPTCP_RES_DEFAULT"
		...
		RADIUS_RES_OVERRIDE = "RADIUS_RES_OVERRIDE"
		RADIUS_RES_DEFAULT = "RADIUS_RES_DEFAULT"
		DNS_REQ_OVERRIDE = "DNS_REQ_OVERRIDE"
		DNS_REQ_DEFAULT = "DNS_REQ_DEFAULT"
		DNS_RES_OVERRIDE = "DNS_RES_OVERRIDE"
		DNS_RES_DEFAULT = "DNS_RES_DEFAULT"
