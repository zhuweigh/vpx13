...
class policymap(base_resource) :
	...
	def mappolicyname(self) :
		r"""Name for the map policy. Must begin with a letter, number, or the underscore (_) character and must consist only of letters, numbers, and the hash (#), period (.), colon (:), space ( ), at (@), equals (=), hyphen (-), and underscore (_) characters.
	...
	@property
	def sd(self) :
		r"""Publicly known source domain name. This is the domain name with which a client request arrives at a reverse proxy virtual server for cache redirection. If you specify a source domain, you must specify a target domain.<br/>Minimum length =  1.
		"""
		try :
			return self._sd
		except Exception as e:
	...
	@property
	def su(self) :
		r"""Source URL. Specify all or part of the source URL, in the following format: /[[prefix] [*]] [.suffix].<br/>Minimum length =  1.
		"""
		try :
			return self._su
		except Exception as e:
	...
	@property
	def td(self) :
		r"""Target domain name sent to the server. The source domain name is replaced with this domain name.<br/>Minimum length =  1.
		"""
		try :
			return self._td
		except Exception as e:
	...
	@property
	def tu(self) :
		r"""Target URL. Specify the target URL in the following format: /[[prefix] [*]][.suffix].<br/>Minimum length =  1.
		"""
		try :
			return self._tu
		except Exception as e:
	...
	def add(cls, client, resource) :
		r""" Use this API to add policymap.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete policymap.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the policymap resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = policymap()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of policymap resources.
	...
	def count(cls, client) :
		r""" Use this API to count the policymap resources configured on NetScaler.
		"""
		try :
			obj = policymap()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of policymap resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = policymap()
