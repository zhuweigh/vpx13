...
class netbridge(base_resource) :
	...
	def vxlanvlanmap(self) :
		r"""The vlan to vxlan mapping to be applied to this netbridge.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add netbridge.
		"""
		try :
	...
	def update(cls, client, resource) :
		r""" Use this API to update netbridge.
		"""
		try :
			if type(resource) is not list :
				updateresource = netbridge()
				updateresource.name = resource.name
				updateresource.vxlanvlanmap = resource.vxlanvlanmap
				return updateresource.update_resource(client)
			else :
				if (resource and len(resource) > 0) :
					updateresources = [ netbridge() for _ in range(len(resource))]
					for i in range(len(resource)) :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of netbridge resource.
		Properties that need to be unset are specified in args array.
		"""
		try :
			if type(resource) is not list :
				unsetresource = netbridge()
				...
				if type(resource[0]) != cls :
					if (resource and len(resource) > 0) :
						unsetresources = [ netbridge() for _ in range(len(resource))]
						for i in range(len(resource)) :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete netbridge.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the netbridge resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = netbridge()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of netbridge resources.
	...
	def count(cls, client) :
		r""" Use this API to count the netbridge resources configured on NetScaler.
		"""
		try :
			obj = netbridge()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of netbridge resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = netbridge()
