...
class rsskeytype(base_resource) :
	...
	@property
	def rsstype(self) :
		r"""Type of RSS key, possible values are SYMMETRIC and ASYMMETRIC.<br/>Default value: ASYMMETRIC<br/>Possible values = ASYMMETRIC, SYMMETRIC.
		"""
		try :
	...
	def update(cls, client, resource) :
		r""" Use this API to update rsskeytype.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the rsskeytype resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = rsskeytype()
