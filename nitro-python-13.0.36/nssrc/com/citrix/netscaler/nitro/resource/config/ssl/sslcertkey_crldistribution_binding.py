...
class sslcertkey_crldistribution_binding(base_resource) :
	...
	def get(cls, service, certkey="", option_="") :
		r""" Use this API to fetch sslcertkey_crldistribution_binding resources.
		"""
		try :
			if not certkey :
	...
	def get_filtered(cls, service, certkey, filter_) :
		r""" Use this API to fetch filtered set of sslcertkey_crldistribution_binding resources.
	...
	def count(cls, service, certkey) :
		r""" Use this API to count sslcertkey_crldistribution_binding resources configued on NetScaler.
		"""
		try :
			obj = sslcertkey_crldistribution_binding()
			obj.certkey = certkey
	...
	def count_filtered(cls, service, certkey, filter_) :
		r""" Use this API to count the filtered set of sslcertkey_crldistribution_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslcertkey_crldistribution_binding()
