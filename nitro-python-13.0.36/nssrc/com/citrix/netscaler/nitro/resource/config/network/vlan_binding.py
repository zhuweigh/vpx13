...
class vlan_binding(base_resource):
	...
	@property
	def id(self) :
		r"""Integer that uniquely identifies the VLAN for which the details are to be displayed.<br/>Minimum value =  1<br/>Maximum value =  4094.
		"""
		try :
			return self._id
	...
	def vlan_interface_bindings(self) :
		r"""interface that can be bound to vlan.
		"""
		try :
	...
	def vlan_nsip6_bindings(self) :
		r"""nsip6 that can be bound to vlan.
		"""
		try :
	...
	def vlan_nsip_bindings(self) :
		r"""nsip that can be bound to vlan.
		"""
		try :
	...
	def vlan_linkset_bindings(self) :
		r"""linkset that can be bound to vlan.
		"""
		try :
	...
	def vlan_channel_bindings(self) :
		r"""channel that can be bound to vlan.
		"""
		try :
	...
	def get(self, service, id="", option_="") :
		r""" Use this API to fetch vlan_binding resource.
		"""
		try :
			if not id :
				obj = vlan_binding()
