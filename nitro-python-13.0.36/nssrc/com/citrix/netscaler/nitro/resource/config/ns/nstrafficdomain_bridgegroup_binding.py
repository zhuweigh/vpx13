...
class nstrafficdomain_bridgegroup_binding(base_resource) :
	...
	def bridgegroup(self) :
		r"""ID of the configured bridge to bind to this traffic domain. More than one bridge group can be bound to a traffic domain, but the same bridge group cannot be a part of multiple traffic domains.<br/>Minimum value =  1<br/>Maximum value =  1000.
		"""
		try :
	...
	def get(cls, service, td="", option_="") :
		r""" Use this API to fetch nstrafficdomain_bridgegroup_binding resources.
		"""
		try :
			if not td :
	...
	def get_filtered(cls, service, td, filter_) :
		r""" Use this API to fetch filtered set of nstrafficdomain_bridgegroup_binding resources.
	...
	def count(cls, service, td) :
		r""" Use this API to count nstrafficdomain_bridgegroup_binding resources configued on NetScaler.
		"""
		try :
			obj = nstrafficdomain_bridgegroup_binding()
			obj.td = td
	...
	def count_filtered(cls, service, td, filter_) :
		r""" Use this API to count the filtered set of nstrafficdomain_bridgegroup_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = nstrafficdomain_bridgegroup_binding()
