...
class hanode_binding(base_resource):
	...
	@property
	def id(self) :
		r"""ID of the node whose HA settings you want to display. (The ID of the local node is always 0.).<br/>Minimum value =  0<br/>Maximum value =  64.
		"""
		try :
			return self._id
	...
	def hanode_routemonitor_bindings(self) :
		r"""routemonitor that can be bound to hanode.
		"""
		try :
	...
	def hanode_partialfailureinterfaces_bindings(self) :
		r"""partialfailureinterfaces that can be bound to hanode.
		"""
		try :
	...
	def hanode_fis_bindings(self) :
		r"""fis that can be bound to hanode.
		"""
		try :
	...
	def hanode_routemonitor6_bindings(self) :
		r"""routemonitor6 that can be bound to hanode.
		"""
		try :
	...
	def hanode_ci_bindings(self) :
		r"""ci that can be bound to hanode.
		"""
		try :
	...
	def get(self, service, id="", option_="") :
		r""" Use this API to fetch hanode_binding resource.
		"""
		try :
			if not id :
				obj = hanode_binding()
