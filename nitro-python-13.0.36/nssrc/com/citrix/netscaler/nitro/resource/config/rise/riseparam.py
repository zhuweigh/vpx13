...
class riseparam(base_resource) :
	...
	def __init__(self) :
		self._directmode = None
		self._indirectmode = None

	@property
	def directmode(self) :
		r"""RISE Direct attach mode.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def indirectmode(self) :
		r"""RISE Indirect attach mode.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def update(cls, client, resource) :
		r""" Use this API to update riseparam.
		"""
		try :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of riseparam resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the riseparam resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = riseparam()
