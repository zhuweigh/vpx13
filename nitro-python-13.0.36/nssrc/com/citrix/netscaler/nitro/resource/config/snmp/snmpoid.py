...
class snmpoid(base_resource) :
	...
	@property
	def entitytype(self) :
		r"""The type of entity whose SNMP OIDs you want to displayType of entity whose SNMP OIDs you want the Citrix ADC to display.<br/>Possible values = VSERVER, SERVICE, SERVICEGROUP.
		"""
		try :
	...
	@property
	def name(self) :
		r"""Name of the entity whose SNMP OID you want the Citrix ADC to display.<br/>Minimum length =  1.
		"""
		try :
			return self._name
		except Exception as e:
