			...
			if type(resource) is not list :
				...
				if (resource and len(resource) > 0) :
					...
					for i in range(len(resource)) :
						...
						addresources[i].autodisablegraceful = resource[i].autodisablegraceful
						addresources[i].autodisabledelay = resource[i].autodisabledelay
			...
			if type(resource) is not list :
				...
				if (resource and len(resource) > 0) :
					...
					for i in range(len(resource)) :
						...
						updateresources[i].autodisablegraceful = resource[i].autodisablegraceful
						updateresources[i].autodisabledelay = resource[i].autodisabledelay
