...
class lsnparameter(base_resource) :
	...
	@property
	def memlimit(self) :
		r"""Amount of Citrix ADC memory to reserve for the LSN feature, in multiples of 2MB.
	...
	def maxmemlimit(self) :
		r"""Maximum amount of Citrix ADC memory that can be reserved for the LSN feature.
		"""
		try :
