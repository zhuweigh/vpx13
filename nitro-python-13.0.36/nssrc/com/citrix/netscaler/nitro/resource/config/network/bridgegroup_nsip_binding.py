...
class bridgegroup_nsip_binding(base_resource) :
	...
	@property
	def netmask(self) :
		r"""The network mask for the subnet defined for the bridge group.
		"""
		try :
	...
	def get(cls, service, id="", option_="") :
		r""" Use this API to fetch bridgegroup_nsip_binding resources.
		"""
		try :
			if not id :
	...
	def get_filtered(cls, service, id, filter_) :
		r""" Use this API to fetch filtered set of bridgegroup_nsip_binding resources.
	...
	def count(cls, service, id) :
		r""" Use this API to count bridgegroup_nsip_binding resources configued on NetScaler.
		"""
		try :
			obj = bridgegroup_nsip_binding()
			obj.id = id
	...
	def count_filtered(cls, service, id, filter_) :
		r""" Use this API to count the filtered set of bridgegroup_nsip_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = bridgegroup_nsip_binding()
