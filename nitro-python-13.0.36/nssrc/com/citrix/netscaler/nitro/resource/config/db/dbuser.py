...
class dbuser(base_resource) :
	...
	@property
	def username(self) :
		r"""Name of the database user. Must be the same as the user name specified in the database.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def password(self) :
		r"""Password for logging on to the database. Must be the same as the password specified in the database.<br/>Minimum length =  1.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete dbuser.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update dbuser.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the dbuser resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = dbuser()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of dbuser resources.
	...
	def count(cls, client) :
		r""" Use this API to count the dbuser resources configured on NetScaler.
		"""
		try :
			obj = dbuser()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of dbuser resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = dbuser()
