...
class nsevents(base_resource) :
	...
	@property
	def data0(self) :
		r"""additional event information.
		"""
		try :
			return self._data0
		except Exception as e:
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the nsevents resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = nsevents()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of nsevents resources.
	...
	def count(cls, client) :
		r""" Use this API to count the nsevents resources configured on NetScaler.
		"""
		try :
			obj = nsevents()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of nsevents resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = nsevents()
