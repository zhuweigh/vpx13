...
class l2param(base_resource) :
	...
	def macmodefwdmypkt(self) :
		r"""Allows MAC mode vserver to pick and forward the packets even if it is destined to Citrix ADC owned VIP.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def usemymac(self) :
		r"""Use Citrix ADC MAC for all outgoing packets.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def proxyarp(self) :
		r"""Proxies the ARP as Citrix ADC MAC for FreeBSD.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
