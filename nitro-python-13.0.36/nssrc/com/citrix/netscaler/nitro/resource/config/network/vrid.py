...
class vrid(base_resource) :
	...
	@property
	def ownernode(self) :
		r"""In a cluster setup, assign a cluster node as the owner of this VMAC address for IP based VRRP configuration. If no owner is configured, owner node is displayed as ALL and one node is dynamically elected as the owner.<br/>Maximum length =  31.
		"""
		try :
	...
	@property
	def all(self) :
		r"""Remove all the configured VMAC addresses from the Citrix ADC.
		"""
		try :
			return self._all
		except Exception as e:
	...
	@property
	def type(self) :
		r"""Indicates whether this VRID entry was added manually or dynamically. When you manually add a VRID entry, the value for this parameter is STATIC. Otherwise, it is DYNAMIC.<br/>Possible values = STATIC, DYNAMIC.
		"""
		try :
			return self._type
		except Exception as e:
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of vrid resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the vrid resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = vrid()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of vrid resources.
	...
	def count(cls, client) :
		r""" Use this API to count the vrid resources configured on NetScaler.
		"""
		try :
			obj = vrid()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of vrid resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vrid()
