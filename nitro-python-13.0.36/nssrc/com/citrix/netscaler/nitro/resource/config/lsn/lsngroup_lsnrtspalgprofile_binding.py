...
class lsngroup_lsnrtspalgprofile_binding(base_resource) :
	...
	def rtspalgprofilename(self) :
		r"""The name of the LSN RTSP ALG Profile.
		"""
		try :
	...
	def get(cls, service, groupname="", option_="") :
		r""" Use this API to fetch lsngroup_lsnrtspalgprofile_binding resources.
		"""
		try :
			if not groupname :
	...
	def get_filtered(cls, service, groupname, filter_) :
		r""" Use this API to fetch filtered set of lsngroup_lsnrtspalgprofile_binding resources.
	...
	def count(cls, service, groupname) :
		r""" Use this API to count lsngroup_lsnrtspalgprofile_binding resources configued on NetScaler.
		"""
		try :
			obj = lsngroup_lsnrtspalgprofile_binding()
			obj.groupname = groupname
	...
	def count_filtered(cls, service, groupname, filter_) :
		r""" Use this API to count the filtered set of lsngroup_lsnrtspalgprofile_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = lsngroup_lsnrtspalgprofile_binding()
