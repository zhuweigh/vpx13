...
class appfwprofile_xmlattachmenturl_binding(base_resource) :
	...
	"""
	def __init__(self) :
		self._xmlattachmenturl = None
		self._xmlmaxattachmentsizecheck = None
		self._xmlmaxattachmentsize = None
		self._xmlattachmentcontenttypecheck = None
		self._xmlattachmentcontenttype = None
		self._state = None
		self._comment = None
		self._name = None
		self.___count = None
	...
	def xmlattachmenturl(self) :
		r"""XML attachment URL regular expression length.
		"""
		try :
	...
	def xmlmaxattachmentsize(self) :
		r"""Specify maximum attachment size.
		"""
		try :
	...
	def xmlmaxattachmentsizecheck(self) :
		r"""State if XML Max attachment size Check is ON or OFF. Protects against XML requests with large attachment data.<br/>Possible values = ON, OFF.
		"""
		try :
	...
	def xmlattachmentcontenttypecheck(self) :
		r"""State if XML attachment content-type check is ON or OFF. Protects against XML requests with illegal attachments.<br/>Possible values = ON, OFF.
		"""
		try :
	...
	def xmlattachmentcontenttype(self) :
		r"""Specify content-type regular expression.
		"""
		try :
	...
	def get(cls, service, name="", option_="") :
		r""" Use this API to fetch appfwprofile_xmlattachmenturl_binding resources.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, service, name, filter_) :
		r""" Use this API to fetch filtered set of appfwprofile_xmlattachmenturl_binding resources.
	...
	def count(cls, service, name) :
		r""" Use this API to count appfwprofile_xmlattachmenturl_binding resources configued on NetScaler.
		"""
		try :
			obj = appfwprofile_xmlattachmenturl_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		r""" Use this API to count the filtered set of appfwprofile_xmlattachmenturl_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appfwprofile_xmlattachmenturl_binding()
