...
class auditmessageaction(base_resource) :
	...
	def __init__(self) :
		...
		self._logtonewnslog = None
		self._bypasssafetycheck = None
		self._loglevel1 = None
		self._hits = None
	...
	@property
	def name(self) :
		r"""Name of the audit message action. Must begin with a letter, number, or the underscore character (_), and must contain only letters, numbers, and the hyphen (-), period (.) pound (#), space ( ), at (@), equals (=), colon (:), and underscore characters. Cannot be changed after the message action is added.
	...
	@property
	def loglevel(self) :
		r"""Audit log level, which specifies the severity level of the log message being generated.. 
	...
	def stringbuilderexpr(self) :
		r"""Default-syntax expression that defines the format and content of the log message.
		"""
		try :
	...
	def logtonewnslog(self) :
		r"""Send the message to the new nslog.<br/>Possible values = YES, NO.
		"""
		try :
	...
	def bypasssafetycheck(self) :
		r"""Bypass the safety check and allow unsafe expressions.<br/>Default value: NO<br/>Possible values = YES, NO.
		"""
		try :
	...
	@property
	def loglevel1(self) :
		r""".<br/>Possible values = ALL, EMERGENCY, ALERT, CRITICAL, ERROR, WARNING, NOTICE, INFORMATIONAL, DEBUG, NONE.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add auditmessageaction.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete auditmessageaction.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update auditmessageaction.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of auditmessageaction resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the auditmessageaction resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of auditmessageaction resources.
	...
	def count(cls, client) :
		r""" Use this API to count the auditmessageaction resources configured on NetScaler.
		"""
		try :
			obj = auditmessageaction()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of auditmessageaction resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = auditmessageaction()
