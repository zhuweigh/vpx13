...
class dnstxtrec(base_resource) :
	...
	@property
	def domain(self) :
		r"""Name of the domain for the TXT record.<br/>Minimum length =  1.
		"""
		try :
			return self._domain
	...
	@property
	def recordid(self) :
		r"""Unique, internally generated record ID. View the details of the TXT record to obtain its record ID. Mutually exclusive with the string parameter.<br/>Minimum length =  1<br/>Maximum length =  65535.
		"""
		try :
	...
	@property
	def ecssubnet(self) :
		r"""Subnet for which the cached TXT record need to be removed.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add dnstxtrec.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete dnstxtrec.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the dnstxtrec resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = dnstxtrec()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of dnstxtrec resources.
	...
	def count(cls, client) :
		r""" Use this API to count the dnstxtrec resources configured on NetScaler.
		"""
		try :
			obj = dnstxtrec()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of dnstxtrec resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = dnstxtrec()
