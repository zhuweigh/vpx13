...
class cachepolicy_cachepolicylabel_binding(base_resource) :
	...
	def get(cls, service, policyname="", option_="") :
		r""" Use this API to fetch cachepolicy_cachepolicylabel_binding resources.
		"""
		try :
			if not policyname :
	...
	def get_filtered(cls, service, policyname, filter_) :
		r""" Use this API to fetch filtered set of cachepolicy_cachepolicylabel_binding resources.
	...
	def count(cls, service, policyname) :
		r""" Use this API to count cachepolicy_cachepolicylabel_binding resources configued on NetScaler.
		"""
		try :
			obj = cachepolicy_cachepolicylabel_binding()
			obj.policyname = policyname
	...
	def count_filtered(cls, service, policyname, filter_) :
		r""" Use this API to count the filtered set of cachepolicy_cachepolicylabel_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = cachepolicy_cachepolicylabel_binding()
