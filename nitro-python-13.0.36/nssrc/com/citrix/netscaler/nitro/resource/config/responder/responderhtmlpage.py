...
class responderhtmlpage(base_resource) :
	...
	@property
	def src(self) :
		r"""Local path to and name of, or URL \(protocol, host, path, and file name\) for, the file in which to store the imported HTML page.
	...
	@property
	def name(self) :
		r"""Name to assign to the HTML page object on the Citrix ADC.<br/>Minimum length =  1<br/>Maximum length =  31.
		"""
		try :
			return self._name
		except Exception as e:
	...
	@property
	def comment(self) :
		r"""Any comments to preserve information about the HTML page object.<br/>Maximum length =  128.
		"""
		try :
	...
	def Import(cls, client, resource) :
		r""" Use this API to Import responderhtmlpage.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete responderhtmlpage.
		"""
		try :
			if type(resource) is not list :
	...
	def change(cls, client, resource) :
		r""" Use this API to change responderhtmlpage.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the responderhtmlpage resources that are configured on netscaler.
		"""
		try :
			if not name :
