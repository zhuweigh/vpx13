...
class lbmonbindings_binding(base_resource):
	...
	def lbmonbindings_service_bindings(self) :
		r"""service that can be bound to lbmonbindings.
		"""
		try :
	...
	def lbmonbindings_servicegroup_bindings(self) :
		r"""servicegroup that can be bound to lbmonbindings.
		"""
		try :
	...
	@property
	def lbmonbindings_gslbservicegroup_bindings(self) :
		r"""gslbservicegroup that can be bound to lbmonbindings.
		"""
		try :
			return self._lbmonbindings_gslbservicegroup_binding
		except Exception as e:
			raise e
	...
	@classmethod
	def get(self, service, monitorname="", option_="") :
		r""" Use this API to fetch lbmonbindings_binding resource.
		"""
		try :
			if not monitorname :
				obj = lbmonbindings_binding()
				response = obj.get_resources(service, option_)
			elif type(monitorname) is not list :
				obj = lbmonbindings_binding()
