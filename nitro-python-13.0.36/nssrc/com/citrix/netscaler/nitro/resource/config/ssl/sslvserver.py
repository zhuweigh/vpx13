...
class sslvserver(base_resource) :
	...
	@property
	def dhcount(self) :
		r"""Number of interactions, between the client and the Citrix ADC, after which the DH private-public pair is regenerated. A value of zero (0) specifies infinite use (no refresh).<br/>Maximum length =  65534.
		"""
		try :
	...
	@property
	def tls11(self) :
		r"""State of TLSv1.1 protocol support for the SSL Virtual Server.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._tls11
		except Exception as e:
	...
	@property
	def tls12(self) :
		r"""State of TLSv1.2 protocol support for the SSL Virtual Server.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._tls12
		except Exception as e:
	...
	@property
	def tls13(self) :
		r"""State of TLSv1.3 protocol support for the SSL Virtual Server.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._tls13
		except Exception as e:
	...
	@property
	def hsts(self) :
		r"""State of HSTS protocol support for the SSL Virtual Server. Using HSTS, a server can enforce the use of an HTTPS connection for all communication with a client.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._hsts
		except Exception as e:
