...
class tmtrafficpolicy(base_resource) :
	...
	@property
	def name(self) :
		r"""Name for the traffic policy. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@), equals (=), and hyphen (-) characters. Cannot be changed after the policy is created.
	...
	@property
	def rule(self) :
		r"""Name of the Citrix ADC named expression, or an expression, that the policy uses to determine whether to apply certain action on the current traffic.
		"""
		try :
			return self._rule
		except Exception as e:
	...
	@property
	def action(self) :
		r"""Name of the action to apply to requests or connections that match this policy.<br/>Minimum length =  1.
		"""
		try :
			return self._action
		except Exception as e:
	...
	def add(cls, client, resource) :
		r""" Use this API to add tmtrafficpolicy.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete tmtrafficpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update tmtrafficpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of tmtrafficpolicy resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the tmtrafficpolicy resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = tmtrafficpolicy()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of tmtrafficpolicy resources.
	...
	def count(cls, client) :
		r""" Use this API to count the tmtrafficpolicy resources configured on NetScaler.
		"""
		try :
			obj = tmtrafficpolicy()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of tmtrafficpolicy resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = tmtrafficpolicy()
