...
class authenticationdfapolicy(base_resource) :
	...
	@property
	def action(self) :
		r"""Name of the DFA action to perform if the policy matches.<br/>Minimum length =  1.
		"""
		try :
			return self._action
		except Exception as e:
	...
	def add(cls, client, resource) :
		r""" Use this API to add authenticationdfapolicy.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete authenticationdfapolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update authenticationdfapolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the authenticationdfapolicy resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of authenticationdfapolicy resources.
	...
	def count(cls, client) :
		r""" Use this API to count the authenticationdfapolicy resources configured on NetScaler.
		"""
		try :
			obj = authenticationdfapolicy()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of authenticationdfapolicy resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = authenticationdfapolicy()
