...
class authorizationpolicy_binding(base_resource):
	...
	def authorizationpolicy_lbvserver_bindings(self) :
		r"""lbvserver that can be bound to authorizationpolicy.
		"""
		try :
	...
	def authorizationpolicy_aaagroup_bindings(self) :
		r"""aaagroup that can be bound to authorizationpolicy.
		"""
		try :
	...
	def authorizationpolicy_csvserver_bindings(self) :
		r"""csvserver that can be bound to authorizationpolicy.
		"""
		try :
	...
	def authorizationpolicy_authorizationpolicylabel_bindings(self) :
		r"""authorizationpolicylabel that can be bound to authorizationpolicy.
		"""
		try :
	...
	def authorizationpolicy_aaauser_bindings(self) :
		r"""aaauser that can be bound to authorizationpolicy.
		"""
		try :
	...
	def get(self, service, name="", option_="") :
		r""" Use this API to fetch authorizationpolicy_binding resource.
		"""
		try :
			if not name :
