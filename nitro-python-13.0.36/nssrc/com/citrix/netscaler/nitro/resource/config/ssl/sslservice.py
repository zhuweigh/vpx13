...
class sslservice(base_resource) :
	...
	@property
	def dhcount(self) :
		r"""Number of interactions, between the client and the Citrix ADC, after which the DH private-public pair is regenerated. A value of zero (0) specifies infinite use (no refresh). This parameter is not applicable when configuring a backend service. Allowed DH count values are 0 and >= 500.<br/>Maximum length =  65534.
		"""
		try :
	...
	@property
	def tls11(self) :
		r"""State of TLSv1.1 protocol support for the SSL service.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._tls11
		except Exception as e:
	...
	@property
	def tls12(self) :
		r"""State of TLSv1.2 protocol support for the SSL service.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._tls12
		except Exception as e:
	...
	@property
	def tls13(self) :
		r"""State of TLSv1.3 protocol support for the SSL service.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._tls13
		except Exception as e:
	...
	def strictsigdigestcheck(self) :
		r"""Parameter indicating to check whether peer's certificate during TLS1.2 handshake is signed with one of signature-hash combination supported by Citrix ADC.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
