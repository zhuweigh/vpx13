...
class gslbsite_binding(base_resource):
	...
	@property
	def gslbsite_gslbservicegroupmember_bindings(self) :
		r"""gslbservicegroupmember that can be bound to gslbsite.
		"""
		try :
			return self._gslbsite_gslbservicegroupmember_binding
		except Exception as e:
			raise e

	@property
	def gslbsite_gslbservicegroup_bindings(self) :
		r"""gslbservicegroup that can be bound to gslbsite.
		"""
		try :
			return self._gslbsite_gslbservicegroup_binding
		except Exception as e:
			raise e
	...
	@classmethod
	def get(self, service, sitename="", option_="") :
		...
		try :
			...
			elif type(sitename) is not list :
				obj = gslbsite_binding()
