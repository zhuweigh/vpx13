...
class ntpserver(base_resource) :
	...
	def __init__(self) :
		...
		self._autokey = None
		self._key = None
		self._preferredntpserver = None
		self.___count = None

	@property
	def serverip(self) :
		r"""IP address of the NTP server.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def servername(self) :
		r"""Fully qualified domain name of the NTP server.
		"""
		try :
	...
	@property
	def minpoll(self) :
		r"""Minimum time after which the NTP server must poll the NTP messages. In seconds, expressed as a power of 2.<br/>Minimum length =  4<br/>Maximum length =  17.
		"""
		try :
	...
	@property
	def maxpoll(self) :
		r"""Maximum time after which the NTP server must poll the NTP messages. In seconds, expressed as a power of 2.<br/>Minimum length =  4<br/>Maximum length =  17.
		"""
		try :
	...
	@property
	def autokey(self) :
		r"""Use the Autokey protocol for key management for this server, with the cryptographic values (for example, symmetric key, host and public certificate files, and sign key) generated by the ntp-keygen utility. To require authentication for communication with the server, you must set either the value of this parameter or the key parameter.
		"""
		try :
	...
	def preferredntpserver(self) :
		r"""Preferred NTP server. The Citrix ADC chooses this NTP server for time synchronization among a set of correctly operating hosts.<br/>Default value: NO<br/>Possible values = YES, NO.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add ntpserver.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete ntpserver.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update ntpserver.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of ntpserver resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the ntpserver resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = ntpserver()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of ntpserver resources.
	...
	def count(cls, client) :
		r""" Use this API to count the ntpserver resources configured on NetScaler.
		"""
		try :
			obj = ntpserver()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of ntpserver resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = ntpserver()
