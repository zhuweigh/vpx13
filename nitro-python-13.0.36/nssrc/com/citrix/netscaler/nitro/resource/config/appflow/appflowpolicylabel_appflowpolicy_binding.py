...
class appflowpolicylabel_appflowpolicy_binding(base_resource) :
	...
	@property
	def labelname(self) :
		r"""Name of the policy label to which to bind the policy.<br/>Minimum length =  1.
		"""
		try :
	...
	def get(cls, service, labelname="", option_="") :
		r""" Use this API to fetch appflowpolicylabel_appflowpolicy_binding resources.
		"""
		try :
			if not labelname :
	...
	def get_filtered(cls, service, labelname, filter_) :
		r""" Use this API to fetch filtered set of appflowpolicylabel_appflowpolicy_binding resources.
	...
	def count(cls, service, labelname) :
		r""" Use this API to count appflowpolicylabel_appflowpolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = appflowpolicylabel_appflowpolicy_binding()
			obj.labelname = labelname
	...
	def count_filtered(cls, service, labelname, filter_) :
		r""" Use this API to count the filtered set of appflowpolicylabel_appflowpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appflowpolicylabel_appflowpolicy_binding()
