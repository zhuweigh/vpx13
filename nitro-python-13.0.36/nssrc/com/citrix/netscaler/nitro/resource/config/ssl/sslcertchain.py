...
class sslcertchain(base_resource) :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the sslcertchain resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = sslcertchain()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of sslcertchain resources.
	...
	def count(cls, client) :
		r""" Use this API to count the sslcertchain resources configured on NetScaler.
		"""
		try :
			obj = sslcertchain()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of sslcertchain resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslcertchain()
