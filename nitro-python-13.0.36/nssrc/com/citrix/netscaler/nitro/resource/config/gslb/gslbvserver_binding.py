...
class gslbvserver_binding(base_resource):
	...
	@property
	def gslbvserver_gslbservicegroupmember_bindings(self) :
		r"""gslbservicegroupmember that can be bound to gslbvserver.
		"""
		try :
			return self._gslbvserver_gslbservicegroupmember_binding
		except Exception as e:
			raise e
	...
	@property
	def gslbvserver_gslbservicegroup_bindings(self) :
		r"""gslbservicegroup that can be bound to gslbvserver.
		"""
		try :
			return self._gslbvserver_gslbservicegroup_binding
		except Exception as e:
			raise e
