...
class snmpmanager(base_resource) :
	...
	@property
	def ipaddress(self) :
		r"""IP address of the SNMP manager. Can be an IPv4 or IPv6 address. You can instead specify an IPv4 network address or IPv6 network prefix if you want the Citrix ADC to respond to SNMP queries from any device on the specified network. Alternatively, instead of an IPv4 address, you can specify a host name that has been assigned to an SNMP manager. If you do so, you must add a DNS name server that resolves the host name of the SNMP manager to its IP address. 
		Note: The Citrix ADC does not support host names for SNMP managers that have IPv6 addresses.<br/>Minimum length =  1<br/>Maximum length =  255.
		"""
		try :
	...
	@property
	def netmask(self) :
		r"""Subnet mask associated with an IPv4 network address. If the IP address specifies the address or host name of a specific host, accept the default value of 255.255.255.255.
		"""
		try :
	...
	@property
	def ip(self) :
		r"""The resolved IP address of the hostname manager.
		"""
		try :
			return self._ip
		except Exception as e:
	...
	@property
	def domain(self) :
		r"""IP address of manager. It will be zero for hostname manager.
		"""
		try :
			return self._domain
		except Exception as e:
	...
	def add(cls, client, resource) :
		r""" Use this API to add snmpmanager.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete snmpmanager.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update snmpmanager.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of snmpmanager resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the snmpmanager resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = snmpmanager()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of snmpmanager resources.
	...
	def count(cls, client) :
		r""" Use this API to count the snmpmanager resources configured on NetScaler.
		"""
		try :
			obj = snmpmanager()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of snmpmanager resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = snmpmanager()
