...
class filterprebodyinjection(base_resource) :
	...
	@property
	def prebody(self) :
		r"""Name of file whose contents are to be inserted before the response body.<br/>Minimum length =  1.
		"""
		try :
	...
	def update(cls, client, resource) :
		r""" Use this API to update filterprebodyinjection.
		"""
		try :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of filterprebodyinjection resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the filterprebodyinjection resources that are configured on netscaler.
		"""
		try :
			if not name :
