...
class csparameter(base_resource) :
	...
	def stateupdate(self) :
		r"""Specifies whether the virtual server checks the attached load balancing server for state information.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def update(cls, client, resource) :
		r""" Use this API to update csparameter.
		"""
		try :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of csparameter resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the csparameter resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = csparameter()
