...
class lbmonbindings_servicegroup_binding(base_resource) :
	...
	def get(cls, service, monitorname="", option_="") :
		r""" Use this API to fetch lbmonbindings_servicegroup_binding resources.
		"""
		try :
			if not monitorname :
	...
	def get_filtered(cls, service, monitorname, filter_) :
		r""" Use this API to fetch filtered set of lbmonbindings_servicegroup_binding resources.
	...
	def count(cls, service, monitorname) :
		r""" Use this API to count lbmonbindings_servicegroup_binding resources configued on NetScaler.
		"""
		try :
			obj = lbmonbindings_servicegroup_binding()
			obj.monitorname = monitorname
	...
	def count_filtered(cls, service, monitorname, filter_) :
		r""" Use this API to count the filtered set of lbmonbindings_servicegroup_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = lbmonbindings_servicegroup_binding()
