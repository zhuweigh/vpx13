...
class iptunnel(base_resource) :
	...
	@property
	def local(self) :
		r"""Type of Citrix ADC owned public IPv4 address, configured on the local Citrix ADC and used to set up the tunnel.
		"""
		try :
			return self._local
		except Exception as e:
	...
	@property
	def protocol(self) :
		r"""Name of the protocol to be used on this tunnel.<br/>Default value: IPIP<br/>Possible values = IPIP, GRE, IPSEC, UDP.
		"""
		try :
