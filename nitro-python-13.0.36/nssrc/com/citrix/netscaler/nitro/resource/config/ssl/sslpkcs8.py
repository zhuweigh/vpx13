...
class sslpkcs8(base_resource) :
	...
	@property
	def pkcs8file(self) :
		r"""Name for and, optionally, path to, the output file where the PKCS#8 format key file is stored. /nsconfig/ssl/ is the default path.<br/>Maximum length =  63.
		"""
		try :
	...
	@property
	def keyfile(self) :
		r"""Name of and, optionally, path to the input key file to be converted from PEM or DER format to PKCS#8 format. /nsconfig/ssl/ is the default path.<br/>Maximum length =  63.
		"""
		try :
	...
	@property
	def keyform(self) :
		r"""Format in which the key file is stored on the appliance.<br/>Default value: PEM<br/>Possible values = DER, PEM.
		"""
		try :
	...
	@property
	def password(self) :
		r"""Password to assign to the file if the key is encrypted. Applies only for PEM format files.<br/>Minimum length =  1<br/>Maximum length =  31.
		"""
		try :
	...
	def convert(cls, client, resource) :
		r""" Use this API to convert sslpkcs8.
		"""
		try :
