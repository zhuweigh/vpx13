...
class transformpolicy(base_resource) :
	...
	@property
	def name(self) :
		r"""Name for the URL Transformation policy.
	...
	@property
	def rule(self) :
		r"""Expression, or name of a named expression, against which to evaluate traffic.
	...
	def profilename(self) :
		r"""Name of the URL Transformation profile to use to transform requests and responses that match the policy.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def comment(self) :
		r"""Any comments to preserve information about this URL Transformation policy.
		"""
		try :
	...
	@property
	def logaction(self) :
		r"""Log server to use to log connections that match this policy.
		"""
		try :
	...
	@property
	def newname(self) :
		r"""New name for the policy. Must begin with a letter, number, or the underscore character (_), and must contain only letters, numbers, and the hyphen (-), period (.) pound (#), space ( ), at (@), equals (=), colon (:), and underscore characters.
		The following requirement applies only to the Citrix ADC CLI:
		If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, ^A"my transform policy^A" or ^A'my transform policy).<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def isdefault(self) :
		r"""A value of true is returned if it is a default transform policy.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add transformpolicy.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete transformpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update transformpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of transformpolicy resource.
	...
	def rename(cls, client, resource, new_name) :
		r""" Use this API to rename a transformpolicy resource.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the transformpolicy resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = transformpolicy()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of transformpolicy resources.
	...
	def count(cls, client) :
		r""" Use this API to count the transformpolicy resources configured on NetScaler.
		"""
		try :
			obj = transformpolicy()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of transformpolicy resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = transformpolicy()
