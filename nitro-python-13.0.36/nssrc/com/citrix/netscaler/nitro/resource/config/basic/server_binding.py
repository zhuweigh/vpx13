...
class server_binding(base_resource):
	...
	@property
	def server_gslbservicegroup_bindings(self) :
		r"""gslbservicegroup that can be bound to server.
		"""
		try :
			return self._server_gslbservicegroup_binding
		except Exception as e:
			raise e

	@property
	def server_servicegroup_bindings(self) :
		r"""servicegroup that can be bound to server.
		"""
		try :
	...
	def server_service_bindings(self) :
		r"""service that can be bound to server.
		"""
		try :
	...
	def server_gslbservice_bindings(self) :
		r"""gslbservice that can be bound to server.
		"""
		try :
	...
	def get(self, service, name="", option_="") :
		r""" Use this API to fetch server_binding resource.
		"""
		try :
			if not name :
				obj = server_binding()
