...
class authenticationepaaction(base_resource) :
	...
	def name(self) :
		...
		characters. Cannot be changed after epa action is created.The following requirement applies only to the Citrix ADC CLI:If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my aaa action" or 'my aaa action').<br/>Minimum length =  1.
		"""
		try :
			return self._name
