...
class authenticationldappolicy(base_resource) :
	...
	@property
	def rule(self) :
		r"""Name of the Citrix ADC named rule, or an expression, that the policy uses to determine whether to attempt to authenticate the user with the LDAP server.<br/>Minimum length =  1.
		"""
		try :
			return self._rule
		except Exception as e:
	...
	@property
	def reqaction(self) :
		r"""Name of the LDAP action to perform if the policy matches.<br/>Minimum length =  1.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add authenticationldappolicy.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete authenticationldappolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update authenticationldappolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of authenticationldappolicy resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the authenticationldappolicy resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of authenticationldappolicy resources.
	...
	def count(cls, client) :
		r""" Use this API to count the authenticationldappolicy resources configured on NetScaler.
		"""
		try :
			obj = authenticationldappolicy()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of authenticationldappolicy resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = authenticationldappolicy()
