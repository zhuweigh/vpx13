...
class appfwprofile_crosssitescripting_binding(base_resource) :
	...
	def as_value_type_xss(self) :
		r"""The web form value type.<br/>Possible values = Tag, Attribute, Pattern.
		"""
		try :
	...
	def get(cls, service, name="", option_="") :
		r""" Use this API to fetch appfwprofile_crosssitescripting_binding resources.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, service, name, filter_) :
		r""" Use this API to fetch filtered set of appfwprofile_crosssitescripting_binding resources.
	...
	def count(cls, service, name) :
		r""" Use this API to count appfwprofile_crosssitescripting_binding resources configued on NetScaler.
		"""
		try :
			obj = appfwprofile_crosssitescripting_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		r""" Use this API to count the filtered set of appfwprofile_crosssitescripting_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appfwprofile_crosssitescripting_binding()
