...
class dnscnamerec(base_resource) :
	...
	@property
	def aliasname(self) :
		r"""Alias for the canonical domain name.<br/>Minimum length =  1.
		"""
		try :
	...
	def canonicalname(self) :
		r"""Canonical domain name.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def ecssubnet(self) :
		r"""Subnet for which the cached CNAME record need to be removed.
		"""
		try :
	...
	def vservername(self) :
		r"""GSLB Vitual server name to which this domain is bound.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add dnscnamerec.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete dnscnamerec.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the dnscnamerec resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = dnscnamerec()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of dnscnamerec resources.
	...
	def count(cls, client) :
		r""" Use this API to count the dnscnamerec resources configured on NetScaler.
		"""
		try :
			obj = dnscnamerec()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of dnscnamerec resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = dnscnamerec()
