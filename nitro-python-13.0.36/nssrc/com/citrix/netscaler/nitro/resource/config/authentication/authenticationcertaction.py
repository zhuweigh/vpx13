...
class authenticationcertaction(base_resource) :
	...
	@property
	def name(self) :
		r"""Name for the client cert authentication server profile (action). 
	...
	@property
	def twofactor(self) :
		r"""Enables or disables two-factor authentication. 
	...
	def usernamefield(self) :
		r"""Client-cert field from which the username is extracted. Must be set to either ""Subject"" and ""Issuer"" (include both sets of double quotation marks).
	...
	def groupnamefield(self) :
		r"""Client-cert field from which the group is extracted.  Must be set to either ""Subject"" and ""Issuer"" (include both sets of double quotation marks).
		Format: <field>:<subfield>.<br/>Minimum length =  1.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add authenticationcertaction.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete authenticationcertaction.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update authenticationcertaction.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of authenticationcertaction resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the authenticationcertaction resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of authenticationcertaction resources.
	...
	def count(cls, client) :
		r""" Use this API to count the authenticationcertaction resources configured on NetScaler.
		"""
		try :
			obj = authenticationcertaction()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of authenticationcertaction resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = authenticationcertaction()
