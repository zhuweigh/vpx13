...
class caaction(base_resource) :
	...
	@property
	def name(self) :
		r"""Name of the content accelerator action. Must begin with an ASCII alphabetic or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@), equals (=), and hyphen (-) characters.
		"""
		try :
			return self._name
	...
	def accumressize(self) :
		r"""Size of the data, in KB, that the server must respond with. The Citrix ADC uses this data to compute a hash which is then used to lookup within the T2100 appliance.
		"""
		try :
	...
	@property
	def lbvserver(self) :
		r"""Name of the load balancing virtual server that has the T2100 appliances as services.
		"""
		try :
	...
	@property
	def comment(self) :
		r"""Information about the content accelerator action.
		"""
		try :
	...
	@property
	def type(self) :
		r"""Specifies whether the Citrix ADC must lookup for the response on the T2100 appliance or serve the response directly from the server.<br/>Possible values = nolookup, lookup, noop.
		"""
		try :
			return self._type
		except Exception as e:
	...
	@property
	def newname(self) :
		r"""New name for the content accelerator action. 
		...
		If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my content accelerator action" or 'my content accelerator action').<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def isdefault(self) :
		r"""A value of true is returned if it is a default content accelerator action.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add caaction.
		"""
		try :
	...
	def update(cls, client, resource) :
		r""" Use this API to update caaction.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of caaction resource.
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete caaction.
		"""
		try :
			if type(resource) is not list :
	...
	def rename(cls, client, resource, new_name) :
		r""" Use this API to rename a caaction resource.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the caaction resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = caaction()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of caaction resources.
	...
	def count(cls, client) :
		r""" Use this API to count the caaction resources configured on NetScaler.
		"""
		try :
			obj = caaction()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of caaction resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = caaction()
