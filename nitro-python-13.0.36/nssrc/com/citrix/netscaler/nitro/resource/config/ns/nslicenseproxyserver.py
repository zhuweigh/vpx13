...
class nslicenseproxyserver(base_resource) :
	...
	@property
	def serverip(self) :
		r"""IP address of the License proxy server.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def servername(self) :
		r"""Fully qualified domain name of the License proxy server.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add nslicenseproxyserver.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete nslicenseproxyserver.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update nslicenseproxyserver.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the nslicenseproxyserver resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of nslicenseproxyserver resources.
	...
	def count(cls, client) :
		r""" Use this API to count the nslicenseproxyserver resources configured on NetScaler.
		"""
		try :
			obj = nslicenseproxyserver()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of nslicenseproxyserver resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = nslicenseproxyserver()
