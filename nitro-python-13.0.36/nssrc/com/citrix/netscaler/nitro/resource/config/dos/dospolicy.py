...
class dospolicy(base_resource) :
	...
	@property
	def name(self) :
		r"""Name for the HTTP DoS protection policy. Must begin with a letter, number, or the underscore character (_). Other characters allowed, after the first character, are the hyphen (-), period (.) hash (#), space ( ), at (@), equals (=), and colon (:) characters.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	@property
	def qdepth(self) :
		r"""Queue depth. The queue size (the number of outstanding service requests on the system) before DoS protection is activated on the service to which the DoS protection policy is bound.<br/>Minimum length =  21.
		"""
		try :
			return self._qdepth
		except Exception as e:
	...
	def cltdetectrate(self) :
		r"""Client detect rate. Integer representing the percentage of traffic to which the HTTP DoS policy is to be applied after the queue depth condition is satisfied.<br/>Maximum length =  100.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add dospolicy.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete dospolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update dospolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of dospolicy resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the dospolicy resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = dospolicy()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of dospolicy resources.
	...
	def count(cls, client) :
		r""" Use this API to count the dospolicy resources configured on NetScaler.
		"""
		try :
			obj = dospolicy()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of dospolicy resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = dospolicy()
