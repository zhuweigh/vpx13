...
class systemuser_systemcmdpolicy_binding(base_resource) :
	...
	def get(cls, service, username="", option_="") :
		r""" Use this API to fetch systemuser_systemcmdpolicy_binding resources.
		"""
		try :
			if not username :
	...
	def get_filtered(cls, service, username, filter_) :
		r""" Use this API to fetch filtered set of systemuser_systemcmdpolicy_binding resources.
	...
	def count(cls, service, username) :
		r""" Use this API to count systemuser_systemcmdpolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = systemuser_systemcmdpolicy_binding()
			obj.username = username
	...
	def count_filtered(cls, service, username, filter_) :
		r""" Use this API to count the filtered set of systemuser_systemcmdpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = systemuser_systemcmdpolicy_binding()
