...
class lbvserver_servicegroup_binding(base_resource) :
	...
	@property
	def weight(self) :
		r"""Integer specifying the weight of the service. A larger number specifies a greater weight. Defines the capacity of the service relative to the other services in the load balancing configuration. Determines the priority given to the service in load balancing decisions.
		"""
		try :
			return self._weight
		except Exception as e:
	...
	def get(cls, service, name="", option_="") :
		r""" Use this API to fetch lbvserver_servicegroup_binding resources.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, service, name, filter_) :
		r""" Use this API to fetch filtered set of lbvserver_servicegroup_binding resources.
	...
	def count(cls, service, name) :
		r""" Use this API to count lbvserver_servicegroup_binding resources configued on NetScaler.
		"""
		try :
			obj = lbvserver_servicegroup_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		r""" Use this API to count the filtered set of lbvserver_servicegroup_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = lbvserver_servicegroup_binding()
