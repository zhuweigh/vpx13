...
class appfwprofile_denyurl_binding(base_resource) :
	...
	@property
	def denyurl(self) :
		r"""A regular expression that designates a URL on the Deny URL list.
		"""
		try :
	...
	def get(cls, service, name="", option_="") :
		r""" Use this API to fetch appfwprofile_denyurl_binding resources.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, service, name, filter_) :
		r""" Use this API to fetch filtered set of appfwprofile_denyurl_binding resources.
	...
	def count(cls, service, name) :
		r""" Use this API to count appfwprofile_denyurl_binding resources configued on NetScaler.
		"""
		try :
			obj = appfwprofile_denyurl_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		r""" Use this API to count the filtered set of appfwprofile_denyurl_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appfwprofile_denyurl_binding()
