...
class cspolicy_cspolicylabel_binding(base_resource) :
	...
	def get(cls, service, policyname="", option_="") :
		r""" Use this API to fetch cspolicy_cspolicylabel_binding resources.
		"""
		try :
			if not policyname :
	...
	def get_filtered(cls, service, policyname, filter_) :
		r""" Use this API to fetch filtered set of cspolicy_cspolicylabel_binding resources.
	...
	def count(cls, service, policyname) :
		r""" Use this API to count cspolicy_cspolicylabel_binding resources configued on NetScaler.
		"""
		try :
			obj = cspolicy_cspolicylabel_binding()
			obj.policyname = policyname
	...
	def count_filtered(cls, service, policyname, filter_) :
		r""" Use this API to count the filtered set of cspolicy_cspolicylabel_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = cspolicy_cspolicylabel_binding()
