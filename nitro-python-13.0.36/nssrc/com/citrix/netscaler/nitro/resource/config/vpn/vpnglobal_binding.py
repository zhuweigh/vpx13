...
class vpnglobal_binding(base_resource):
	...
	@property
	def vpnglobal_sslcertkey_bindings(self) :
		r"""sslcertkey that can be bound to vpnglobal.
		"""
		try :
			return self._vpnglobal_sslcertkey_binding
		except Exception as e:
			raise e
	...
	@property
	def vpnglobal_vpnurlpolicy_bindings(self) :
		r"""vpnurlpolicy that can be bound to vpnglobal.
		"""
		try :
			return self._vpnglobal_vpnurlpolicy_binding
		except Exception as e:
			raise e
