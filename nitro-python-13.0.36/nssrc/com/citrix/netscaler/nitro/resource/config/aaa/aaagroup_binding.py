...
class aaagroup_binding(base_resource):
	...
	@property
	def groupname(self) :
		r"""Name of the group.<br/>Minimum length =  1.
		"""
		try :
	...
	def aaagroup_vpntrafficpolicy_bindings(self) :
		r"""vpntrafficpolicy that can be bound to aaagroup.
		"""
		try :
	...
	def aaagroup_authorizationpolicy_bindings(self) :
		r"""authorizationpolicy that can be bound to aaagroup.
		"""
		try :
	...
	def aaagroup_intranetip_bindings(self) :
		r"""intranetip that can be bound to aaagroup.
		"""
		try :
	...
	@property
	def aaagroup_vpnurlpolicy_bindings(self) :
		r"""vpnurlpolicy that can be bound to aaagroup.
		"""
		try :
			return self._aaagroup_vpnurlpolicy_binding
		except Exception as e:
			raise e

	@property
	def aaagroup_intranetip6_bindings(self) :
		r"""intranetip6 that can be bound to aaagroup.
		"""
		try :
	...
	def aaagroup_auditnslogpolicy_bindings(self) :
		r"""auditnslogpolicy that can be bound to aaagroup.
		"""
		try :
	...
	def aaagroup_vpnurl_bindings(self) :
		r"""vpnurl that can be bound to aaagroup.
		"""
		try :
	...
	def aaagroup_auditsyslogpolicy_bindings(self) :
		r"""auditsyslogpolicy that can be bound to aaagroup.
		"""
		try :
	...
	def aaagroup_aaauser_bindings(self) :
		r"""aaauser that can be bound to aaagroup.
		"""
		try :
	...
	def aaagroup_tmsessionpolicy_bindings(self) :
		r"""tmsessionpolicy that can be bound to aaagroup.
		"""
		try :
	...
	def aaagroup_vpnsessionpolicy_bindings(self) :
		r"""vpnsessionpolicy that can be bound to aaagroup.
		"""
		try :
	...
	def aaagroup_vpnintranetapplication_bindings(self) :
		r"""vpnintranetapplication that can be bound to aaagroup.
		"""
		try :
	...
	def get(self, service, groupname="", option_="") :
		r""" Use this API to fetch aaagroup_binding resource.
		"""
		try :
			if not groupname :
