...
class l3param(base_resource) :
	...
	def dynamicrouting(self) :
		r"""Enable/Disable Dynamic routing on partition. This configuration is not applicable to default partition.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def ipv6dynamicrouting(self) :
		r"""Enable/Disable IPv6 Dynamic routing.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def allowclasseipv4(self) :
		r"""Enable/Disable IPv4 Class E address clients.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
