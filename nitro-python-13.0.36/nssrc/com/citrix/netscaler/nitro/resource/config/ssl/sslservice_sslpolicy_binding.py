...
class sslservice_sslpolicy_binding(base_resource) :
	...
	def get(cls, service, servicename="", option_="") :
		r""" Use this API to fetch sslservice_sslpolicy_binding resources.
		"""
		try :
			if not servicename :
	...
	def get_filtered(cls, service, servicename, filter_) :
		r""" Use this API to fetch filtered set of sslservice_sslpolicy_binding resources.
	...
	def count(cls, service, servicename) :
		r""" Use this API to count sslservice_sslpolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = sslservice_sslpolicy_binding()
			obj.servicename = servicename
	...
	def count_filtered(cls, service, servicename, filter_) :
		r""" Use this API to count the filtered set of sslservice_sslpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslservice_sslpolicy_binding()
