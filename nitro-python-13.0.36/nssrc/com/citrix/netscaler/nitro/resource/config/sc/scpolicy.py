...
class scpolicy(base_resource) :
	...
	@property
	def name(self) :
		r"""Name for the policy. Must begin with an ASCII alphabetic or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@), equals (=), and hyphen (-) characters.<br/>Minimum length =  1<br/>Maximum length =  31.
		"""
		try :
			return self._name
	...
	@property
	def url(self) :
		r"""URL against which to match incoming client request.<br/>Maximum length =  127.
		"""
		try :
			return self._url
		except Exception as e:
	...
	@property
	def delay(self) :
		r"""Delay threshold, in microseconds, for requests that match the policy's URL or rule. If the delay statistics gathered for the matching request exceed the specified delay, SureConnect is triggered for that request.<br/>Minimum length =  1<br/>Maximum length =  599999999.
		"""
		try :
			return self._delay
		except Exception as e:
	...
	@property
	def maxconn(self) :
		r"""Maximum number of concurrent connections that can be open for requests that match the policy's URL or rule.<br/>Minimum length =  1<br/>Maximum length =  0xFFFFFFFE.
		"""
		try :
	...
	@property
	def action(self) :
		r"""Action to be taken when the delay or maximum-connections threshold is reached. Available settings function as follows:
	...
	def altcontentsvcname(self) :
		r"""Name of the alternative content service to be used in the ACS action.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
	...
	def altcontentpath(self) :
		r"""Path to the alternative content service to be used in the ACS action.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add scpolicy.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete scpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update scpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of scpolicy resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the scpolicy resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = scpolicy()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of scpolicy resources.
	...
	def count(cls, client) :
		r""" Use this API to count the scpolicy resources configured on NetScaler.
		"""
		try :
			obj = scpolicy()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of scpolicy resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = scpolicy()
