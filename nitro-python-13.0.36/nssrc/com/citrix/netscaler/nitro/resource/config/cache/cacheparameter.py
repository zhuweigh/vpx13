...
class cacheparameter(base_resource) :
	...
	def __init__(self) :
		...
		self._enablehaobjpersist = None
		self._disklimit = None
		self._maxdisklimit = None
	...
	@property
	def memlimit(self) :
		r"""Amount of memory available for storing the cache objects. In practice, the amount of memory available for caching can be less than half the total memory of the Citrix ADC.
		"""
		try :
	...
	@property
	def via(self) :
		r"""String to include in the Via header. A Via header is inserted into all responses served from a content group if its Insert Via flag is set.<br/>Minimum length =  1.
		"""
		try :
			return self._via
		except Exception as e:
	...
	def verifyusing(self) :
		r"""Criteria for deciding whether a cached object can be served for an incoming HTTP request. Available settings function as follows:
	...
	@property
	def maxpostlen(self) :
		r"""Maximum number of POST body bytes to consider when evaluating parameters for a content group for which you have configured hit parameters and invalidation parameters.<br/>Default value: 4096<br/>Maximum length =  131072.
		"""
		try :
	...
	def prefetchmaxpending(self) :
		r"""Maximum number of outstanding prefetches in the Integrated Cache.
		"""
		try :
	...
	def enablebypass(self) :
		r"""Evaluate the request-time policies before attempting hit selection. If set to NO, an incoming request for which a matching object is found in cache storage results in a response regardless of the policy configuration.
	...
	def undefaction(self) :
		r"""Action to take when a policy cannot be evaluated.<br/>Possible values = NOCACHE, RESET.
		"""
		try :
	...
	def enablehaobjpersist(self) :
		r"""The HA object persisting parameter. When this value is set to YES, cache objects can be synced to Secondary in a HA deployment.  If set to NO, objects will never be synced to Secondary node.<br/>Default value: NO<br/>Possible values = YES, NO.
		"""
		try :
	...
	@property
	def disklimit(self) :
		r"""The disk limit for the Integrated Cache.
		"""
		try :
	...
	def maxdisklimit(self) :
		r"""The maximum value of the memory limit for the Integrated Cache.
		"""
		try :
	...
	def memlimitactive(self) :
		r"""Active value of the memory limit for the Integrated Cache.
		"""
		try :
	...
	def prefetchcur(self) :
		r"""Number of current outstanding prefetches in the IC.
		"""
		try :
	...
	def update(cls, client, resource) :
		r""" Use this API to update cacheparameter.
		"""
		try :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of cacheparameter resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the cacheparameter resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = cacheparameter()
