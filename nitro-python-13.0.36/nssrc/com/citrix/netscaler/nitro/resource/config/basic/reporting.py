...
class reporting(base_resource) :
	...
	@property
	def state(self) :
		r"""The rule associated with the entity.<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._state
	...
	def enable(cls, client, resource="") :
		r""" Use this API to enable reporting.
		"""
		try :
	...
	def disable(cls, client, resource="") :
		r""" Use this API to disable reporting.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the reporting resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = reporting()
