...
class appfwpolicy(base_resource) :
	...
	@property
	def rule(self) :
		r"""Name of the Citrix ADC named rule, or a Citrix ADC expression, that the policy uses to determine whether to filter the connection through the application firewall with the designated profile.
		"""
		try :
			return self._rule
		except Exception as e:
	...
	def profilename(self) :
		r"""Name of the application firewall profile to use if the policy matches.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def comment(self) :
		r"""Any comments to preserve information about the policy for later reference.
		"""
		try :
	...
	@property
	def logaction(self) :
		r"""Where to log information for connections that match this policy.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add appfwpolicy.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete appfwpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update appfwpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of appfwpolicy resource.
	...
	def rename(cls, client, resource, new_name) :
		r""" Use this API to rename a appfwpolicy resource.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the appfwpolicy resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = appfwpolicy()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of appfwpolicy resources.
	...
	def count(cls, client) :
		r""" Use this API to count the appfwpolicy resources configured on NetScaler.
		"""
		try :
			obj = appfwpolicy()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of appfwpolicy resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appfwpolicy()
