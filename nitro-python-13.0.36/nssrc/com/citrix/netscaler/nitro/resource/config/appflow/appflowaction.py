...
class appflowaction(base_resource) :
	...
	def clientsidemeasurements(self) :
		r"""On enabling this option, the Citrix ADC will collect the time required to load and render the mainpage on the client.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def pagetracking(self) :
		r"""On enabling this option, the Citrix ADC will start tracking the page for waterfall chart by inserting a NS_ESNS cookie in the response.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def webinsight(self) :
		r"""On enabling this option, the Citrix ADC will send the webinsight records to the configured collectors.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def securityinsight(self) :
		r"""On enabling this option, the Citrix ADC will send the security insight records to the configured collectors.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def videoanalytics(self) :
		r"""On enabling this option, the Citrix ADC will send the videoinsight records to the configured collectors.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def distributionalgorithm(self) :
		r"""On enabling this option, the Citrix ADC will distribute records among the collectors. Else, all records will be sent to all the collectors.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def transactionlog(self) :
		r"""Log ANOMALOUS or ALL transactions.<br/>Default value: ALL<br/>Possible values = ALL, ANOMALOUS.
		"""
		try :
