...
class nslicense(base_resource) :
	...
	def __init__(self) :
		...
		self._forwardproxy = None
		self._sslinterception = None
		self._remotecontentinspection = None
		self._adaptivetcp = None
		self._cqa = None
	...
	@property
	def isswglic(self) :
		r"""Secure Web Gateway License.
		"""
		try :
			return self._isswglic
		except Exception as e:
			raise e
	...
	def licensingmode(self) :
		r"""Pooled Licensed.<br/>Default value: Local<br/>Possible values = Local, Pooled, CICO, EXPRESS, CPU, CPU-Local.
		"""
		try :
	...
	def daystoexpiration(self) :
		r"""Days to expire.<br/>Minimum value =  0<br/>Maximum value =  4294967294.
		"""
		try :
	...
	@property
	def forwardproxy(self) :
		r"""Forward Proxy.
		"""
		try :
			return self._forwardproxy
		except Exception as e:
			raise e
	...
	@property
	def remotecontentinspection(self) :
		r"""Remote Content Inspection.
		"""
		try :
			return self._remotecontentinspection
		except Exception as e:
			raise e

	@property
	def adaptivetcp(self) :
		r"""Adaptive TCP.
		"""
		try :
			return self._adaptivetcp
		except Exception as e:
			raise e

	@property
	def cqa(self) :
		r"""Connection Quality Analytics.
		"""
		try :
			return self._cqa
		except Exception as e:
