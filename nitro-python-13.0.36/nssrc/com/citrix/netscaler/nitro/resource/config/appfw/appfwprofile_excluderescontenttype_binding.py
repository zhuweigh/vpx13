...
class appfwprofile_excluderescontenttype_binding(base_resource) :
	...
	"""
	def __init__(self) :
		self._excluderescontenttype = None
		self._state = None
		self._comment = None
		self._name = None
		self.___count = None
	...
	def excluderescontenttype(self) :
		r"""A regular expression that represents the content type of the response that are to be excluded from inspection.
		"""
		try :
	...
	def get(cls, service, name="", option_="") :
		r""" Use this API to fetch appfwprofile_excluderescontenttype_binding resources.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, service, name, filter_) :
		r""" Use this API to fetch filtered set of appfwprofile_excluderescontenttype_binding resources.
	...
	def count(cls, service, name) :
		r""" Use this API to count appfwprofile_excluderescontenttype_binding resources configued on NetScaler.
		"""
		try :
			obj = appfwprofile_excluderescontenttype_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		r""" Use this API to count the filtered set of appfwprofile_excluderescontenttype_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appfwprofile_excluderescontenttype_binding()
