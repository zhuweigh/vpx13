...
class aaaradiusparams(base_resource) :
	...
	def authtimeout(self) :
		r"""Maximum number of seconds that the Citrix ADC waits for a response from the RADIUS server.<br/>Default value: 3<br/>Minimum length =  1.
		"""
		try :
	...
	def radkey(self) :
		...
		Required for allowing the Citrix ADC to communicate with the RADIUS server.<br/>Minimum length =  1.
		"""
		try :
			return self._radkey
		except Exception as e:
	...
	@property
	def radnasip(self) :
		r"""Send the Citrix ADC IP (NSIP) address to the RADIUS server as the Network Access Server IP (NASIP) part of the Radius protocol.<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def radnasid(self) :
		r"""Send the Network Access Server ID (NASID) for your Citrix ADC to the RADIUS server as the nasid part of the Radius protocol.
		"""
		try :
	...
	def passencoding(self) :
		r"""Enable password encoding in RADIUS packets that the Citrix ADC sends to the RADIUS server.<br/>Default value: pap<br/>Possible values = pap, chap, mschapv1, mschapv2.
		"""
		try :
