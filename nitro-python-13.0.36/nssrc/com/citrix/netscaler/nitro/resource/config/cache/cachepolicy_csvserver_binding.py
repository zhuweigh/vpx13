...
class cachepolicy_csvserver_binding(base_resource) :
	...
	def get(cls, service, policyname="", option_="") :
		r""" Use this API to fetch cachepolicy_csvserver_binding resources.
		"""
		try :
			if not policyname :
	...
	def get_filtered(cls, service, policyname, filter_) :
		r""" Use this API to fetch filtered set of cachepolicy_csvserver_binding resources.
	...
	def count(cls, service, policyname) :
		r""" Use this API to count cachepolicy_csvserver_binding resources configued on NetScaler.
		"""
		try :
			obj = cachepolicy_csvserver_binding()
			obj.policyname = policyname
