...
class authenticationpolicy_binding(base_resource):
	...
	@property
	def authenticationpolicy_systemglobal_bindings(self) :
		r"""systemglobal that can be bound to authenticationpolicy.
		"""
		try :
			return self._authenticationpolicy_systemglobal_binding
		except Exception as e:
			raise e
