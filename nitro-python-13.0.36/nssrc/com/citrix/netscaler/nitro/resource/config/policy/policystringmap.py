...
class policystringmap(base_resource) :
	...
	@property
	def name(self) :
		r"""Unique name for the string map. Not case sensitive. Must begin with an ASCII letter or underscore (_) character, and must consist only of ASCII alphanumeric or underscore characters. Must not begin with 're' or 'xp' or be a word reserved for use as an expression qualifier prefix (such as HTTP) or enumeration value (such as ASCII). Must not be the name of an existing named expression, pattern set, dataset, string map, or HTTP callout.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	@property
	def comment(self) :
		r"""Comments associated with the string map.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add policystringmap.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete policystringmap.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update policystringmap.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of policystringmap resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the policystringmap resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = policystringmap()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of policystringmap resources.
	...
	def count(cls, client) :
		r""" Use this API to count the policystringmap resources configured on NetScaler.
		"""
		try :
			obj = policystringmap()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of policystringmap resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = policystringmap()
