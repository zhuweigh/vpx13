...
class sslservicegroup_sslcipher_binding(base_resource) :
	...
	def get(cls, service, servicegroupname="", option_="") :
		r""" Use this API to fetch sslservicegroup_sslcipher_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, servicegroupname, filter_) :
		r""" Use this API to fetch filtered set of sslservicegroup_sslcipher_binding resources.
	...
	def count(cls, service, servicegroupname) :
		r""" Use this API to count sslservicegroup_sslcipher_binding resources configued on NetScaler.
		"""
		try :
			obj = sslservicegroup_sslcipher_binding()
			obj.servicegroupname = servicegroupname
	...
	def count_filtered(cls, service, servicegroupname, filter_) :
		r""" Use this API to count the filtered set of sslservicegroup_sslcipher_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslservicegroup_sslcipher_binding()
