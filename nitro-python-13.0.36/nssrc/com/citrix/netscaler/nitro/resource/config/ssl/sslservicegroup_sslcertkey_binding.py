...
class sslservicegroup_sslcertkey_binding(base_resource) :
	...
	def certkeyname(self) :
		r"""The name of the certificate bound to the SSL service group.
		"""
		try :
	...
	def get(cls, service, servicegroupname="", option_="") :
		r""" Use this API to fetch sslservicegroup_sslcertkey_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, servicegroupname, filter_) :
		r""" Use this API to fetch filtered set of sslservicegroup_sslcertkey_binding resources.
	...
	def count(cls, service, servicegroupname) :
		r""" Use this API to count sslservicegroup_sslcertkey_binding resources configued on NetScaler.
		"""
		try :
			obj = sslservicegroup_sslcertkey_binding()
			obj.servicegroupname = servicegroupname
	...
	def count_filtered(cls, service, servicegroupname, filter_) :
		r""" Use this API to count the filtered set of sslservicegroup_sslcertkey_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslservicegroup_sslcertkey_binding()
