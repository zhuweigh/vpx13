...
class dnszone(base_resource) :
	...
	@property
	def zonename(self) :
		r"""Name of the zone to create.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def proxymode(self) :
		r"""Deploy the zone in proxy mode. Enable in the following scenarios:
	...
	def dnssecoffload(self) :
		r"""Enable dnssec offload for this zone.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def nsec(self) :
		r"""Enable nsec generation for dnssec offload.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._nsec
		except Exception as e:
	...
	@property
	def keyname(self) :
		r"""Name of the public/private DNS key pair with which to sign the zone. You can sign a zone with up to four keys.<br/>Minimum length =  1.
		"""
		try :
	...
	def update(cls, client, resource) :
		r""" Use this API to update dnszone.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of dnszone resource.
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete dnszone.
		"""
		try :
			if type(resource) is not list :
	...
	def sign(cls, client, resource) :
		r""" Use this API to sign dnszone.
		"""
		try :
			if type(resource) is not list :
	...
	def unsign(cls, client, resource) :
		r""" Use this API to unsign dnszone.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the dnszone resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = dnszone()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of dnszone resources.
	...
	def count(cls, client) :
		r""" Use this API to count the dnszone resources configured on NetScaler.
		"""
		try :
			obj = dnszone()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of dnszone resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = dnszone()
