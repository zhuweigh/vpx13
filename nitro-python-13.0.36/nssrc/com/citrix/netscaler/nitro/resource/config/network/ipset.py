...
class ipset(base_resource) :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete ipset.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the ipset resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = ipset()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of ipset resources.
	...
	def count(cls, client) :
		r""" Use this API to count the ipset resources configured on NetScaler.
		"""
		try :
			obj = ipset()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of ipset resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = ipset()
