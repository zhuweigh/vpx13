...
class appfwglobal_auditnslogpolicy_binding(base_resource) :
	...
	@property
	def state(self) :
		r"""Enable or disable the binding to activate or deactivate the policy. This is applicable to classic policies only.<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._state
		except Exception as e:
	...
	@property
	def type(self) :
		r"""Bind point to which to policy is bound.<br/>Possible values = REQ_OVERRIDE, REQ_DEFAULT, NONE.
		"""
		try :
			return self._type
		except Exception as e:
	...
	def _get_nitro_response(self, service, response) :
		...
		"""
		try :
			result = service.payload_formatter.string_to_resource(appfwglobal_auditnslogpolicy_binding_response, response, self.__class__.__name__)
	...
	def add(cls, client, resource) :
		try :
			if resource and type(resource) is not list :
				updateresource = appfwglobal_auditnslogpolicy_binding()
				...
				if resource and len(resource) > 0 :
					updateresources = [appfwglobal_auditnslogpolicy_binding() for _ in range(len(resource))]
	...
	def delete(cls, client, resource) :
		try :
			if resource and type(resource) is not list :
				deleteresource = appfwglobal_auditnslogpolicy_binding()
				...
				if resource and len(resource) > 0 :
					deleteresources = [appfwglobal_auditnslogpolicy_binding() for _ in range(len(resource))]
					for i in range(len(resource)) :
	...
	@classmethod
	def get(cls, service) :
		r""" Use this API to fetch a appfwglobal_auditnslogpolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		r""" Use this API to fetch filtered set of appfwglobal_auditnslogpolicy_binding resources.
	...
	def count(cls, service) :
		r""" Use this API to count appfwglobal_auditnslogpolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = appfwglobal_auditnslogpolicy_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		r""" Use this API to count the filtered set of appfwglobal_auditnslogpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appfwglobal_auditnslogpolicy_binding()
...
class appfwglobal_auditnslogpolicy_binding_response(base_response) :
	def __init__(self, length=1) :
		...
		self.severity = ""
		self.sessionid = ""
		self.appfwglobal_auditnslogpolicy_binding = [appfwglobal_auditnslogpolicy_binding() for _ in range(length)]
