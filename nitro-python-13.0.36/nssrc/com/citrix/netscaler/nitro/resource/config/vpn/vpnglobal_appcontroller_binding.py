...
class vpnglobal_appcontroller_binding(base_resource) :
	...
	def appcontroller(self) :
		r"""Configured App Controller server.
		"""
		try :
	...
	@classmethod
	def get(cls, service) :
		r""" Use this API to fetch a vpnglobal_appcontroller_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		r""" Use this API to fetch filtered set of vpnglobal_appcontroller_binding resources.
	...
	def count(cls, service) :
		r""" Use this API to count vpnglobal_appcontroller_binding resources configued on NetScaler.
		"""
		try :
			obj = vpnglobal_appcontroller_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		r""" Use this API to count the filtered set of vpnglobal_appcontroller_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnglobal_appcontroller_binding()
