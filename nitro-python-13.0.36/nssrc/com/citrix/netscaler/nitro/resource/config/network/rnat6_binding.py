...
class rnat6_binding(base_resource):
	...
	@property
	def name(self) :
		r"""Name of the RNAT6 rule whose details you want to display.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	def rnat6_nsip6_bindings(self) :
		r"""nsip6 that can be bound to rnat6.
		"""
		try :
	...
	def get(self, service, name="", option_="") :
		r""" Use this API to fetch rnat6_binding resource.
		"""
		try :
			if not name :
				obj = rnat6_binding()
