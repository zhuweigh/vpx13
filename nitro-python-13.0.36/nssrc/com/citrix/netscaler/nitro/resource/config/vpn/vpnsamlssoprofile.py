...
class vpnsamlssoprofile(base_resource) :
	...
	def samlsigningcertname(self) :
		r"""Name of the signing authority as given in the SAML server's SSL certificate.<br/>Minimum length =  1.
		"""
		try :
	...
	def relaystaterule(self) :
		r"""Expression to extract relaystate to be sent along with assertion. Evaluation of this expression should return TEXT content. This is typically a target url to which user is redirected after the recipient validates SAML token.
		"""
		try :
	...
	def encryptassertion(self) :
		r"""Option to encrypt assertion when Citrix ADC sends one.<br/>Default value: OFF<br/>Possible values = ON, OFF.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add vpnsamlssoprofile.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete vpnsamlssoprofile.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update vpnsamlssoprofile.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of vpnsamlssoprofile resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the vpnsamlssoprofile resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of vpnsamlssoprofile resources.
	...
	def count(cls, client) :
		r""" Use this API to count the vpnsamlssoprofile resources configured on NetScaler.
		"""
		try :
			obj = vpnsamlssoprofile()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of vpnsamlssoprofile resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnsamlssoprofile()
