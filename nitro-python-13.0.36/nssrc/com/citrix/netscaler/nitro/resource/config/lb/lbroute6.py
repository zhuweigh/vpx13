...
class lbroute6(base_resource) :
	...
	def add(cls, client, resource) :
		r""" Use this API to add lbroute6.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete lbroute6.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the lbroute6 resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = lbroute6()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of lbroute6 resources.
	...
	def count(cls, client) :
		r""" Use this API to count the lbroute6 resources configured on NetScaler.
		"""
		try :
			obj = lbroute6()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of lbroute6 resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = lbroute6()
