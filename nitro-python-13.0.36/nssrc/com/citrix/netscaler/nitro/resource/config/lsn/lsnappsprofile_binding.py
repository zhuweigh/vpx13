...
class lsnappsprofile_binding(base_resource):
	...
	@property
	def lsnappsprofile_lsnappsattributes_bindings(self) :
		r"""lsnappsattributes that can be bound to lsnappsprofile.
		"""
		try :
			return self._lsnappsprofile_lsnappsattributes_binding
		except Exception as e:
			raise e
