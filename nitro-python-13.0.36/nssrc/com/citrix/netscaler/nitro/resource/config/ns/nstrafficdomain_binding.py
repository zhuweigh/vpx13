...
class nstrafficdomain_binding(base_resource):
	...
	def nstrafficdomain_vlan_bindings(self) :
		r"""vlan that can be bound to nstrafficdomain.
		"""
		try :
	...
	def nstrafficdomain_vxlan_bindings(self) :
		r"""vxlan that can be bound to nstrafficdomain.
		"""
		try :
	...
	def nstrafficdomain_bridgegroup_bindings(self) :
		r"""bridgegroup that can be bound to nstrafficdomain.
		"""
		try :
	...
	@classmethod
	def get(self, service, td="", option_="") :
		r""" Use this API to fetch nstrafficdomain_binding resource.
		"""
		try :
			if not td :
				obj = nstrafficdomain_binding()
				response = obj.get_resources(service, option_)
			elif type(td) is not list :
				obj = nstrafficdomain_binding()
				obj.td = td
