...
class hanode(base_resource) :
	...
	def __init__(self) :
		...
		self._curflips = None
		self._completedfliptime = None
		self._routemonitorstate = None
		self._hasyncfailurereason = None
		self.___count = None

	@property
	def id(self) :
		r"""Number that uniquely identifies the node. For self node, it will always be 0. Peer node values can range from 1-64.<br/>Minimum length =  1<br/>Maximum length =  64.
		"""
		try :
			return self._id
	...
	@property
	def ipaddress(self) :
		r"""The NSIP or NSIP6 address of the node to be added for an HA configuration. This setting is neither propagated nor synchronized.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def haprop(self) :
		r"""Automatically propagate all commands from the primary to the secondary node, except the following:
	...
	def hellointerval(self) :
		r"""Interval, in milliseconds, between heartbeat messages sent to the peer node. The heartbeat messages are UDP packets sent to port 3003 of the peer node.<br/>Default value: 200<br/>Minimum length =  200<br/>Maximum length =  1000.
		"""
		try :
	...
	def deadinterval(self) :
		r"""Number of seconds after which a peer node is marked DOWN if heartbeat messages are not received from the peer node.<br/>Default value: 3<br/>Minimum length =  3<br/>Maximum length =  60.
		"""
		try :
	...
	@property
	def failsafe(self) :
		r"""Keep one node primary if both nodes fail the health check, so that a partially available node can back up data and handle traffic. This mode is set independently on each node.<br/>Default value: OFF<br/>Possible values = ON, OFF.
		"""
		try :
	...
	@property
	def maxflips(self) :
		r"""Max number of flips allowed before becoming sticky primary.<br/>Default value: 0.
		"""
		try :
	...
	def maxfliptime(self) :
		r"""Interval after which flipping of node states can again start.<br/>Default value: 0.
		"""
		try :
	...
	@property
	def syncvlan(self) :
		r"""Vlan on which HA related communication is sent. This include sync, propagation , connection mirroring , LB persistency config sync, persistent session sync and session state sync. However HA heartbeats can go all interfaces.<br/>Minimum length =  1<br/>Maximum length =  4094.
		"""
		try :
	...
	@property
	def state(self) :
		r"""HA Master State.<br/>Possible values = Primary, Secondary, UNKNOWN.
		"""
		try :
			return self._state
		except Exception as e:
	...
	@property
	def haheartbeatifaces(self) :
		r"""HAHEARTBEAT OFF interfaces.
		"""
		try :
			return self._haheartbeatifaces
		except Exception as e:
			raise e

	@property
	def pfifaces(self) :
		r"""Interfaces causing Partial Failure.
		"""
		try :
	...
	@property
	def ifaces(self) :
		r"""Interfaces on which non-multicast is not seen.
		"""
		try :
			return self._ifaces
		except Exception as e:
	...
	@property
	def ssl2(self) :
		r"""SSL card status.<br/>Possible values = DOWN, UP, NOT PRESENT, UNKNOWN.
		"""
		try :
			return self._ssl2
		except Exception as e:
	...
	def masterstatetime(self) :
		r"""Time elapsed in current master state.
		"""
		try :
	...
	@property
	def curflips(self) :
		r"""Keeps track of number of flips that have happened till now in current interval.
		"""
		try :
	...
	def completedfliptime(self) :
		r"""To inform user whether flip time is elapsed or not.
		"""
		try :
	...
	def routemonitorstate(self) :
		r"""State for route monitor.<br/>Possible values = UP, DOWN.
		"""
		try :
	...
	@property
	def hasyncfailurereason(self) :
		r"""Displays the reason for HA SYNC Failure.<br/>Possible values = .
		"""
		try :
			return self._hasyncfailurereason
		except Exception as e:
			raise e
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete hanode.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update hanode.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of hanode resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the hanode resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = hanode()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of hanode resources.
	...
	def count(cls, client) :
		r""" Use this API to count the hanode resources configured on NetScaler.
		"""
		try :
			obj = hanode()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of hanode resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = hanode()
