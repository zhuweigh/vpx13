...
class authenticationnegotiateaction(base_resource) :
	...
	@property
	def domain(self) :
		r"""Domain name of the service principal that represnts Citrix ADC.<br/>Minimum length =  1.
		"""
		try :
			return self._domain
		except Exception as e:
	...
	@property
	def domainuser(self) :
		r"""User name of the account that is mapped with Citrix ADC principal. This can be given along with domain and password when keytab file is not available. If username is given along with keytab file, then that keytab file will be searched for this user's credentials.<br/>Minimum length =  1.
		"""
		try :
	...
	def domainuserpasswd(self) :
		r"""Password of the account that is mapped to the Citrix ADC principal.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def keytab(self) :
		r"""The path to the keytab file that is used to decrypt kerberos tickets presented to Citrix ADC. If keytab is not available, domain/username/password can be specified in the negotiate action configuration.<br/>Minimum length =  1.
		"""
		try :
			return self._keytab
		except Exception as e:
