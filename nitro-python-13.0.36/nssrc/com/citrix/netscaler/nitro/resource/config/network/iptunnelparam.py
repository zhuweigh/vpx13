...
class iptunnelparam(base_resource) :
	...
	def __init__(self) :
		...
		self._enablestrictrx = None
		self._enablestricttx = None
		self._mac = None
		self._useclientsourceip = None

	@property
	def srcip(self) :
		r"""Common source-IP address for all tunnels. For a specific tunnel, this global setting is overridden if you have specified another source IP address. Must be a MIP or SNIP address.<br/>Minimum length =  1.
		"""
		try :
			return self._srcip
	...
	@property
	def dropfrag(self) :
		r"""Drop any IP packet that requires fragmentation before it is sent through the tunnel.<br/>Default value: NO<br/>Possible values = YES, NO.
		"""
		try :
	...
	def dropfragcputhreshold(self) :
		r"""Threshold value, as a percentage of CPU usage, at which to drop packets that require fragmentation to use the IP tunnel. Applies only if dropFragparameter is set to NO. The default value, 0, specifies that this parameter is not set.<br/>Minimum length =  1<br/>Maximum length =  100.
		"""
		try :
	...
	def enablestrictrx(self) :
		r"""Strict PBR check for IPSec packets received through tunnel.<br/>Default value: NO<br/>Possible values = YES, NO.
		"""
		try :
	...
	def enablestricttx(self) :
		r"""Strict PBR check for packets to be sent IPSec protected.<br/>Default value: NO<br/>Possible values = YES, NO.
		"""
		try :
	...
	@property
	def mac(self) :
		r"""The shared MAC used for shared IP between cluster nodes/HA peers.
		"""
		try :
			return self._mac
		except Exception as e:
	...
	@property
	def useclientsourceip(self) :
		r"""Use client source IP as source IP for outer tunnel IP header.<br/>Default value: NO<br/>Possible values = YES, NO.
		"""
		try :
			return self._useclientsourceip
		except Exception as e:
			raise e

	@useclientsourceip.setter
	def useclientsourceip(self, useclientsourceip) :
		r"""Use client source IP as source IP for outer tunnel IP header.<br/>Default value: NO<br/>Possible values = YES, NO
		"""
		try :
			self._useclientsourceip = useclientsourceip
		except Exception as e:
			raise e
	...
	def update(cls, client, resource) :
		r""" Use this API to update iptunnelparam.
		"""
		try :
			if type(resource) is not list :
				...
				updateresource.mac = resource.mac
				updateresource.useclientsourceip = resource.useclientsourceip
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of iptunnelparam resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the iptunnelparam resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = iptunnelparam()
