...
class sslvserver_sslcipher_binding(base_resource) :
	...
	def get(cls, service, vservername="", option_="") :
		r""" Use this API to fetch sslvserver_sslcipher_binding resources.
		"""
		try :
			if not vservername :
	...
	def get_filtered(cls, service, vservername, filter_) :
		r""" Use this API to fetch filtered set of sslvserver_sslcipher_binding resources.
	...
	def count(cls, service, vservername) :
		r""" Use this API to count sslvserver_sslcipher_binding resources configued on NetScaler.
		"""
		try :
			obj = sslvserver_sslcipher_binding()
			obj.vservername = vservername
	...
	def count_filtered(cls, service, vservername, filter_) :
		r""" Use this API to count the filtered set of sslvserver_sslcipher_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslvserver_sslcipher_binding()
