...
class sslcrlfile(base_resource) :
	...
	@property
	def src(self) :
		r"""URL specifying the protocol, host, and path, including file name to the CRL file to be imported. For example, http://www.example.com/crl_file.
	...
	def Import(cls, client, resource) :
		r""" Use this API to Import sslcrlfile.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete sslcrlfile.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the sslcrlfile resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = sslcrlfile()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of sslcrlfile resources.
	...
	def count(cls, client) :
		r""" Use this API to count the sslcrlfile resources configured on NetScaler.
		"""
		try :
			obj = sslcrlfile()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of sslcrlfile resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslcrlfile()
