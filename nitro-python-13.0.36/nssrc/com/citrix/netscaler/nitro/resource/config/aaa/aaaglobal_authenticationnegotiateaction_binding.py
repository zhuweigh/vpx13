...
class aaaglobal_authenticationnegotiateaction_binding(base_resource) :
	...
	def windowsprofile(self) :
		r"""Name of the negotiate profile to be bound.<br/>Minimum length =  1<br/>Maximum length =  32.
		"""
		try :
	...
	@classmethod
	def get(cls, service) :
		r""" Use this API to fetch a aaaglobal_authenticationnegotiateaction_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		r""" Use this API to fetch filtered set of aaaglobal_authenticationnegotiateaction_binding resources.
	...
	def count(cls, service) :
		r""" Use this API to count aaaglobal_authenticationnegotiateaction_binding resources configued on NetScaler.
		"""
		try :
			obj = aaaglobal_authenticationnegotiateaction_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		r""" Use this API to count the filtered set of aaaglobal_authenticationnegotiateaction_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = aaaglobal_authenticationnegotiateaction_binding()
