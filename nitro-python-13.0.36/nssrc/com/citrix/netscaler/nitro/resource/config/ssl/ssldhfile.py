...
class ssldhfile(base_resource) :
	...
	@property
	def src(self) :
		r"""URL specifying the protocol, host, and path, including file name, to the DH file to be imported. For example, http://www.example.com/dh_file.  
	...
	def Import(cls, client, resource) :
		r""" Use this API to Import ssldhfile.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete ssldhfile.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the ssldhfile resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = ssldhfile()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of ssldhfile resources.
	...
	def count(cls, client) :
		r""" Use this API to count the ssldhfile resources configured on NetScaler.
		"""
		try :
			obj = ssldhfile()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of ssldhfile resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = ssldhfile()
