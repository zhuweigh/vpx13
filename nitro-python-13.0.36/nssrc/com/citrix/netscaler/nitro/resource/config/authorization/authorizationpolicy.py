...
class authorizationpolicy(base_resource) :
	...
	@property
	def name(self) :
		r"""Name for the new authorization policy. 
	...
	@property
	def action(self) :
		r"""Action to perform if the policy matches: either allow or deny the request.<br/>Minimum length =  1.
		"""
		try :
			return self._action
		except Exception as e:
	...
	@property
	def newname(self) :
		r"""The new name of the author policy.<br/>Minimum length =  1.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add authorizationpolicy.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete authorizationpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update authorizationpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def rename(cls, client, resource, new_name) :
		r""" Use this API to rename a authorizationpolicy resource.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the authorizationpolicy resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of authorizationpolicy resources.
	...
	def count(cls, client) :
		r""" Use this API to count the authorizationpolicy resources configured on NetScaler.
		"""
		try :
			obj = authorizationpolicy()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of authorizationpolicy resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = authorizationpolicy()
