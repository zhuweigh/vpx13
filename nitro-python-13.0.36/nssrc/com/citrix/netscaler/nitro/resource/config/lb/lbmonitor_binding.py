...
class lbmonitor_binding(base_resource):
	...
	def lbmonitor_metric_bindings(self) :
		r"""metric that can be bound to lbmonitor.
		"""
		try :
	...
	@property
	def lbmonitor_sslcertkey_bindings(self) :
		r"""sslcertkey that can be bound to lbmonitor.
		"""
		try :
			return self._lbmonitor_sslcertkey_binding
		except Exception as e:
			raise e
	...
	def get(self, service, monitorname="", option_="") :
		r""" Use this API to fetch lbmonitor_binding resource.
		"""
		try :
			if not monitorname :
