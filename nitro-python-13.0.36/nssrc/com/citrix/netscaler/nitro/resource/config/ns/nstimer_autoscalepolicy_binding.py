...
class nstimer_autoscalepolicy_binding(base_resource) :
	...
	@property
	def priority(self) :
		r"""Specifies the priority of the timer policy.
		"""
		try :
	...
	@property
	def policyname(self) :
		r"""The timer policy associated with the timer.
		"""
		try :
	...
	@property
	def threshold(self) :
		r"""Denotes the threshold. If the rule of the policy in the binding relation evaluates 'threshold size' number of times in 'sample size' to true, then the corresponding action is taken. Its value needs to be less than or equal to the sample size value.<br/>Default value: 3<br/>Minimum value =  1<br/>Maximum value =  32.
		"""
		try :
	...
	@property
	def samplesize(self) :
		r"""Denotes the sample size. Sample size value of 'x' means that previous '(x - 1)' policy's rule evaluation results and the current evaluation result are present with the binding. For example, sample size of 10 means that there is a state of previous 9 policy evaluation results and also the current policy evaluation result.<br/>Default value: 3<br/>Minimum value =  1<br/>Maximum value =  32.
		"""
		try :
	...
	@property
	def vserver(self) :
		r"""Name of the vserver which provides the context for the rule in timer policy. When not specified it is treated as a Global Default context.
		"""
		try :
	...
	def get(cls, service, name="", option_="") :
		r""" Use this API to fetch nstimer_autoscalepolicy_binding resources.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, service, name, filter_) :
		r""" Use this API to fetch filtered set of nstimer_autoscalepolicy_binding resources.
	...
	def count(cls, service, name) :
		r""" Use this API to count nstimer_autoscalepolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = nstimer_autoscalepolicy_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		r""" Use this API to count the filtered set of nstimer_autoscalepolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = nstimer_autoscalepolicy_binding()
