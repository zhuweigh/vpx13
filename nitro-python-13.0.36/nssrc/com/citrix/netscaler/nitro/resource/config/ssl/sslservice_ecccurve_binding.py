...
class sslservice_ecccurve_binding(base_resource) :
	...
	def ecccurvename(self) :
		r"""Named ECC curve bound to service/vserver.<br/>Possible values = ALL, P_224, P_256, P_384, P_521.
		"""
		try :
	...
	def get(cls, service, servicename="", option_="") :
		r""" Use this API to fetch sslservice_ecccurve_binding resources.
		"""
		try :
			if not servicename :
	...
	def get_filtered(cls, service, servicename, filter_) :
		r""" Use this API to fetch filtered set of sslservice_ecccurve_binding resources.
	...
	def count(cls, service, servicename) :
		r""" Use this API to count sslservice_ecccurve_binding resources configued on NetScaler.
		"""
		try :
			obj = sslservice_ecccurve_binding()
			obj.servicename = servicename
	...
	def count_filtered(cls, service, servicename, filter_) :
		r""" Use this API to count the filtered set of sslservice_ecccurve_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslservice_ecccurve_binding()
