...
class servicegroupbindings(base_resource) :
	...
	def servicegroupname(self) :
		r"""The name of the service.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def ipaddress(self) :
		r"""The IP address of the vserver.
		"""
		try :
	...
	@property
	def port(self) :
		r"""The port of the vserver.<br/>Range 1 - 65535<br/>* in CLI is represented as 65535 in NITRO API.
		"""
		try :
			return self._port
		except Exception as e:
	...
	@property
	def state(self) :
		r"""The state of the service group.<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._state
		except Exception as e:
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the servicegroupbindings resources that are configured on netscaler.
		"""
		try :
	...
	def get_filtered(cls, client, filter_, obj) :
		r""" Use this API to fetch filtered set of servicegroupbindings resources.
	...
	def count(cls, client, obj) :
		r""" Use this API to count the servicegroupbindings resources configured on NetScaler.
		"""
		try :
			option_ = options()
			option_.count = True
	...
	def count_filtered(cls, client, filter_, obj) :
		r""" Use this API to count filtered the set of servicegroupbindings resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			option_ = options()
