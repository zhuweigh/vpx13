...
class dnspolicylabel(base_resource) :
	...
	@property
	def transform(self) :
		r"""The type of transformations allowed by the policies bound to the label.<br/>Possible values = dns_req, dns_res.
		"""
		try :
	...
	@property
	def newname(self) :
		r"""The new name of the dns policylabel.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def flowtype(self) :
		r"""Flowtype of the bound dns policy.
		"""
		try :
	...
	@property
	def isdefault(self) :
		r"""A value of true is returned if it is a default dns policylabel.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add dnspolicylabel.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete dnspolicylabel.
		"""
		try :
			if type(resource) is not list :
	...
	def rename(cls, client, resource, new_labelname) :
		r""" Use this API to rename a dnspolicylabel resource.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the dnspolicylabel resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = dnspolicylabel()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of dnspolicylabel resources.
	...
	def count(cls, client) :
		r""" Use this API to count the dnspolicylabel resources configured on NetScaler.
		"""
		try :
			obj = dnspolicylabel()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of dnspolicylabel resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = dnspolicylabel()
