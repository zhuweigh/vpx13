...
class dnskey(base_resource) :
	...
	@property
	def algorithm(self) :
		r"""Algorithm to generate for zone signing.<br/>Default value: NS_DNSKEYALGO_RSASHA1<br/>Possible values = RSASHA1.
		"""
		try :
	...
	@property
	def keysize(self) :
		r"""Size of the key, in bits.<br/>Default value: 512.
		"""
		try :
