...
class auditmessages(base_resource) :
	...
	@property
	def numofmesgs(self) :
		r"""Number of log messages to be displayed.<br/>Default value: 20<br/>Minimum length =  1<br/>Maximum length =  256.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the auditmessages resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = auditmessages()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of auditmessages resources.
	...
	def count(cls, client) :
		r""" Use this API to count the auditmessages resources configured on NetScaler.
		"""
		try :
			obj = auditmessages()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of auditmessages resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = auditmessages()
