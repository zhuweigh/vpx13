...
class location(base_resource) :
	...
	@property
	def ipfrom(self) :
		r"""First IP address in the range, in dotted decimal notation.<br/>Minimum length =  1.
		"""
		try :
			return self._ipfrom
	...
	@property
	def ipto(self) :
		r"""Last IP address in the range, in dotted decimal notation.<br/>Minimum length =  1.
		"""
		try :
			return self._ipto
		except Exception as e:
	...
	def preferredlocation(self) :
		r"""String of qualifiers, in dotted notation, describing the geographical location of the IP address range. Each qualifier is more specific than the one that precedes it, as in continent.country.region.city.isp.organization. For example, "NA.US.CA.San Jose.ATT.citrix". 
	...
	@property
	def longitude(self) :
		r"""Numerical value, in degrees, specifying the longitude of the geographical location of the IP address-range. 
	...
	@property
	def latitude(self) :
		r"""Numerical value, in degrees, specifying the latitude of the geographical location of the IP address-range. 
	...
	@property
	def q1label(self) :
		r"""Least specific location qualifier.
		"""
		try :
	...
	@property
	def q6label(self) :
		r"""Most specific location qualifier.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add location.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete location.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the location resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = location()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of location resources.
	...
	def count(cls, client) :
		r""" Use this API to count the location resources configured on NetScaler.
		"""
		try :
			obj = location()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of location resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = location()
