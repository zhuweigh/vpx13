...
class application(base_resource) :
	...
	def __init__(self) :
		self._apptemplatefilename = None
		self._appname = None
		self._deploymentfilename = None
	...
	@property
	def appname(self) :
		r"""Name to assign to the application on the Citrix ADC. If you do not provide a name, the appliance assigns the application the name of the template file.
		"""
		try :
