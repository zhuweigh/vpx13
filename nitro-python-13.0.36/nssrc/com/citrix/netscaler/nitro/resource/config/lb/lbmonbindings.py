...
class lbmonbindings(base_resource) :
	...
	@property
	def type(self) :
		r"""The type of monitor.<br/>Possible values = PING, TCP, HTTP, TCP-ECV, HTTP-ECV, UDP-ECV, DNS, FTP, LDNS-PING, LDNS-TCP, LDNS-DNS, RADIUS, USER, HTTP-INLINE, SIP-UDP, SIP-TCP, LOAD, FTP-EXTENDED, SMTP, SNMP, NNTP, MYSQL, MYSQL-ECV, MSSQL-ECV, ORACLE-ECV, LDAP, POP3, CITRIX-XML-SERVICE, CITRIX-WEB-INTERFACE, DNS-TCP, RTSP, ARP, CITRIX-AG, CITRIX-AAC-LOGINPAGE, CITRIX-AAC-LAS, CITRIX-XD-DDC, ND6, CITRIX-WI-EXTENDED, DIAMETER, RADIUS_ACCOUNTING, STOREFRONT, APPC, SMPP, CITRIX-XNC-ECV, CITRIX-XDM, CITRIX-STA-SERVICE, CITRIX-STA-SERVICE-NHOP.
		"""
		try :
			return self._type
		except Exception as e:
	...
	@property
	def state(self) :
		r"""The state of the monitor.<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._state
		except Exception as e:
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the lbmonbindings resources that are configured on netscaler.
		"""
		try :
	...
	def get_filtered(cls, client, filter_, obj) :
		r""" Use this API to fetch filtered set of lbmonbindings resources.
	...
	def count(cls, client, obj) :
		r""" Use this API to count the lbmonbindings resources configured on NetScaler.
		"""
		try :
			option_ = options()
			option_.count = True
	...
	def count_filtered(cls, client, filter_, obj) :
		r""" Use this API to count filtered the set of lbmonbindings resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			option_ = options()
