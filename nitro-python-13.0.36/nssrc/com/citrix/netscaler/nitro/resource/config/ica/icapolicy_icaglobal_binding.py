...
class icapolicy_icaglobal_binding(base_resource) :
	...
	def get(cls, service, name="", option_="") :
		r""" Use this API to fetch icapolicy_icaglobal_binding resources.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, service, name, filter_) :
		r""" Use this API to fetch filtered set of icapolicy_icaglobal_binding resources.
	...
	def count(cls, service, name) :
		r""" Use this API to count icapolicy_icaglobal_binding resources configued on NetScaler.
		"""
		try :
			obj = icapolicy_icaglobal_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		r""" Use this API to count the filtered set of icapolicy_icaglobal_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = icapolicy_icaglobal_binding()
