...
class callhome(base_resource) :
	...
	@property
	def mode(self) :
		r"""CallHome mode of operation.<br/>Default value: Default<br/>Possible values = Default, CSP.
		"""
		try :
			return self._mode
		except Exception as e:
	...
	def hbcustominterval(self) :
		r"""Interval (in days) between CallHome heartbeats.<br/>Default value: 7<br/>Minimum length =  1<br/>Maximum length =  30.
		"""
		try :
	...
	def callhomestatus(self) :
		r"""Callhome feature enabled/disable, register with upload server successful/failed.<br/>Possible values = ENABLED, DISABLED, SUCCESSFUL, FAILED, INVALID HOSTNAME, NO DNSSERVER, HOSTNAME RESOLUTION FAILED.
		"""
		try :
	...
	def get_args(cls, client, args) :
		r""" Use this API to fetch all the callhome resources that are configured on netscaler.
	# This uses callhome_args which is a way to provide additional arguments while fetching the resources.
		"""
		try :
			obj = callhome()
			option_ = options()
