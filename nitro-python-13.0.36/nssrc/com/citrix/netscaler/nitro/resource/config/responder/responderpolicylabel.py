...
class responderpolicylabel(base_resource) :
	...
	@property
	def labelname(self) :
		r"""Name for the responder policy label. Must begin with a letter, number, or the underscore character (_), and must contain only letters, numbers, and the hyphen (-), period (.) hash (#), space ( ), at (@), equals (=), colon (:), and underscore characters. Cannot be changed after the responder policy label is added.
	...
	@property
	def comment(self) :
		r"""Any comments to preserve information about this responder policy label.
		"""
		try :
	...
	@property
	def newname(self) :
		r"""New name for the responder policy label. Must begin with a letter, number, or the underscore character (_), and must contain only letters, numbers, and the hyphen (-), period (.) hash (#), space ( ), at (@), equals (=), colon (:), and underscore characters.<br/>Minimum length =  1.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add responderpolicylabel.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete responderpolicylabel.
		"""
		try :
			if type(resource) is not list :
	...
	def rename(cls, client, resource, new_labelname) :
		r""" Use this API to rename a responderpolicylabel resource.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the responderpolicylabel resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of responderpolicylabel resources.
	...
	def count(cls, client) :
		r""" Use this API to count the responderpolicylabel resources configured on NetScaler.
		"""
		try :
			obj = responderpolicylabel()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of responderpolicylabel resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = responderpolicylabel()
