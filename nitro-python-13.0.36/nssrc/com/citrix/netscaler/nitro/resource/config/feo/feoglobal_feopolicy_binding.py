...
class feoglobal_feopolicy_binding(base_resource) :
	...
	@property
	def priority(self) :
		r"""The priority assigned to the policy binding.
		"""
		try :
	...
	@property
	def policyname(self) :
		r"""The name of the globally bound front end optimization policy.
		"""
		try :
	...
	@property
	def type(self) :
		r"""Bindpoint to which the policy is bound.<br/>Possible values = REQ_OVERRIDE, REQ_DEFAULT, RES_OVERRIDE, RES_DEFAULT, NONE.
		"""
		try :
			return self._type
		except Exception as e:
	...
	@classmethod
	def get(cls, service) :
		r""" Use this API to fetch a feoglobal_feopolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		r""" Use this API to fetch filtered set of feoglobal_feopolicy_binding resources.
	...
	def count(cls, service) :
		r""" Use this API to count feoglobal_feopolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = feoglobal_feopolicy_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		r""" Use this API to count the filtered set of feoglobal_feopolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = feoglobal_feopolicy_binding()
