...
class dnssrvrec(base_resource) :
	...
	@property
	def domain(self) :
		r"""Domain name, which, by convention, is prefixed by the symbolic name of the desired service and the symbolic name of the desired protocol, each with an underscore (_) prepended. For example, if an SRV-aware client wants to discover a SIP service that is provided over UDP, in the domain example.com, the client performs a lookup for _sip._udp.example.com.<br/>Minimum length =  1.
		"""
		try :
			return self._domain
	...
	@property
	def target(self) :
		r"""Target host for the specified service.
		"""
		try :
			return self._target
		except Exception as e:
	...
	@property
	def priority(self) :
		r"""Integer specifying the priority of the target host. The lower the number, the higher the priority. If multiple target hosts have the same priority, selection is based on the Weight parameter.<br/>Maximum length =  65535.
		"""
		try :
	...
	@property
	def weight(self) :
		r"""Weight for the target host. Aids host selection when two or more hosts have the same priority. A larger number indicates greater weight.<br/>Maximum length =  65535.
		"""
		try :
			return self._weight
		except Exception as e:
	...
	@property
	def port(self) :
		r"""Port on which the target host listens for client requests.<br/>Maximum length =  65535.
		"""
		try :
			return self._port
		except Exception as e:
	...
	@property
	def ecssubnet(self) :
		r"""Subnet for which the cached SRV record need to be removed.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add dnssrvrec.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete dnssrvrec.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update dnssrvrec.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of dnssrvrec resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the dnssrvrec resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = dnssrvrec()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of dnssrvrec resources.
	...
	def count(cls, client) :
		r""" Use this API to count the dnssrvrec resources configured on NetScaler.
		"""
		try :
			obj = dnssrvrec()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of dnssrvrec resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = dnssrvrec()
