...
class appflowpolicylabel_binding(base_resource):
	...
	@property
	def labelname(self) :
		r"""Name of the policy label about which to display detailed information.<br/>Minimum length =  1.
		"""
		try :
	...
	def appflowpolicylabel_appflowpolicy_bindings(self) :
		r"""appflowpolicy that can be bound to appflowpolicylabel.
		"""
		try :
	...
	def get(self, service, labelname="", option_="") :
		r""" Use this API to fetch appflowpolicylabel_binding resource.
		"""
		try :
			if not labelname :
