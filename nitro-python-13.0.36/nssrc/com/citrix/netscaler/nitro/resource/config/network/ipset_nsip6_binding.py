...
class ipset_nsip6_binding(base_resource) :
	...
	@property
	def name(self) :
		r"""Name of the IP set to which to bind IP addresses.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	@property
	def ipaddress(self) :
		r"""One or more IP addresses bound to the IP set.<br/>Minimum length =  1.
		"""
		try :
	...
	def get(cls, service, name="", option_="") :
		r""" Use this API to fetch ipset_nsip6_binding resources.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, service, name, filter_) :
		r""" Use this API to fetch filtered set of ipset_nsip6_binding resources.
	...
	def count(cls, service, name) :
		r""" Use this API to count ipset_nsip6_binding resources configued on NetScaler.
		"""
		try :
			obj = ipset_nsip6_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		r""" Use this API to count the filtered set of ipset_nsip6_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = ipset_nsip6_binding()
