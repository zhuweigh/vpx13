...
class systemgroup(base_resource) :
	...
	@property
	def groupname(self) :
		r"""Name for the group. Must begin with a letter, number, or the underscore (_) character, and must contain only alphanumeric, hyphen (-), period (.), hash (#), space ( ), at (@), equal (=), colon (:), and underscore characters. Cannot be changed after the group is created.
	...
	def add(cls, client, resource) :
		r""" Use this API to add systemgroup.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete systemgroup.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update systemgroup.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of systemgroup resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the systemgroup resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = systemgroup()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of systemgroup resources.
	...
	def count(cls, client) :
		r""" Use this API to count the systemgroup resources configured on NetScaler.
		"""
		try :
			obj = systemgroup()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of systemgroup resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = systemgroup()
