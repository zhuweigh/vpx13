...
class nat64(base_resource) :
	...
	@property
	def acl6name(self) :
		r"""Name of any configured ACL6 whose action is ALLOW.  IPv6 Packets matching the condition of this ACL6 rule and destination IP address of these packets matching the NAT64 IPv6 prefix are considered for NAT64 translation.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def netprofile(self) :
		r"""Name of the configured netprofile. The Citrix ADC selects one of the IP address in the netprofile as the source IP address of the translated IPv4 packet to be sent to the IPv4 server.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
	...
	def update(cls, client, resource) :
		r""" Use this API to update nat64.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of nat64 resource.
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete nat64.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the nat64 resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = nat64()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of nat64 resources.
	...
	def count(cls, client) :
		r""" Use this API to count the nat64 resources configured on NetScaler.
		"""
		try :
			obj = nat64()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of nat64 resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = nat64()
