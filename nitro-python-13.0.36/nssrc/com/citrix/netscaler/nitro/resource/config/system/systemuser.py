...
class systemuser(base_resource) :
	...
	def __init__(self) :
		self._username = None
		self._password = None
		self._externalauth = None
		self._promptstring = None
		self._timeout = None
		self._logging = None
		self._maxsession = None
		self._encrypted = None
		self._hashmethod = None
		self._promptinheritedfrom = None
		self._timeoutkind = None
		self.___count = None

	@property
	def username(self) :
		r"""Name for a user. Must begin with a letter, number, or the underscore (_) character, and must contain only alphanumeric, hyphen (-), period (.), hash (#), space ( ), at (@), equal (=), colon (:), and underscore characters. Cannot be changed after the user is added.
	...
	@property
	def password(self) :
		r"""Password for the system user. Can include any ASCII character.<br/>Minimum length =  1.
		"""
		try :
	...
	def externalauth(self) :
		r"""Whether to use external authentication servers for the system user authentication or not.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def timeout(self) :
		r"""CLI session inactivity timeout, in seconds. If Restrictedtimeout argument of system parameter is enabled, Timeout can have values in the range [300-86400] seconds. If Restrictedtimeout argument of system parameter is disabled, Timeout can have values in the range [0, 10-100000000] seconds. Default value is 900 seconds.
		"""
		try :
	...
	@property
	def logging(self) :
		r"""Users logging privilege.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def maxsession(self) :
		r"""Maximum number of client connection allowed per user.<br/>Default value: 20<br/>Minimum length =  1<br/>Maximum length =  40.
		"""
		try :
			return self._maxsession
		except Exception as e:
			raise e

	@maxsession.setter
	def maxsession(self, maxsession) :
		r"""Maximum number of client connection allowed per user.<br/>Default value: 20<br/>Minimum length =  1<br/>Maximum length =  40
		"""
		try :
			self._maxsession = maxsession
		except Exception as e:
			raise e
	...
	@property
	def hashmethod(self) :
		r""".<br/>Possible values = SHA1, SHA512.
		"""
		try :
			return self._hashmethod
		except Exception as e:
			raise e

	@property
	def promptinheritedfrom(self) :
		r"""From where the prompt has been inherited.<br/>Possible values = User, Group, Global, Climode.
		"""
		try :
	...
	def timeoutkind(self) :
		r"""From where the timeout has been inherited.<br/>Possible values = User, Group, Global, Climode.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add systemuser.
		"""
		try :
			if type(resource) is not list :
				...
				addresource.maxsession = resource.maxsession
				...
				if (resource and len(resource) > 0) :
					...
					for i in range(len(resource)) :
						...
						addresources[i].maxsession = resource[i].maxsession
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete systemuser.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update systemuser.
		"""
		try :
			if type(resource) is not list :
				...
				updateresource.maxsession = resource.maxsession
				...
				if (resource and len(resource) > 0) :
					...
					for i in range(len(resource)) :
						...
						updateresources[i].maxsession = resource[i].maxsession
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of systemuser resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the systemuser resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = systemuser()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of systemuser resources.
	...
	def count(cls, client) :
		r""" Use this API to count the systemuser resources configured on NetScaler.
		"""
		try :
			obj = systemuser()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of systemuser resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = systemuser()
