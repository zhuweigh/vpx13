...
class inat(base_resource) :
	...
	@property
	def publicip(self) :
		r"""Public IP address of packets received on the Citrix ADC. Can be aNetScaler-owned VIP or VIP6 address.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def privateip(self) :
		r"""IP address of the server to which the packet is sent by the Citrix ADC. Can be an IPv4 or IPv6 address.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def tcpproxy(self) :
		r"""Enable TCP proxy, which enables the Citrix ADC to optimize the RNAT TCP traffic by using Layer 4 features.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def usip(self) :
		r"""Enable the Citrix ADC to retain the source IP address of packets before sending the packets to the server.<br/>Possible values = ON, OFF.
		"""
		try :
			return self._usip
		except Exception as e:
	...
	@property
	def usnip(self) :
		r"""Enable the Citrix ADC to use a SNIP address as the source IP address of packets before sending the packets to the server.<br/>Possible values = ON, OFF.
		"""
		try :
			return self._usnip
		except Exception as e:
	...
	def useproxyport(self) :
		r"""Enable the Citrix ADC to proxy the source port of packets before sending the packets to the server.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
