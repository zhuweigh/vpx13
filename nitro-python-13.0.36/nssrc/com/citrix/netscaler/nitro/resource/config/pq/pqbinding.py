...
class pqbinding(base_resource) :
	...
	@property
	def policyname(self) :
		r"""The name of the priority queuing policy.
		"""
		try :
	...
	@property
	def rule(self) :
		r"""The condition for applying the policy.
		"""
		try :
			return self._rule
		except Exception as e:
	...
	@property
	def priority(self) :
		r"""The priority of queuing the request.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the pqbinding resources that are configured on netscaler.
		"""
		try :
	...
	def get_filtered(cls, client, filter_, obj) :
		r""" Use this API to fetch filtered set of pqbinding resources.
	...
	def count(cls, client, obj) :
		r""" Use this API to count the pqbinding resources configured on NetScaler.
		"""
		try :
			option_ = options()
			option_.count = True
	...
	def count_filtered(cls, client, filter_, obj) :
		r""" Use this API to count filtered the set of pqbinding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			option_ = options()
