...
class policydataset_value_binding(base_resource) :
	...
	@property
	def value(self) :
		r"""Value of the specified type that is associated with the dataset.
		"""
		try :
			return self._value
	...
	@property
	def name(self) :
		r"""Name of the dataset to which to bind the value.<br/>Minimum length =  1.
		"""
		try :
			return self._name
		except Exception as e:
	...
	@property
	def index(self) :
		r"""The index of the value (ipv4, ipv6, number) associated with the set.
		"""
		try :
			return self._index
		except Exception as e:
	...
	def get(cls, service, name="", option_="") :
		r""" Use this API to fetch policydataset_value_binding resources.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, service, name, filter_) :
		r""" Use this API to fetch filtered set of policydataset_value_binding resources.
	...
	def count(cls, service, name) :
		r""" Use this API to count policydataset_value_binding resources configued on NetScaler.
		"""
		try :
			obj = policydataset_value_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		r""" Use this API to count the filtered set of policydataset_value_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = policydataset_value_binding()
