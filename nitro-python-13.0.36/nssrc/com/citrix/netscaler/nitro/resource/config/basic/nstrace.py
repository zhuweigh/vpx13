...
class nstrace(base_resource) :
	...
	def mode(self) :
		...
		Default mode: NEW_RX TXB .<br/>Default value: DEFAULT_MODE<br/>Possible values = TX, TXB, RX, IPV6, NEW_RX, C2C, NS_FR_TX, APPFW, MPTCP, PolicyBased.
		"""
		try :
			return self._mode
		except Exception as e:
	...
	@property
	def capdroppkt(self) :
		r"""Captures Dropped Packets if set to ENABLED.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
