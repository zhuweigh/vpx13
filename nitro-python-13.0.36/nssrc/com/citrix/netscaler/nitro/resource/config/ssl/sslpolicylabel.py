...
class sslpolicylabel(base_resource) :
	...
	@property
	def labelname(self) :
		r"""Name for the SSL policy label.  Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@), equals (=), and hyphen (-) characters. Cannot be changed after the policy label is created.
	...
	@property
	def type(self) :
		r"""Type of policies that the policy label can contain.<br/>Possible values = CONTROL, DATA.
		"""
		try :
			return self._type
		except Exception as e:
	...
	@property
	def policyname(self) :
		r"""Name of the SSL policy to bind to the policy label.
		"""
		try :
	...
	@property
	def flowtype(self) :
		r"""Flowtype of the bound SSL policy.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add sslpolicylabel.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete sslpolicylabel.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the sslpolicylabel resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = sslpolicylabel()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of sslpolicylabel resources.
	...
	def count(cls, client) :
		r""" Use this API to count the sslpolicylabel resources configured on NetScaler.
		"""
		try :
			obj = sslpolicylabel()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of sslpolicylabel resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslpolicylabel()
