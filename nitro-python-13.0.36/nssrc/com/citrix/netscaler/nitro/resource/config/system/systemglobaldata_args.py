...
class systemglobaldata_args :
	r""" Provides additional arguments required for fetching the systemglobaldata resource.
	"""
	def __init__(self) :
		self._counters = None
	...
	def countergroup(self) :
		r"""Specify the (counter) group name which contains all the counters specific to this particular group.
		"""
		try :
