...
class lsnsipalgcall_datachannel_binding(base_resource) :
	...
	def get(cls, service, callid="", option_="") :
		r""" Use this API to fetch lsnsipalgcall_datachannel_binding resources.
		"""
		try :
			if not callid :
	...
	def get_filtered(cls, service, callid, filter_) :
		r""" Use this API to fetch filtered set of lsnsipalgcall_datachannel_binding resources.
	...
	def count(cls, service, callid) :
		r""" Use this API to count lsnsipalgcall_datachannel_binding resources configued on NetScaler.
		"""
		try :
			obj = lsnsipalgcall_datachannel_binding()
			obj.callid = callid
	...
	def count_filtered(cls, service, callid, filter_) :
		r""" Use this API to count the filtered set of lsnsipalgcall_datachannel_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = lsnsipalgcall_datachannel_binding()
