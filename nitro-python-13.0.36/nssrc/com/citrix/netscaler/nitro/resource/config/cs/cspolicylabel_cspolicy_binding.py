...
class cspolicylabel_cspolicy_binding(base_resource) :
	...
	@property
	def labelname(self) :
		r"""Name of the policy label to which to bind a content switching policy.
		"""
		try :
	...
	def get(cls, service, labelname="", option_="") :
		r""" Use this API to fetch cspolicylabel_cspolicy_binding resources.
		"""
		try :
			if not labelname :
	...
	def get_filtered(cls, service, labelname, filter_) :
		r""" Use this API to fetch filtered set of cspolicylabel_cspolicy_binding resources.
	...
	def count(cls, service, labelname) :
		r""" Use this API to count cspolicylabel_cspolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = cspolicylabel_cspolicy_binding()
			obj.labelname = labelname
	...
	def count_filtered(cls, service, labelname, filter_) :
		r""" Use this API to count the filtered set of cspolicylabel_cspolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = cspolicylabel_cspolicy_binding()
