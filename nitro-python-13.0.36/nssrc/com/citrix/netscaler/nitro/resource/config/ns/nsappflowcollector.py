...
class nsappflowcollector(base_resource) :
	...
	@property
	def name(self) :
		r"""Name of the AppFlow collector.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
			return self._name
	...
	@property
	def ipaddress(self) :
		r"""The IPv4 address of the AppFlow collector.
		"""
		try :
	...
	@property
	def port(self) :
		r"""The UDP port on which the AppFlow collector is listening.<br/>Default value: 4739.
		"""
		try :
			return self._port
		except Exception as e:
	...
	def add(cls, client, resource) :
		r""" Use this API to add nsappflowcollector.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete nsappflowcollector.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the nsappflowcollector resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of nsappflowcollector resources.
	...
	def count(cls, client) :
		r""" Use this API to count the nsappflowcollector resources configured on NetScaler.
		"""
		try :
			obj = nsappflowcollector()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of nsappflowcollector resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = nsappflowcollector()
