...
class azurekeyvault(base_resource) :
	...
	@property
	def name(self) :
		r"""Name of keyvault entity in NetScaler.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	def azurevaultname(self) :
		r"""Name of the Azure vault account as configured in azure portal.<br/>Minimum length =  3<br/>Maximum length =  25.
		"""
		try :
	...
	def azureapplication(self) :
		r"""Name of Azure Application object to be used for authentication with this keyvault.<br/>Minimum length =  1<br/>Maximum length =  63.
		"""
		try :
			...
			if type(resource) is not list :
				...
				if (resource and len(resource) > 0) :
					...
					for i in range(len(resource)) :
						...
						addresources[i].azurevaultname = resource[i].azurevaultname
						addresources[i].azureapplication = resource[i].azureapplication
