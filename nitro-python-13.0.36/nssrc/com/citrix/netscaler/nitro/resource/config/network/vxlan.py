...
class vxlan(base_resource) :
	...
	@property
	def vlan(self) :
		r"""ID of VLANs whose traffic is allowed over this VXLAN. If you do not specify any VLAN IDs, the Citrix ADC allows traffic of all VLANs that are not part of any other VXLANs.<br/>Minimum length =  2<br/>Maximum length =  4094.
		"""
		try :
			return self._vlan
		except Exception as e:
	...
	def innervlantagging(self) :
		r"""Specifies whether Citrix ADC should generate VXLAN packets with inner VLAN tag.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
