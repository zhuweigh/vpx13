...
class autoscaleprofile(base_resource) :
	...
	@property
	def type(self) :
		r"""The type of profile.<br/>Possible values = CLOUDSTACK.
		"""
		try :
			return self._type
		except Exception as e:
	...
	@property
	def url(self) :
		r"""URL providing the service.<br/>Minimum length =  1.
		"""
		try :
			return self._url
		except Exception as e:
	...
	@property
	def apikey(self) :
		r"""api key for authentication with service.<br/>Minimum length =  1.
		"""
		try :
			return self._apikey
		except Exception as e:
	...
	def sharedsecret(self) :
		r"""shared secret for authentication with service.<br/>Minimum length =  1.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add autoscaleprofile.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete autoscaleprofile.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update autoscaleprofile.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the autoscaleprofile resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of autoscaleprofile resources.
	...
	def count(cls, client) :
		r""" Use this API to count the autoscaleprofile resources configured on NetScaler.
		"""
		try :
			obj = autoscaleprofile()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of autoscaleprofile resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = autoscaleprofile()
