...
class capolicy_binding(base_resource):
	...
	def capolicy_csvserver_bindings(self) :
		r"""csvserver that can be bound to capolicy.
		"""
		try :
	...
	def capolicy_caglobal_bindings(self) :
		r"""caglobal that can be bound to capolicy.
		"""
		try :
	...
	def capolicy_lbvserver_bindings(self) :
		r"""lbvserver that can be bound to capolicy.
		"""
		try :
	...
	def get(self, service, name="", option_="") :
		r""" Use this API to fetch capolicy_binding resource.
		"""
		try :
			if not name :
