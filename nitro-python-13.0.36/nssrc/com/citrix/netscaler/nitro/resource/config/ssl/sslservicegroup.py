...
class sslservicegroup(base_resource) :
	...
	@property
	def tls13(self) :
		r"""State of TLSv1.3 protocol support for the SSL service group.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._tls13
		except Exception as e:
	...
	def strictsigdigestcheck(self) :
		r"""Parameter indicating to check whether peer's certificate is signed with one of signature-hash combination supported by Citrix ADC.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
