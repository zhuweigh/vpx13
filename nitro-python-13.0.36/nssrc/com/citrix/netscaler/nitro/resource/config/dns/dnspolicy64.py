...
class dnspolicy64(base_resource) :
	...
	@property
	def action(self) :
		r"""Name of the DNS64 action to perform when the rule evaluates to TRUE. The built in actions function as follows:
	...
	def add(cls, client, resource) :
		r""" Use this API to add dnspolicy64.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete dnspolicy64.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update dnspolicy64.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the dnspolicy64 resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = dnspolicy64()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of dnspolicy64 resources.
	...
	def count(cls, client) :
		r""" Use this API to count the dnspolicy64 resources configured on NetScaler.
		"""
		try :
			obj = dnspolicy64()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of dnspolicy64 resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = dnspolicy64()
