...
class systemglobal_binding(base_resource):
	...
	def systemglobal_authenticationldappolicy_bindings(self) :
		r"""authenticationldappolicy that can be bound to systemglobal.
		"""
		try :
	...
	def systemglobal_auditsyslogpolicy_bindings(self) :
		r"""auditsyslogpolicy that can be bound to systemglobal.
		"""
		try :
	...
	def systemglobal_authenticationlocalpolicy_bindings(self) :
		r"""authenticationlocalpolicy that can be bound to systemglobal.
		"""
		try :
	...
	def systemglobal_auditnslogpolicy_bindings(self) :
		r"""auditnslogpolicy that can be bound to systemglobal.
		"""
		try :
	...
	def systemglobal_authenticationtacacspolicy_bindings(self) :
		r"""authenticationtacacspolicy that can be bound to systemglobal.
		"""
		try :
	...
	def systemglobal_authenticationpolicy_bindings(self) :
		r"""authenticationpolicy that can be bound to systemglobal.
		"""
		try :
	...
	def systemglobal_authenticationradiuspolicy_bindings(self) :
		r"""authenticationradiuspolicy that can be bound to systemglobal.
		"""
		try :
	...
	def get(self, service) :
		r""" Use this API to fetch a systemglobal_binding resource .
		"""
		try :
