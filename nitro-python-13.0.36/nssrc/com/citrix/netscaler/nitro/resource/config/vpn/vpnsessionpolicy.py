...
class vpnsessionpolicy(base_resource) :
	...
	@property
	def name(self) :
		r"""Name for the new session policy that is applied after the user logs on to Citrix Gateway.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	@property
	def action(self) :
		r"""Action to be applied by the new session policy if the rule criteria are met.<br/>Minimum length =  1.
		"""
		try :
			return self._action
		except Exception as e:
	...
	def add(cls, client, resource) :
		r""" Use this API to add vpnsessionpolicy.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete vpnsessionpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update vpnsessionpolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of vpnsessionpolicy resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the vpnsessionpolicy resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of vpnsessionpolicy resources.
	...
	def count(cls, client) :
		r""" Use this API to count the vpnsessionpolicy resources configured on NetScaler.
		"""
		try :
			obj = vpnsessionpolicy()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of vpnsessionpolicy resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnsessionpolicy()
