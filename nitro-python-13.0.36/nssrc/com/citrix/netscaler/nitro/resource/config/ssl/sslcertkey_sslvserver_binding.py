...
class sslcertkey_sslvserver_binding(base_resource) :
	...
	@property
	def vserver(self) :
		r"""Specify this option to bind the certificate to an SSL virtual server.
	...
	def vservername(self) :
		r"""The name of the SSL virtual server name to which the certificate-key pair needs to be bound.
		"""
		try :
	...
	@property
	def servername(self) :
		r"""Vserver name to which the certificate key pair is bound.
		"""
		try :
	...
	def get(cls, service, certkey="", option_="") :
		r""" Use this API to fetch sslcertkey_sslvserver_binding resources.
		"""
		try :
			if not certkey :
	...
	def get_filtered(cls, service, certkey, filter_) :
		r""" Use this API to fetch filtered set of sslcertkey_sslvserver_binding resources.
	...
	def count(cls, service, certkey) :
		r""" Use this API to count sslcertkey_sslvserver_binding resources configued on NetScaler.
		"""
		try :
			obj = sslcertkey_sslvserver_binding()
			obj.certkey = certkey
	...
	def count_filtered(cls, service, certkey, filter_) :
		r""" Use this API to count the filtered set of sslcertkey_sslvserver_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslcertkey_sslvserver_binding()
