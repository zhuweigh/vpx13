...
class svcbindings(base_resource) :
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the svcbindings resources that are configured on netscaler.
		"""
		try :
	...
	def get_filtered(cls, client, filter_, obj) :
		r""" Use this API to fetch filtered set of svcbindings resources.
	...
	def count(cls, client, obj) :
		r""" Use this API to count the svcbindings resources configured on NetScaler.
		"""
		try :
			option_ = options()
			option_.count = True
	...
	def count_filtered(cls, client, filter_, obj) :
		r""" Use this API to count filtered the set of svcbindings resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			option_ = options()
