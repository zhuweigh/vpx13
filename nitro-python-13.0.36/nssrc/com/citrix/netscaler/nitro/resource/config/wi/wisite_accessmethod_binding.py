...
class wisite_accessmethod_binding(base_resource) :
	...
	def __init__(self) :
		...
		self._clientnetmask = None
		self._sitepath = None
		self.___count = None

	@property
	def clientipaddress(self) :
		r"""IPv4 or network address of the client for which you want to associate an access method.<br/>Default value: 0.
		"""
		try :
	...
	def clientnetmask(self) :
		r"""Subnet mask associated with the IPv4 or network address specified by the Client IP Address parameter.<br/>Default value: 0.
		"""
		try :
	...
	def accessmethod(self) :
		r"""Secure access method to be applied to the IPv4 or network address of the client specified by the Client IP Address parameter.
	...
	def get(cls, service, sitepath="", option_="") :
		r""" Use this API to fetch wisite_accessmethod_binding resources.
		"""
		try :
			if not sitepath :
	...
	def get_filtered(cls, service, sitepath, filter_) :
		r""" Use this API to fetch filtered set of wisite_accessmethod_binding resources.
	...
	def count(cls, service, sitepath) :
		r""" Use this API to count wisite_accessmethod_binding resources configued on NetScaler.
		"""
		try :
			obj = wisite_accessmethod_binding()
			obj.sitepath = sitepath
	...
	def count_filtered(cls, service, sitepath, filter_) :
		r""" Use this API to count the filtered set of wisite_accessmethod_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = wisite_accessmethod_binding()
