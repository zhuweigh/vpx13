...
class nsconnectiontable(base_resource) :
	...
	def __init__(self) :
		...
		self._cqabifavg = None
		self._cqathruputavg = None
		self._cqarcvwndavg = None
		self._cqaiai1mspct = None
		self._cqaiai2mspct = None
		self._cqasamples = None
		self._cqaiaisamples = None
		self._cqanetclass = None
		self._cqaccl = None
		self._cqacsq = None
		self._cqaiaiavg = None
		self._cqaisiavg = None
		self._cqarcvwndmin = None
		self._cqaretxcorr = None
		self._cqaretxcong = None
		self._cqaretxpackets = None
		self._cqaloaddelayavg = None
		self._cqanoisedelayavg = None
		self._cqarttmax = None
		self._cqarttmin = None
		self._cqarttavg = None
		self._adaptivetcpprofname = None
		self._outoforderblocks = None
		self._outoforderflushedcount = None
		self._outoforderbytes = None
		self.___count = None
	...
	def detail(self) :
		...
		* FULL - Displays all available details.<br/>Possible values = LINK, NAME, CONNFAILOVER, FULL, NNM, FULL+.
		"""
		try :
			return self._detail
		except Exception as e:
	...
	@property
	def entityname(self) :
		r"""Citrix ADC entity name for the connection.
		"""
		try :
	...
	def linkentityname(self) :
		r"""Citrix ADC entity name for link connection.
		"""
		try :
	...
	@property
	def nswsvalue(self) :
		r"""Citrix ADC window scaling value.
		"""
		try :
	...
	def httprequest(self) :
		r"""current HTTP request type on the connection.<br/>Possible values = OPTIONS, GET, HEAD, POST, PUT, DELETE, TRACE, TRACK, CONNECT, RPCCONNECT.
		"""
		try :
	...
	def linknswsvalue(self) :
		r"""Link connection-s Citrix ADC window scaling value.
		"""
		try :
	...
	def linkpeerwsvalue(self) :
		r"""Link connection-s peer Citrix ADC window scaling value.
		"""
		try :
	...
	@property
	def rxqsize(self) :
		r"""Total number of bytes in Citrix ADC receive buffer. This includes bytes being processed / policy related data / stored in application buffer.
		"""
		try :
	...
	def linkrxqsize(self) :
		r"""Total number of bytes in Citrix ADC receive buffer for linked connection. This includes bytes being processed / policy related data / stored in application buffer.
		"""
		try :
	...
	@property
	def txqsize(self) :
		r"""Total number of bytes in Citrix ADC send buffer. This includes both inflight and queued bytes in Citrix ADC.
		"""
		try :
	...
	def linktxqsize(self) :
		r"""Total number of bytes in Citrix ADC send buffer for linked connection. This includes both inflight and queued bytes in Citrix ADC.
		"""
		try :
	...
	@property
	def cqabifavg(self) :
		r"""Average bytes in flight over maxburst.
		"""
		try :
			return self._cqabifavg
		except Exception as e:
			raise e

	@property
	def cqathruputavg(self) :
		r"""Average instantaneous throughput over maxburst.
		"""
		try :
			return self._cqathruputavg
		except Exception as e:
			raise e

	@property
	def cqarcvwndavg(self) :
		r"""Average receive window over maxburst.
		"""
		try :
			return self._cqarcvwndavg
		except Exception as e:
			raise e

	@property
	def cqaiai1mspct(self) :
		r"""Percentage of inter arriaval samples for 1ms over maxburst.
		"""
		try :
			return self._cqaiai1mspct
		except Exception as e:
			raise e

	@property
	def cqaiai2mspct(self) :
		r"""Percentage of inter arriaval samples for 2ms over maxburst.
		"""
		try :
			return self._cqaiai2mspct
		except Exception as e:
			raise e

	@property
	def cqasamples(self) :
		r"""Number of ACK samples over maxburst.
		"""
		try :
			return self._cqasamples
		except Exception as e:
			raise e

	@property
	def cqaiaisamples(self) :
		r"""Number of samples considered for calculating inter arrival interval over maxburst.
		"""
		try :
			return self._cqaiaisamples
		except Exception as e:
			raise e

	@property
	def cqanetclass(self) :
		r"""Network type name.<br/>Maximum length =  49.
		"""
		try :
			return self._cqanetclass
		except Exception as e:
			raise e

	@property
	def cqaccl(self) :
		r"""Connection congestion level.<br/>Minimum value =  0<br/>Maximum value =  100.
		"""
		try :
			return self._cqaccl
		except Exception as e:
	...
	@property
	def cqacsq(self) :
		r"""Connectiontion signal quality level.<br/>Minimum value =  0<br/>Maximum value =  100.
		"""
		try :
			return self._cqacsq
		except Exception as e:
	...
	@property
	def cqaiaiavg(self) :
		r"""Average inter arriaval interval over maxburst.
		"""
		try :
			return self._cqaiaiavg
		except Exception as e:
			raise e

	@property
	def cqaisiavg(self) :
		r"""Average inter send interval over maxburst.
		"""
		try :
			return self._cqaisiavg
		except Exception as e:
			raise e

	@property
	def cqarcvwndmin(self) :
		r"""Minimum receive window over maxburst.
		"""
		try :
			return self._cqarcvwndmin
		except Exception as e:
			raise e

	@property
	def cqaretxcorr(self) :
		r"""Number of retransmission due to noise over maxburst.
		"""
		try :
			return self._cqaretxcorr
		except Exception as e:
			raise e

	@property
	def cqaretxcong(self) :
		r"""Number of retransmission due to congestion over maxburst.
		"""
		try :
			return self._cqaretxcong
		except Exception as e:
			raise e

	@property
	def cqaretxpackets(self) :
		r"""Number of retransmission over maxburst.
		"""
		try :
			return self._cqaretxpackets
		except Exception as e:
			raise e

	@property
	def cqaloaddelayavg(self) :
		r"""Average load delay over maxburst.
		"""
		try :
			return self._cqaloaddelayavg
		except Exception as e:
			raise e

	@property
	def cqanoisedelayavg(self) :
		r"""Average noise delay over maxburst.
		"""
		try :
			return self._cqanoisedelayavg
		except Exception as e:
			raise e

	@property
	def cqarttmax(self) :
		r"""Maximum RTT sample over maxburst in ms.
		"""
		try :
			return self._cqarttmax
		except Exception as e:
			raise e

	@property
	def cqarttmin(self) :
		r"""Minimum RTT sample over maxburst in ms.
		"""
		try :
			return self._cqarttmin
		except Exception as e:
			raise e
	...
	def cqarttavg(self) :
		...
		"""
		try :
			return self._cqarttavg
		except Exception as e:
			raise e

	@property
	def adaptivetcpprofname(self) :
		r"""Name of the Adaptive-TCP profile currently assigned to the connection.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
			return self._adaptivetcpprofname
		except Exception as e:
			raise e

	@property
	def outoforderblocks(self) :
		r"""held packets on the connection.
		"""
		try :
			return self._outoforderblocks
		except Exception as e:
			raise e

	@property
	def outoforderflushedcount(self) :
		r"""held packets on the connection.
		"""
		try :
			return self._outoforderflushedcount
		except Exception as e:
			raise e

	@property
	def outoforderbytes(self) :
		r"""held packets on the connection.
		"""
		try :
			return self._outoforderbytes
		except Exception as e:
			raise e
