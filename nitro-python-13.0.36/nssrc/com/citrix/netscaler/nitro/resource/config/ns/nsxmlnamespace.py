...
class nsxmlnamespace(base_resource) :
	...
	@property
	def prefix(self) :
		r"""XML prefix.<br/>Minimum length =  1.
		"""
		try :
			return self._prefix
	...
	@property
	def Namespace(self) :
		r"""Expanded namespace for which the XML prefix is provided.<br/>Minimum length =  1.
		"""
		try :
	...
	def description(self) :
		r"""Description for the prefix.<br/>Minimum length =  1.
		"""
		try :
	...
	def add(cls, client, resource) :
		r""" Use this API to add nsxmlnamespace.
		"""
		try :
	...
	def delete(cls, client, resource) :
		r""" Use this API to delete nsxmlnamespace.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		r""" Use this API to update nsxmlnamespace.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of nsxmlnamespace resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the nsxmlnamespace resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = nsxmlnamespace()
	...
	def get_filtered(cls, client, filter_) :
		r""" Use this API to fetch filtered set of nsxmlnamespace resources.
	...
	def count(cls, client) :
		r""" Use this API to count the nsxmlnamespace resources configured on NetScaler.
		"""
		try :
			obj = nsxmlnamespace()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		r""" Use this API to count filtered the set of nsxmlnamespace resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = nsxmlnamespace()
