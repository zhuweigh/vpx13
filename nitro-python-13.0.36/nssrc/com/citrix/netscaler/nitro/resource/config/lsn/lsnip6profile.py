...
class lsnip6profile(base_resource) :
	...
	@property
	def natprefix(self) :
		r"""IPv6 address(es) of the LSN subscriber(s) or subscriber network(s) on whose traffic you want the Citrix ADC to perform Large Scale NAT.
		"""
		try :
	...
	@property
	def network6(self) :
		r"""IPv6 address of the Citrix ADC AFTR device.
		"""
		try :
