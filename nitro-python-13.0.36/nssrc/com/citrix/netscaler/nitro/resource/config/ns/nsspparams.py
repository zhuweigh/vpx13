...
class nsspparams(base_resource) :
	...
	def basethreshold(self) :
		r"""Maximum number of server connections that can be opened before surge protection is activated.<br/>Default value: 200<br/>Maximum length =  0x7FFF.
		"""
		try :
	...
	@property
	def throttle(self) :
		r"""Rate at which the system opens connections to the server.<br/>Default value: Normal<br/>Possible values = Aggressive, Normal, Relaxed.
		"""
		try :
	...
	def update(cls, client, resource) :
		r""" Use this API to update nsspparams.
		"""
		try :
	...
	def unset(cls, client, resource, args) :
		r""" Use this API to unset the properties of nsspparams resource.
	...
	def get(cls, client, name="", option_="") :
		r""" Use this API to fetch all the nsspparams resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = nsspparams()
