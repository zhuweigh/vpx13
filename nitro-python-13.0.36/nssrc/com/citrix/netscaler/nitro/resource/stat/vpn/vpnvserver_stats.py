...
class vpnvserver_stats(base_resource) :
	...
	@property
	def vpnurlpolicy(self) :
		r"""vpnurlpolicy that are bound to vpnvserver.
		"""
		try :
			return self._vpnurlpolicy
		except Exception as e:
			raise e

	@vpnurlpolicy.setter
	def vpnurlpolicy(self, vpnurlpolicy) :
		r"""vpnurlpolicy that are bound to vpnvserver.
		"""
		try :
			self._vpnurlpolicy = vpnurlpolicy
		except Exception as e:
			raise e
	...
	@property
	def authenticationoauthidppolicy(self) :
		r"""authenticationoauthidppolicy that are bound to vpnvserver.
		"""
		try :
			return self._authenticationoauthidppolicy
		except Exception as e:
			raise e

	@authenticationoauthidppolicy.setter
	def authenticationoauthidppolicy(self, authenticationoauthidppolicy) :
		r"""authenticationoauthidppolicy that are bound to vpnvserver.
		"""
		try :
			self._authenticationoauthidppolicy = authenticationoauthidppolicy
		except Exception as e:
			raise e
