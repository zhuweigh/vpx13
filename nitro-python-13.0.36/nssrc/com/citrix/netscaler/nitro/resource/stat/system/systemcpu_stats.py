...
class systemcpu_stats(base_resource) :
	...
	@property
	def id(self) :
		r"""ID of the CPU for which to display statistics.<br/>Default value: 65535<br/>Minimum value =  0<br/>Maximum value =  65534.
		"""
		try :
			return self._id
	...
	@id.setter
	def id(self, id) :
		r"""ID of the CPU for which to display statistics.
		"""
		try :
			self._id = id
		except Exception as e:
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all systemcpu_stats resources that are configured on netscaler.
