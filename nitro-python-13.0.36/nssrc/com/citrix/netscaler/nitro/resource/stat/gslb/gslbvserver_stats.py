...
class gslbvserver_stats(base_resource) :
	...
	def __init__(self) :
		...
		self._tothits = 0
		self._hitsrate = 0
		self._vsvrtotbkplbhits = 0
		self._vsvrtotbkplbfail = 0
		self._curpersistencesessions = 0
		self._vsvrtotpersistencehits = 0
	...
	@property
	def vsvrtotbkplbfail(self) :
		r""" Total backup LB method fails.
		"""
		try :
			return self._vsvrtotbkplbfail
		except Exception as e:
			raise e

	@property
	def vsvrtotbkplbhits(self) :
		r""" Total backup LB method hits.
		"""
		try :
			return self._vsvrtotbkplbhits
		except Exception as e:
			raise e
	...
	@property
	def vsvrtotpersistencehits(self) :
		r"""Total number of Persistence hits at vserver.
		"""
		try :
			return self._vsvrtotpersistencehits
		except Exception as e:
			raise e
	...
	@property
	def gslbservicegroup(self) :
		r"""gslbservicegroup that are bound to gslbvserver.
		"""
		try :
			return self._gslbservicegroup
		except Exception as e:
			raise e

	@gslbservicegroup.setter
	def gslbservicegroup(self, gslbservicegroup) :
		r"""gslbservicegroup that are bound to gslbvserver.
		"""
		try :
			self._gslbservicegroup = gslbservicegroup
		except Exception as e:
			raise e
