...
class systembw_stats(base_resource) :
	...
	def httpcltttfp_4rate(self) :
		r"""Rate (/s) counter for httpcltttfp_4.
		"""
		try :
	...
	def httpcltttlp_5rate(self) :
		r"""Rate (/s) counter for httpcltttlp_5.
		"""
		try :
	...
	def httpcltttfp_2rate(self) :
		r"""Rate (/s) counter for httpcltttfp_2.
		"""
		try :
	...
	def httpcltttfp_7rate(self) :
		r"""Rate (/s) counter for httpcltttfp_7.
		"""
		try :
	...
	def httpcltttlphwmrate(self) :
		r"""Rate (/s) counter for httpcltttlphwm.
		"""
		try :
	...
	def httpcltttfp_0rate(self) :
		r"""Rate (/s) counter for httpcltttfp_0.
		"""
		try :
	...
	def httpcltttlplwmrate(self) :
		r"""Rate (/s) counter for httpcltttlplwm.
		"""
		try :
	...
	def httpcltttfp_4(self) :
		r"""Number of Responses Falling on Band-4 for TTFP.
		"""
		try :
	...
	def httpcltttlplwm(self) :
		r"""Number of Responses Falling on LWM for TTLP.
		"""
		try :
	...
	def httpcltttlp_1(self) :
		r"""Number of Responses Falling on Band-1 for TTLP.
		"""
		try :
	...
	def httpsvr404notfoundrate(self) :
		r"""Rate (/s) counter for httpsvr404notfound.
		"""
		try :
	...
	def httpcltttlp_6(self) :
		r"""Number of Responses Falling on Band-6 for TTLP.
		"""
		try :
	...
	def httpcltttlphwm(self) :
		r"""Number of Responses Falling on HWM for TTLP.
		"""
		try :
	...
	def httpcltttlp_1rate(self) :
		r"""Rate (/s) counter for httpcltttlp_1.
		"""
		try :
	...
	def httpcltpoolinactive(self) :
		r"""No of requests sent from BW client.
		"""
		try :
	...
	def httpcltttlp_3(self) :
		r"""Number of Responses Falling on Band-3 for TTLP.
		"""
		try :
	...
	def httpcltttlp_5(self) :
		r"""Number of Responses Falling on Band-5 for TTLP.
		"""
		try :
	...
	def httpcltttlp_6rate(self) :
		r"""Rate (/s) counter for httpcltttlp_6.
		"""
		try :
	...
	def httpsvr200okresprate(self) :
		r"""Rate (/s) counter for httpsvr200okresp.
		"""
		try :
	...
	def httpcltttfp_1rate(self) :
		r"""Rate (/s) counter for httpcltttfp_1.
		"""
		try :
	...
	def httpcltttfp_1(self) :
		r"""Number of Responses Falling on Band-1 for TTFP.
		"""
		try :
	...
	def httpcltttfphwmrate(self) :
		r"""Rate (/s) counter for httpcltttfphwm.
		"""
		try :
	...
	def httpcltttfp_6(self) :
		r"""Number of Responses Falling on Band-6 for TTFP.
		"""
		try :
	...
	def httpcltttfpmax(self) :
		r"""Peak RTT observed for Time to First response packet.
		"""
		try :
	...
	def httpcltttfp_5(self) :
		r"""Number of Responses Falling on Band-5 for TTFP.
		"""
		try :
	...
	def httpcltttlpmax(self) :
		r"""Peak RTT observed for Time to Last response packet.
		"""
		try :
	...
	def httpcltttlp_4rate(self) :
		r"""Rate (/s) counter for httpcltttlp_4.
		"""
		try :
	...
	def httpcltttlp_7rate(self) :
		r"""Rate (/s) counter for httpcltttlp_7.
		"""
		try :
	...
	def httpcltttfp_0(self) :
		r"""Number of Responses Falling on Band-0 for TTFP.
		"""
		try :
	...
	def httpcltttfp_3(self) :
		r"""Number of Responses Falling on Band-3 for TTFP.
		"""
		try :
	...
	def httpcltttfphwm(self) :
		r"""Number of Responses Falling on HWM for TTFP.
		"""
		try :
	...
	def httpclterrstray(self) :
		r"""Number of stray packets received from server without HTTP request.
		"""
		try :
	...
	def httpcltttlp_0rate(self) :
		r"""Rate (/s) counter for httpcltttlp_0.
		"""
		try :
	...
	def httpcltttfplwm(self) :
		r"""Number of Responses Falling on LWM for TTFP.
		"""
		try :
	...
	def httpcltttlp_0(self) :
		r"""Number of Responses Falling on Band-0 for TTLP.
		"""
		try :
	...
	def httpclterrstrayrate(self) :
		r"""Rate (/s) counter for httpclterrstray.
		"""
		try :
	...
	def httpcltttfplwmrate(self) :
		r"""Rate (/s) counter for httpcltttfplwm.
		"""
		try :
	...
	def httpcltttlp_2(self) :
		r"""Number of Responses Falling on Band-2 for TTLP.
		"""
		try :
	...
	def httpcltttfp_2(self) :
		r"""Number of Responses Falling on Band-2 for TTFP.
		"""
		try :
	...
	def httpcltttlp_2rate(self) :
		r"""Rate (/s) counter for httpcltttlp_2.
		"""
		try :
	...
	def httpcltttlp_4(self) :
		r"""Number of Responses Falling on Band-4 for TTLP.
		"""
		try :
	...
	def httpcltttfp_7(self) :
		r"""Number of Responses Falling on Band-7 for TTFP.
		"""
		try :
	...
	def httpsvr200okresp(self) :
		r"""Number of 200 Ok response sent from the BW appliance.
		"""
		try :
	...
	def httpsvr404notfound(self) :
		r"""Number of 404 Not Found responses sent.
		"""
		try :
	...
	def httpcltttlp_3rate(self) :
		r"""Rate (/s) counter for httpcltttlp_3.
		"""
		try :
	...
	def httpcltttfp_6rate(self) :
		r"""Rate (/s) counter for httpcltttfp_6.
		"""
		try :
	...
	def httpcltttfp_5rate(self) :
		r"""Rate (/s) counter for httpcltttfp_5.
		"""
		try :
	...
	def httpcltttfp_3rate(self) :
		r"""Rate (/s) counter for httpcltttfp_3.
		"""
		try :
	...
	def httpcltttlp_7(self) :
		r"""Number of Responses Falling on Band-7 for TTLP.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all systembw_stats resources that are configured on netscaler.
