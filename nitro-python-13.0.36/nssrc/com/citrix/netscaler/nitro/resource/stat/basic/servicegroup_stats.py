...
class servicegroup_stats(base_resource) :
	r""" Statistics for service group resource.
	"""
	def __init__(self) :
	...
	def servicegroupname(self) :
		r"""Name of the service group for which to display settings.<br/>Minimum length =  1.
		"""
		try :
	...
	def servicegroupname(self, servicegroupname) :
		r"""Name of the service group for which to display settings.
		"""
		try :
	...
	@property
	def servicegroupmember(self) :
		r"""servicegroupmember that are bound to servicegroup.
		"""
		try :
			return self._servicegroupmember
		except Exception as e:
			raise e

	@servicegroupmember.setter
	def servicegroupmember(self, servicegroupmember) :
		r"""servicegroupmember that are bound to servicegroup.
		"""
		try :
			self._servicegroupmember = servicegroupmember
		except Exception as e:
			raise e
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all servicegroup_stats resources that are configured on netscaler.
