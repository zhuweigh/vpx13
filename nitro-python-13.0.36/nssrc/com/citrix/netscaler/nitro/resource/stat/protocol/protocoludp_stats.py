...
class protocoludp_stats(base_resource) :
	r""" Statistics for UDP Protocol resource.
	"""
	def __init__(self) :
	...
	def udptxpktsrate(self) :
		r"""Rate (/s) counter for udptottxpkts.
		"""
		try :
	...
	def udpcurratethreshold(self) :
		r"""Limit for UDP packets handled every 10 milliseconds. Default value, 0, applies no limit.
	...
	def udptotrxpkts(self) :
		r"""Total number of UDP packets received.
		"""
		try :
	...
	def udptottxpkts(self) :
		r"""Total number of UDP packets transmitted.
		"""
		try :
	...
	def udptotrxbytes(self) :
		r"""Total number of UDP data received in bytes.
		"""
		try :
	...
	def udptxbytesrate(self) :
		r"""Rate (/s) counter for udptottxbytes.
		"""
		try :
	...
	def udprxpktsrate(self) :
		r"""Rate (/s) counter for udptotrxpkts.
		"""
		try :
	...
	def udpbadchecksum(self) :
		r"""Packets received with a UDP checksum error.
		"""
		try :
	...
	def udptottxbytes(self) :
		r"""Total number of UDP data transmitted in bytes.
		"""
		try :
	...
	def udptotunknownsvcpkts(self) :
		r"""Stray UDP packets dropped due to no configured listening  service.
		"""
		try :
	...
	def udprxbytesrate(self) :
		r"""Rate (/s) counter for udptotrxbytes.
		"""
		try :
	...
	def udpcurratethresholdexceeds(self) :
		r"""Number of times the UDP rate threshold is exceeded. If this counter continuously increases, first make sure the UDP packets received are genuine. 
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all protocoludp_stats resources that are configured on netscaler.
