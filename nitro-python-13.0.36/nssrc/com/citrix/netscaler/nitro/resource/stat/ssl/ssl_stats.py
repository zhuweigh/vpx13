...
class ssl_stats(base_resource) :
	def __init__(self) :
		...
		self._ssltottlsv13transactions = 0
		self._ssltlsv13transactionsrate = 0
		self._ssltotdtlsv1transactions = 0
		self._ssldtlsv1transactionsrate = 0
		...
		self._ssltottlsv13sessions = 0
		self._ssltlsv13sessionsrate = 0
		self._ssltotdtlsv1sessions = 0
		self._ssldtlsv1sessionsrate = 0
		...
		self._sslbetotdtlsv1sessions = 0
		self._sslbedtlsv1sessionsrate = 0
		...
		self._ssltotdtlsv1renegsessions = 0
		self._ssldtlsv1renegsessionsrate = 0
		...
		self._ssltotdh4096keyexchanges = 0
		self._ssldh4096keyexchangesrate = 0
		...
		self._ssltottlsv13handshakes = 0
		self._ssltlsv13handshakesrate = 0
		self._ssltotdtlsv1handshakes = 0
		self._ssldtlsv1handshakesrate = 0
		...
		self._ssltottlsv13clientauthentications = 0
		self._ssltlsv13clientauthenticationsrate = 0
		self._ssltotdtlsv1clientauthentications = 0
		self._ssldtlsv1clientauthenticationsrate = 0
		...
		self._ssltotbkenddtlsvlrenego = 0
		self._sslbkenddtlsvlrenegorate = 0
		...
		self._sslbetotrsa4096keyexchanges = 0
		self._sslbersa4096keyexchangesrate = 0
		...
		self._sslbetotdh4096keyexchanges = 0
		self._sslbedh4096keyexchangesrate = 0
		...
		self._ssltotbkendcipheraesgcm128 = 0
		self._sslbkendcipheraesgcm128rate = 0
		self._ssltotbkendcipheraesgcm256 = 0
		self._sslbkendcipheraesgcm256rate = 0
		...
		self._sslbetotdtlsv1handshakes = 0
		self._sslbedtlsv1handshakesrate = 0
		...
		self._sslbetotdtlsv1clientauthentications = 0
		self._sslbedtlsv1clientauthenticationsrate = 0
	...
	@property
	def ssltotdtlsv1renegsessions(self) :
		r"""Number of SSL session renegotiations done on DTLSv1.
		"""
		try :
			return self._ssltotdtlsv1renegsessions
		except Exception as e:
			raise e

	@property
	def ssldtlsv1handshakesrate(self) :
		r"""Rate (/s) counter for ssltotdtlsv1handshakes.
		"""
		try :
			return self._ssldtlsv1handshakesrate
		except Exception as e:
			raise e
	...
	def sslbetotsha384mac(self) :
		r"""Number of back-end SHA384 hashes on the Citrix ADC.
		"""
		try :
	...
	def sslbetottlsv1handshakes(self) :
		r"""Number of back-end TLSv1 handshakes on the Citrix ADC.
		"""
		try :
	...
	@property
	def sslbkenddtlsvlrenegorate(self) :
		r"""Rate (/s) counter for ssltotbkenddtlsvlrenego.
		"""
		try :
			return self._sslbkenddtlsvlrenegorate
		except Exception as e:
			raise e
	...
	def ssltottransactions(self) :
		r"""Number of SSL transactions on the Citrix ADC.
		"""
		try :
	...
	def sslbetot40bitrc4ciphers(self) :
		r"""Number of back-end RC4 40-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def ssltottlsv11handshakes(self) :
		r"""Number of SSL handshakes on TLSv1.1 on the Citrix ADC.
		"""
		try :
	...
	def sslbetotsessions(self) :
		r"""Number of back-end SSL sessions on the Citrix ADC.
		"""
		try :
	...
	def sslbetot64bitrc4ciphers(self) :
		r"""Number of back-end RC4 64-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	@property
	def sslbetotrsa4096keyexchanges(self) :
		r"""Number of back-end RSA 4096-bit key exchanges on the Citrix ADC.
		"""
		try :
			return self._sslbetotrsa4096keyexchanges
		except Exception as e:
			raise e
	...
	def sslbetottlsv1clientauthentications(self) :
		r"""Number of back-end TLSv1 client authentications on the Citrix ADC.
		"""
		try :
	...
	def sslbetotdh512keyexchanges(self) :
		r"""Number of back-end DH 512-bit key exchanges on the Citrix ADC.
		"""
		try :
	...
	def ssltotrsaauthorizations(self) :
		r"""Number of RSA authentications on the Citrix ADC.
		"""
		try :
	...
	def ssltotsslv2sessions(self) :
		r"""Number of SSLv2 sessions on the Citrix ADC.
		"""
		try :
	...
	def ssltotbkendtlsv11renego(self) :
		r"""Number of back-end TLSv1.1 session renegotiations on the Citrix ADC.
		"""
		try :
	...
	@property
	def sslbetotdh4096keyexchanges(self) :
		r"""Number of back-end DH 4096-bit key exchanges on the Citrix ADC.
		"""
		try :
			return self._sslbetotdh4096keyexchanges
		except Exception as e:
			raise e
	...
	@property
	def sslbedtlsv1clientauthenticationsrate(self) :
		r"""Rate (/s) counter for sslbetotdtlsv1clientauthentications.
		"""
		try :
			return self._sslbedtlsv1clientauthenticationsrate
		except Exception as e:
			raise e
	...
	def ssltotrsa4096keyexchanges(self) :
		r"""Number of RSA 4096-bit key exchanges on the Citrix ADC.
		"""
		try :
	...
	def sslbetotsslv3clientauthentications(self) :
		r"""Number of back-end SSLv3 client authentications on the Citrix ADC.
		"""
		try :
	...
	@property
	def ssltotdtlsv1clientauthentications(self) :
		r"""Number of client authentications done on DTLSv1.
		"""
		try :
			return self._ssltotdtlsv1clientauthentications
		except Exception as e:
			raise e
	...
	def ssltotmd5mac(self) :
		r"""Number of MD5 hashes on the Citrix ADC.
		"""
		try :
	...
	def sslbetotnullauthorizations(self) :
		r"""Number of back-end null authentications on the Citrix ADC.
		"""
		try :
	...
	def sslbetotrsa512keyexchanges(self) :
		r"""Number of back-end RSA 512-bit key exchanges on the Citrix ADC.
		"""
		try :
	...
	def ssltotecdsaauthorizations(self) :
		r"""Total number of times ECDSA authorization is used on the Citrix ADC.
		"""
		try :
	...
	def ssltot168bit3desciphers(self) :
		r"""Number of DES 168-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def ssltottlsv1handshakes(self) :
		r"""Number of SSL handshakes on TLSv1 on the Citrix ADC.
		"""
		try :
	...
	def sslbetot56bitdesciphers(self) :
		r"""Number of back-end DES 56-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def sslbetottlsv12clientauthentications(self) :
		r"""Number of back-end TLSv1.2 client authentications on the Citrix ADC.
		"""
		try :
	...
	def ssltottlsv12handshakes(self) :
		r"""Number of SSL handshakes on TLSv1.2 on the Citrix ADC.
		"""
		try :
	...
	def ssltotsessionhits(self) :
		r"""Number of SSL session reuse hits on the Citrix ADC.
		"""
		try :
	...
	@property
	def sslbkendcipheraesgcm256rate(self) :
		r"""Rate (/s) counter for ssltotbkendcipheraesgcm256.
		"""
		try :
			return self._sslbkendcipheraesgcm256rate
		except Exception as e:
			raise e
	...
	@property
	def ssltottlsv13handshakes(self) :
		r"""Number of SSL handshakes on TLSv1.3 on the Citrix ADC.
		"""
		try :
			return self._ssltottlsv13handshakes
		except Exception as e:
			raise e
	...
	def ssltottlsv12sessions(self) :
		r"""Number of TLSv1.2 sessions on the Citrix ADC.
		"""
		try :
	...
	@property
	def sslbedtlsv1handshakesrate(self) :
		r"""Rate (/s) counter for sslbetotdtlsv1handshakes.
		"""
		try :
			return self._sslbedtlsv1handshakesrate
		except Exception as e:
			raise e

	@property
	def sslbetotsha256mac(self) :
		r"""Number of back-end SHA256 hashes on the Citrix ADC.
		"""
		try :
	...
	def ssltotrsa2048keyexchanges(self) :
		r"""Number of RSA 2048-bit key exchanges on the Citrix ADC.
		"""
		try :
	...
	def sslbetotsessionmultiplexattemptfails(self) :
		r"""Number of back-end SSL session multiplex failures on the Citrix ADC.
		"""
		try :
	...
	def ssltotnullciphers(self) :
		r"""Number of Null cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	@property
	def sslbetotdtlsv1sessions(self) :
		r"""Number of back-end DTLSv1 sessions on the Citrix ADC.
		"""
		try :
			return self._sslbetotdtlsv1sessions
		except Exception as e:
			raise e

	@property
	def ssltottlsv13clientauthentications(self) :
		r"""Number of client authentications done on TLSv1.3.
		"""
		try :
			return self._ssltottlsv13clientauthentications
		except Exception as e:
			raise e
	...
	def sslbetotshamac(self) :
		r"""Number of back-end SHA hashes on the Citrix ADC.
		"""
		try :
	...
	def ssltotcipheraes128(self) :
		r"""Number of AES 128-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def sslbetottlsv11handshakes(self) :
		r"""Number of back-end TLSv1.1 handshakes on the Citrix ADC.
		"""
		try :
	...
	def ssltotbkendsslv3renego(self) :
		r"""Number of back-end SSLv3 session renegotiations on the Citrix ADC.
		"""
		try :
	...
	def ssltot128bitrc4ciphers(self) :
		r"""Number of RC4 128-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def sslbetotdssauthorizations(self) :
		r"""Number of back-end DSS authentications on the Citrix ADC.
		"""
		try :
	...
	def sslbetot56bitrc4ciphers(self) :
		r"""Number of back-end RC4 56-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def sslbetot40bitdesciphers(self) :
		r"""Number of back-end DES 40-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def sslbetottlsv12handshakes(self) :
		r"""Number of back-end TLSv1.2 handshakes on the Citrix ADC.
		"""
		try :
	...
	def ssltot128bitaesgcmciphers(self) :
		r"""Number of AEC-GCM 128-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def ssltotsslv2transactions(self) :
		r"""Number of SSLv2 transactions on the Citrix ADC.
		"""
		try :
	...
	def sslbetotecdsaauthorizations(self) :
		r"""Number of back-end ECDSA authentications on the Citrix ADC.
		"""
		try :
	...
	@property
	def ssltotdtlsv1transactions(self) :
		r"""Number of DTLSv1 transactions on the Citrix ADC.
		"""
		try :
			return self._ssltotdtlsv1transactions
		except Exception as e:
			raise e

	@property
	def sslbetottlsv11sessions(self) :
		r"""Number of back-end TLSv1.1 sessions on the Citrix ADC.
		"""
		try :
	...
	def sslcardssecondary(self) :
		r"""Number of secondary SSL crypto cards present on the Citrix ADC.
		"""
		try :
	...
	@property
	def ssltotbkenddtlsvlrenego(self) :
		r"""Number of back-end DTLSv1 session renegotiations on the Citrix ADC.
		"""
		try :
			return self._ssltotbkenddtlsvlrenego
		except Exception as e:
			raise e

	@property
	def ssltotdh4096keyexchanges(self) :
		r"""Number of Diffie-Helman 4096-bit key exchanges on the Citrix ADC.
		"""
		try :
			return self._ssltotdh4096keyexchanges
		except Exception as e:
			raise e

	@property
	def sslbetotdhauthorizations(self) :
		r"""Number of back-end DH authentications on the Citrix ADC.
		"""
		try :
	...
	def sslbetotmd5mac(self) :
		r"""Number of back-end MD5 hashes on the Citrix ADC.
		"""
		try :
	...
	def sslcursessions(self) :
		r"""Number of active SSL sessions on the Citrix ADC.
		"""
		try :
	...
	def sslbetot128bitrc2ciphers(self) :
		r"""Number of back-end RC2 128-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def ssltotdh1024keyexchanges(self) :
		r"""Number of Diffie-Helman 1024-bit key exchanges on the Citrix ADC.
		"""
		try :
	...
	def ssltotbkendsessionrenegotiate(self) :
		r"""Number of back-end SSL session renegotiations on the Citrix ADC.
		"""
		try :
	...
	@property
	def ssldtlsv1sessionsrate(self) :
		r"""Rate (/s) counter for ssltotdtlsv1sessions.
		"""
		try :
			return self._ssldtlsv1sessionsrate
		except Exception as e:
			raise e
	...
	@property
	def ssltotdtlsv1handshakes(self) :
		r"""Number of SSL handshakes on DTLSv1 on the Citrix ADC.
		"""
		try :
			return self._ssltotdtlsv1handshakes
		except Exception as e:
			raise e
	...
	def sslbetotsessionmultiplexattemptsuccess(self) :
		r"""Number of back-end SSL session multiplex successes on the Citrix ADC.
		"""
		try :
	...
	def sslbetotdh2048keyexchanges(self) :
		r"""Number of back-end DH 2048-bit key exchanges on the Citrix ADC.
		"""
		try :
	...
	def sslbetot168bit3desciphers(self) :
		r"""Number of back-end 3DES 168-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def ssltotrenegsessions(self) :
		r"""Number of SSL session renegotiations on the Citrix ADC.
		"""
		try :
	...
	@property
	def ssldtlsv1clientauthenticationsrate(self) :
		r"""Rate (/s) counter for ssltotdtlsv1clientauthentications.
		"""
		try :
			return self._ssldtlsv1clientauthenticationsrate
		except Exception as e:
			raise e
	...
	def sslbetotrsa2048keyexchanges(self) :
		r"""Number of back-end RSA 2048-bit key exchanges on the Citrix ADC.
		"""
		try :
	...
	def ssltot40bitrc2ciphers(self) :
		r"""Number of RC2 40-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	@property
	def ssltotbkendcipheraesgcm128(self) :
		r"""Back-end AES-GCM 128-bit cipher encryptions on the Citrix ADC.
		"""
		try :
			return self._ssltotbkendcipheraesgcm128
		except Exception as e:
			raise e

	@property
	def ssltot56bitrc2ciphers(self) :
		r"""Number of RC2 56-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def ssltot40bitdesciphers(self) :
		r"""Number of DES 40-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def ssltottlsv1transactions(self) :
		r"""Number of TLSv1 transactions on the Citrix ADC.
		"""
		try :
	...
	def ssltotrsa512keyexchanges(self) :
		r"""Number of RSA 512-bit key exchanges on the Citrix ADC.
		"""
		try :
	...
	def sslbetotnullciphers(self) :
		r"""Number of back-end null cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def sslbetotecdhecurve224(self) :
		r"""Number of back-end ECDHE 224 curve Key exchanges  on the Citrix ADC.
		"""
		try :
	...
	def ssltotbkendcipheraes128(self) :
		r"""Back-end AES 128-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	@property
	def sslbedh4096keyexchangesrate(self) :
		r"""Rate (/s) counter for sslbetotdh4096keyexchanges.
		"""
		try :
			return self._sslbedh4096keyexchangesrate
		except Exception as e:
			raise e
	...
	@property
	def sslbedtlsv1sessionsrate(self) :
		r"""Rate (/s) counter for sslbetotdtlsv1sessions.
		"""
		try :
			return self._sslbedtlsv1sessionsrate
		except Exception as e:
			raise e
	...
	def ssltotcipheraes256(self) :
		r"""Number of AES 256-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def ssltotsslv3transactions(self) :
		r"""Total number of SSLv3 transactions on the Citrix ADC.
		"""
		try :
	...
	def ssltotbkendtlsv12renego(self) :
		r"""Number of back-end TLSv1.2 session renegotiations on the Citrix ADC.
		"""
		try :
	...
	def ssltot128bitideaciphers(self) :
		r"""Number of IDEA 128-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	@property
	def ssltotdec(self) :
		r"""Number of bytes decrypted on the Citrix ADC.
		"""
		try :
	...
	@property
	def ssldtlsv1renegsessionsrate(self) :
		r"""Rate (/s) counter for ssltotdtlsv1renegsessions.
		"""
		try :
			return self._ssldtlsv1renegsessionsrate
		except Exception as e:
			raise e

	@property
	def ssltotsslserverinrecords(self) :
		r"""Number server in record on the Citrix ADC.
		"""
		try :
	...
	def sslbetot56bitrc2ciphers(self) :
		r"""Number of back-end RC2 56-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def sslbetotrsaauthorizations(self) :
		r"""Number of back-end RSA authentications on the Citrix ADC.
		"""
		try :
	...
	def sslbetottlsv11clientauthentications(self) :
		r"""Number of back-end TLSv1.1 client authentications on the Citrix ADC.
		"""
		try :
	...
	@property
	def ssldtlsv1transactionsrate(self) :
		r"""Rate (/s) counter for ssltotdtlsv1transactions.
		"""
		try :
			return self._ssldtlsv1transactionsrate
		except Exception as e:
			raise e

	@property
	def sslbetot40bitrc2ciphers(self) :
		r"""Number of back-end RC2 40-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def ssltot64bitrc4ciphers(self) :
		r"""Number of RC4 64-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def ssltot256bitaesgcmciphers(self) :
		r"""Number of AEC-GCM 256-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def ssltotdhauthorizations(self) :
		r"""Number of Diffie-Helman authentications on the Citrix ADC.
		"""
		try :
	...
	def ssltotsessionmiss(self) :
		r"""Number of SSL session reuse misses on the Citrix ADC.
		"""
		try :
	...
	def ssltotecdhe224keyexchanges(self) :
		r"""Number of 224 Elliptical Curve Diffie-Helman on the Citrix ADC.
		"""
		try :
	...
	@property
	def ssltottlsv13sessions(self) :
		r"""Number of TLSv1.3 sessions on the Citrix ADC.
		"""
		try :
			return self._ssltottlsv13sessions
		except Exception as e:
			raise e

	@property
	def ssltot56bitrc4ciphers(self) :
		r"""Number of RC4 56-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	@property
	def sslbersa4096keyexchangesrate(self) :
		r"""Rate (/s) counter for sslbetotrsa4096keyexchanges.
		"""
		try :
			return self._sslbersa4096keyexchangesrate
		except Exception as e:
			raise e

	@property
	def ssltotsslv3handshakes(self) :
		r"""Number of handshakes on SSLv3 on the Citrix ADC.
		"""
		try :
	...
	def ssltottlsv12transactions(self) :
		r"""Number of TLSv1.2 transactions on the Citrix ADC.
		"""
		try :
	...
	def ssltottlsv11sessions(self) :
		r"""Number of TLSv1.1 sessions on the Citrix ADC.
		"""
		try :
	...
	def ssltot56bitdesciphers(self) :
		r"""Number of DES 56-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	@property
	def ssltotbkendcipheraesgcm256(self) :
		r"""Back-end AES-GCM 256-bit cipher encryptions on the Citrix ADC .
		"""
		try :
			return self._ssltotbkendcipheraesgcm256
		except Exception as e:
			raise e
	...
	@property
	def ssltottlsv13transactions(self) :
		r"""Number of TLSv1.3 transactions on the Citrix ADC.
		"""
		try :
			return self._ssltottlsv13transactions
		except Exception as e:
			raise e
	...
	def sslbetotecdhecurve256(self) :
		r"""Number of back-end ECDHE 256 curve Key exchanges  on the Citrix ADC.
		"""
		try :
	...
	def ssltotdh512keyexchanges(self) :
		r"""Number of Diffie-Helman 512-bit key exchanges on the Citrix ADC.
		"""
		try :
	...
	@property
	def ssltotdtlsv1sessions(self) :
		r"""Number of DTLSv1 sessions on the Citrix ADC.
		"""
		try :
			return self._ssltotdtlsv1sessions
		except Exception as e:
			raise e

	@property
	def ssltlsv13sessionsrate(self) :
		r"""Rate (/s) counter for ssltottlsv13sessions.
		"""
		try :
			return self._ssltlsv13sessionsrate
		except Exception as e:
			raise e

	@property
	def ssltotecdhe384keyexchanges(self) :
		r"""Number of 384 Elliptical Curve Diffie-Helman on the Citrix ADC.
		"""
		try :
	...
	@property
	def ssltlsv13handshakesrate(self) :
		r"""Rate (/s) counter for ssltottlsv13handshakes.
		"""
		try :
			return self._ssltlsv13handshakesrate
		except Exception as e:
			raise e
	...
	def ssltotsslv2handshakes(self) :
		r"""Number of handshakes on SSLv2 on the Citrix ADC.
		"""
		try :
	...
	@property
	def ssldh4096keyexchangesrate(self) :
		r"""Rate (/s) counter for ssltotdh4096keyexchanges.
		"""
		try :
			return self._ssldh4096keyexchangesrate
		except Exception as e:
			raise e
	...
	@property
	def ssltotenc(self) :
		r"""Number of bytes encrypted on the Citrix ADC.
		"""
		try :
	...
	def sslbetotsslv3sessions(self) :
		r"""Number of back-end SSLv3 sessions on the Citrix ADC.
		"""
		try :
	...
	def ssltottlsv11transactions(self) :
		r"""Number of TLSv1.1 transactions on the Citrix ADC.
		"""
		try :
	...
	def sslbemaxmultiplexedsessions(self) :
		r"""Number of back-end SSL sessions reused on the Citrix ADC.
		"""
		try :
	...
	def sslbetotecdhecurve384(self) :
		r"""Number of back-end ECDHE 384 curve Key exchanges  on the Citrix ADC.
		"""
		try :
	...
	def ssltotsessions(self) :
		r"""Number of SSL sessions on the Citrix ADC.
		"""
		try :
	...
	def ssltot40bitrc4ciphers(self) :
		r"""Number of RC4 40-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def ssltotecdhe256keyexchanges(self) :
		r"""Number of 256 Elliptical Curve Diffie-Helman on the Citrix ADC.
		"""
		try :
	...
	def sslbetot128bitideaciphers(self) :
		r"""Number of back-end IDEA 128-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	@property
	def sslbkendcipheraesgcm128rate(self) :
		r"""Rate (/s) counter for ssltotbkendcipheraesgcm128.
		"""
		try :
			return self._sslbkendcipheraesgcm128rate
		except Exception as e:
			raise e
	...
	def ssltotbkendtlsvlrenego(self) :
		r"""Number of back-end TLSv1 session renegotiations on the Citrix ADC.
		"""
		try :
	...
	def sslbetotsslv3handshakes(self) :
		r"""Number of back-end SSLv3 handshakes on the Citrix ADC.
		"""
		try :
	...
	def ssltotsha384mac(self) :
		r"""Number of SHA384 hashes on the Citrix ADC.
		"""
		try :
	...
	@property
	def sslbetotdtlsv1clientauthentications(self) :
		r"""Number of back-end DTLSv1 client authentications on the Citrix ADC.
		"""
		try :
			return self._sslbetotdtlsv1clientauthentications
		except Exception as e:
			raise e

	@property
	def sslbetotsessionmultiplexattempts(self) :
		r"""Number of back-end SSL session multiplex attempts on the Citrix ADC.
		"""
		try :
	...
	@property
	def ssltlsv13transactionsrate(self) :
		r"""Rate (/s) counter for ssltottlsv13transactions.
		"""
		try :
			return self._ssltlsv13transactionsrate
		except Exception as e:
			raise e

	@property
	def ssltotdssauthorizations(self) :
		r"""Total number of times DSS authorization is used on the Citrix ADC.
		"""
		try :
	...
	def ssltotshamac(self) :
		r"""Number of SHA hashes on the Citrix ADC.
		"""
		try :
	...
	@property
	def ssltlsv13clientauthenticationsrate(self) :
		r"""Rate (/s) counter for ssltottlsv13clientauthentications.
		"""
		try :
			return self._ssltlsv13clientauthenticationsrate
		except Exception as e:
			raise e
	...
	def ssltotsha256mac(self) :
		r"""Number of SHA256 hashes on the Citrix ADC.
		"""
		try :
	...
	def ssltotrsa1024keyexchanges(self) :
		r"""Number of RSA 1024-bit key exchanges on the Citrix ADC.
		"""
		try :
	...
	def ssltotnullauthorizations(self) :
		r"""Number of Null authentications on the Citrix ADC.
		"""
		try :
	...
	def ssltotecdhe521keyexchanges(self) :
		r"""Number of 521 Elliptical Curve Diffie-Helman on the Citrix ADC.
		"""
		try :
	...
	@property
	def sslcards(self) :
		r"""Number of SSL crypto cards present on the Citrix ADC.
		"""
		try :
	...
	def sslbetot128bitrc4ciphers(self) :
		r"""Number of back-end RC4 128-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def ssltotsslv3sessions(self) :
		r"""Number of SSLv3 sessions on the Citrix ADC.
		"""
		try :
	...
	def ssltotdh2048keyexchanges(self) :
		r"""Number of Diffie-Helman 2048-bit key exchanges on the Citrix ADC.
		"""
		try :
	...
	def sslbetotdh1024keyexchanges(self) :
		r"""Number of back-end DH 1024-bit key exchanges on the Citrix ADC.
		"""
		try :
	...
	def ssltotnewsessions(self) :
		r"""Number of new SSL sessions created on the Citrix ADC.
		"""
		try :
	...
	def ssltottlsv1sessions(self) :
		r"""Number of TLSv1 sessions on the Citrix ADC.
		"""
		try :
	...
	def ssltot128bitrc2ciphers(self) :
		r"""Number of RC2 128-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def sslbetotrsa1024keyexchanges(self) :
		r"""Number of back-end RSA 1024-bit key exchanges on the Citrix ADC.
		"""
		try :
	...
	def sslbetottlsv1sessions(self) :
		r"""Number of back-end TLSv1 sessions on the Citrix ADC.
		"""
		try :
	...
	def ssltotbkendcipheraes256(self) :
		r"""Back-end AES 256-bit cipher encryptions on the Citrix ADC.
		"""
		try :
	...
	def sslbetottlsv12sessions(self) :
		r"""Number of back-end TLSv1.2 sessions on the Citrix ADC.
		"""
		try :
	...
	def sslbetotecdhecurve521(self) :
		r"""Number of back-end ECDHE 521 curve Key exchanges  on the Citrix ADC.
		"""
		try :
	...
	@property
	def sslbetotdtlsv1handshakes(self) :
		r"""Number of back-end DTLSv1 handshakes on the Citrix ADC.
		"""
		try :
			return self._sslbetotdtlsv1handshakes
		except Exception as e:
			raise e
