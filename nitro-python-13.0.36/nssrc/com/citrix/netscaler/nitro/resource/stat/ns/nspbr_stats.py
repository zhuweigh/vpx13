...
class nspbr_stats(base_resource) :
	...
	@property
	def name(self) :
		r"""Name of the PBR whose statistics you want the Citrix ADC to display.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	@name.setter
	def name(self, name) :
		r"""Name of the PBR whose statistics you want the Citrix ADC to display.
		"""
		try :
			self._name = name
		except Exception as e:
