...
class Interface_stats(base_resource) :
	r""" Statistics for interface resource.
	"""
	def __init__(self) :
		self._id = None
		...
		self._trunkpktsreceived = 0
		self._trunkpktsreceivedrate = 0
		self._trunkpktstransmitted = 0
		self._trunkpktstransmittedrate = 0
	...
	@property
	def errpkttx(self) :
		r"""Number of outbound packets dropped by the hardware on a specified interface since the Citrix ADC was started or the interface statistics were cleared. This could happen due to length (undersize or oversize) errors and lack of resources. This statistic is available only for: 
	...
	def nicrxstalls(self) :
		r"""Number of times the interface stalled, when receiving packets, since the Citrix ADC was started or the interface statistics were cleared. Receive (Rx) stalls are detected when the following conditions are met:
	...
	def nictotmulticastpkts(self) :
		r"""Number of multicast packets received by the specified interface since the Citrix ADC was started or the interface statistics were cleared.
		"""
		try :
	...
	def jumbopktstransmitted(self) :
		r"""Number of Jumbo packets transmitted on this interface by upper layer, with TSO enabled actual trasmission size could be non Jumbo.
		"""
		try :
	...
	def txbytesrate(self) :
		r"""Rate (/s) counter for tottxbytes.
		"""
		try :
	...
	@property
	def rxlacpdu(self) :
		r"""Number of Link Aggregation Control Protocol Data Units(LACPDUs) received by the specified interface since the Citrix ADC was started or the interface statistics were cleared.
		"""
		try :
	...
	def netscalerpktsrate(self) :
		r"""Rate (/s) counter for totnetscalerpkts.
		"""
		try :
	...
	@property
	def tottxpkts(self) :
		r"""Number of packets transmitted by an interface since the Citrix ADC was started or the interface statistics were cleared.
		"""
		try :
	...
	def macmovedrate(self) :
		r"""Rate (/s) counter for totmacmoved.
		"""
		try :
	...
	@property
	def errpktrx(self) :
		r"""Number of inbound packets dropped by the hardware on a specified interface once the Citrix ADC starts or the interface statistics are cleared. This happens due to following reasons:
	...
	def curlinkdowntime(self) :
		r"""Duration for which the link is DOWN. This statistic is reset when the state changes to UP.
		"""
		try :
	...
	@property
	def rxcrcerrorsrate(self) :
		r"""Rate (/s) counter for rxcrcerrors.
		"""
		try :
			return self._rxcrcerrorsrate
		except Exception as e:
			raise e

	@property
	def nicmulticastpktsrate(self) :
		r"""Rate (/s) counter for nictotmulticastpkts.
		"""
		try :
	...
	def rxbytesrate(self) :
		r"""Rate (/s) counter for totrxbytes.
		"""
		try :
	...
	def curlinkuptime(self) :
		r"""Duration for which the link is UP. This statistic is reset when the state changes to DOWN.
		"""
		try :
	...
	@property
	def tottxbytes(self) :
		r"""Number of bytes transmitted by an interface since the Citrix ADC was started or the interface statistics were cleared.
		"""
		try :
	...
	def errdroppedtxpktsrate(self) :
		r"""Rate (/s) counter for errdroppedtxpkts.
		"""
		try :
	...
	def nictxstalls(self) :
		r"""Number of times the interface stalled, when transmitting packets, since the Citrix ADC was started or the interface statistics were cleared. Transmit (Tx) stalls are detected when a packet posted for transmission is not transmitted in 4 seconds.
		"""
		try :
	...
	def totnetscalerpkts(self) :
		r"""Number of packets, destined to the Citrix ADC, received by an interface since the Citrix ADC was started or the interface statistics were cleared. The packets destined to Citrix ADC are those that have the same MAC address as that of an interface or a VMAC address owned by the Citrix ADC.
		"""
		try :
	...
	@property
	def trunkpktstransmittedrate(self) :
		r"""Rate (/s) counter for trunkpktstransmitted.
		"""
		try :
			return self._trunkpktstransmittedrate
		except Exception as e:
			raise e

	@property
	def jumbopktsreceivedrate(self) :
		r"""Rate (/s) counter for jumbopktsreceived.
		"""
		try :
	...
	@property
	def totrxbytes(self) :
		r"""Number of bytes received by an interface since the Citrix ADC was started or the interface statistics were cleared.
		"""
		try :
	...
	@property
	def trunkpktstransmitted(self) :
		r"""Number of Tagged Packets transmitted on this Trunk interface through Allowed VLan List.
		"""
		try :
			return self._trunkpktstransmitted
		except Exception as e:
			raise e

	@property
	def linkreinits(self) :
		r"""Number of times the link has been re-initialized. A re-initialization occurs due to link state change, configuration parameter change, or administrative reset operation.
		"""
		try :
	...
	def nicerrdisables(self) :
		r"""Number of times the specified interface is disabled by the Citrix ADC, due to continuous Receive (Rx) or Transmit (Tx) stalls, since the Citrix ADC was started or the interface statistics were cleared. The Citrix ADC disables an interface when one of the following conditions is met:
	...
	@property
	def txpktsrate(self) :
		r"""Rate (/s) counter for tottxpkts.
		"""
		try :
	...
	def jumbopktsreceived(self) :
		r"""Number of Jumbo Packets received on this interface.
		"""
		try :
	...
	@property
	def txlacpdu(self) :
		r"""Number of Link Aggregation Control Protocol Data Units(LACPDUs) transmitted by the specified interface since the Citrix ADC was started or the interface statistics were cleared.
		"""
		try :
	...
	def errdroppedrxpktsrate(self) :
		r"""Rate (/s) counter for errdroppedrxpkts.
		"""
		try :
	...
	def errnicmuted(self) :
		r"""Number of times the specified interface stopped transmitting and receiving packets due to MAC moves between ports.
		"""
		try :
	...
	def errdroppedtxpkts(self) :
		r"""Number of packets dropped in transmission by the specified interface due to one of the following reasons.
		(1) VLAN mismatch.
		(2) Oversized packets.
	...
	def nicerrifoutdiscardsrate(self) :
		r"""Rate (/s) counter for nicerrifoutdiscards.
		"""
		try :
	...
	def errifindiscardsrate(self) :
		r"""Rate (/s) counter for errifindiscards.
		"""
		try :
	...
	@property
	def trunkpktsreceivedrate(self) :
		r"""Rate (/s) counter for trunkpktsreceived.
		"""
		try :
			return self._trunkpktsreceivedrate
		except Exception as e:
			raise e

	@property
	def nicerrifoutdiscards(self) :
		r"""Number of error-free outbound packets discarded by the specified interface due to a lack of resources. This statistic is not available on:
	...
	def rxcrcerrors(self) :
		...
		"""
		try :
			return self._rxcrcerrors
		except Exception as e:
			raise e

	@property
	def errifindiscards(self) :
		r"""Number of error-free inbound packets discarded by the specified interface due to a lack of resources, for example, insufficient receive buffers.
		"""
		try :
	...
	def interfacealias(self) :
		r"""Alias Name for the Interface.
		"""
		try :
	...
	@property
	def totrxpkts(self) :
		r"""Number of packets received by an interface since the Citrix ADC was started or the interface statistics were cleared.
		"""
		try :
	...
	def totmacmoved(self) :
		r"""Number of MAC moves between ports. If a high rate of MAC moves is observed, it is likely that there is a bridge loop between two interfaces.
		"""
		try :
	...
	@property
	def rxpktsrate(self) :
		r"""Rate (/s) counter for totrxpkts.
		"""
		try :
	...
	def jumbopktstransmittedrate(self) :
		r"""Rate (/s) counter for jumbopktstransmitted.
		"""
		try :
	...
	def errlinkhangs(self) :
		r"""Number of times the specified interface detected hangs in the transmit and receive paths since the Citrix ADC was started or the interface statistics were cleared.
		"""
		try :
	...
	def nicstsstalls(self) :
		r"""Number of times the status updates for a specified interface were stalled since the Citrix ADC was started or the interface statistics were cleared. A status stall is detected when the status of the interface is not updated by the NIC hardware within 0.8 seconds of the last update.
		"""
		try :
	...
	@property
	def trunkpktsreceived(self) :
		r"""Number of Tagged Packets received on this Trunk interface through Allowed VLan List.
		"""
		try :
			return self._trunkpktsreceived
		except Exception as e:
			raise e
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all Interface_stats resources that are configured on netscaler.
