...
class snmp_stats(base_resource) :
	...
	def snmptotresponses(self) :
		r"""SNMP Get-Response PDUs that have been generated by the Citrix ADC.
		"""
		try :
	...
	def snmptottraps(self) :
		r"""SNMP Trap PDUs that have been generated by the Citrix ADC.
		"""
		try :
	...
	def snmptotbadcommname(self) :
		r"""SNMP messages received, which used an SNMP community name not known to the Citrix ADC.
		"""
		try :
	...
	def snmpunknownengineids(self) :
		r"""SNMP packets that were dropped because they referenced an SNMP engine ID that was not known to the Citrix ADC.
		"""
		try :
