...
class feo_stats(base_resource) :
	def __init__(self) :
		...
		self._totalcssmin = 0
		self._cssminrate = 0
		self._totalimgstojxr = 0
		self._imgstojxrrate = 0
		self._totalimgstowebp = 0
		self._imgstowebprate = 0
	...
	def totaljsmoved(self) :
		r"""The total number of JS moved to end.
		"""
		try :
	...
	def totalimgslazyloaded(self) :
		r"""Total number of images modified for lazy loading.
		"""
		try :
	...
	def htmlcommentsremovedrate(self) :
		r"""Rate (/s) counter for htmlcommentsremoved.
		"""
		try :
	...
	def urireplacedrate(self) :
		r"""Rate (/s) counter for toturireplaced.
		"""
		try :
	...
	def cssmovedrate(self) :
		r"""Rate (/s) counter for totalcssmoved.
		"""
		try :
	...
	def htmlcommentsremoved(self) :
		r"""The total number of HTML comments removed.
		"""
		try :
	...
	def jsmovedrate(self) :
		r"""Rate (/s) counter for totaljsmoved.
		"""
		try :
	...
	def totalimgsinlinedincss(self) :
		r"""Total number of images inlined in CSS.
		"""
		try :
	...
	def totalinlinedcss(self) :
		r"""Total number of inlined CSS files.
		"""
		try :
	...
	def inlinedimgsrate(self) :
		r"""Rate (/s) counter for totalinlinedimgs.
		"""
		try :
	...
	def toturireplaced(self) :
		r"""Total number of URI replaced.
		"""
		try :
	...
	@property
	def imgstowebprate(self) :
		r"""Rate (/s) counter for totalimgstowebp.
		"""
		try :
			return self._imgstowebprate
		except Exception as e:
			raise e

	@property
	def totalinlinedjs(self) :
		r"""Total number of inlined JS files.
		"""
		try :
	...
	def totalcssmoved(self) :
		r"""The total number of CSS moved to head.
		"""
		try :
	...
	def csscombinedrate(self) :
		r"""Rate (/s) counter for totalcsscombined.
		"""
		try :
	...
	def imgslazyloadedrate(self) :
		r"""Rate (/s) counter for totalimgslazyloaded.
		"""
		try :
	...
	@property
	def totaljsmin(self) :
		r"""The total number of JS files minified.
		"""
		try :
	...
	def optcacheobjects(self) :
		r"""Total number of optimized cache objects ready to be served.
		"""
		try :
	...
	def totalgifstopng(self) :
		r"""The total number of images converted from GIF to PNG format.
		"""
		try :
	...
	def totalimgsresized(self) :
		r"""The total number of images resized to dimensions in the <img> tag.
		"""
		try :
	...
	def imgsinlinedincssrate(self) :
		r"""Rate (/s) counter for totalimgsinlinedincss.
		"""
		try :
	...
	def inlinedcssrate(self) :
		r"""Rate (/s) counter for totalinlinedcss.
		"""
		try :
	...
	@property
	def totalimgstowebp(self) :
		r"""The total number of images converted to WEBP format.
		"""
		try :
			return self._totalimgstowebp
		except Exception as e:
			raise e

	@property
	def inlinedjsrate(self) :
		r"""Rate (/s) counter for totalinlinedjs.
		"""
		try :
	...
	def origcacheobjectsrate(self) :
		r"""Rate (/s) counter for origcacheobjects.
		"""
		try :
	...
	@property
	def cssminrate(self) :
		r"""Rate (/s) counter for totalcssmin.
		"""
		try :
	...
	def totalimgsdomainsharded(self) :
		r"""Total no of images whose domain has been set from shards.
		"""
		try :
	...
	def imgsdomainshardedrate(self) :
		r"""Rate (/s) counter for totalimgsdomainsharded.
		"""
		try :
	...
	def gifstopngrate(self) :
		r"""Rate (/s) counter for totalgifstopng.
		"""
		try :
	...
	def importtolinkrate(self) :
		r"""Rate (/s) counter for totalimporttolink.
		"""
		try :
	...
	def totalcsscombined(self) :
		r"""The total number of CSS combined.
		"""
		try :
	...
	@property
	def totalimgstojxr(self) :
		r"""The total number of images converted to JPEGXR format.
		"""
		try :
			return self._totalimgstojxr
		except Exception as e:
			raise e

	@property
	def imgsresizedrate(self) :
		r"""Rate (/s) counter for totalimgsresized.
		"""
		try :
	...
	def optcacheobjectsrate(self) :
		r"""Rate (/s) counter for optcacheobjects.
		"""
		try :
	...
	def totaljpegsoptimized(self) :
		r"""The total number of JPEG format images optimized.
		"""
		try :
	...
	def totalcacheextended(self) :
		r"""The total number of objects cache extended.
		"""
		try :
	...
	def origcacheobjects(self) :
		r"""Total number of original cache objects ready to be served.
		"""
		try :
	...
	@property
	def jsminrate(self) :
		r"""Rate (/s) counter for totaljsmin.
		"""
		try :
	...
	def jpegsoptimizedrate(self) :
		r"""Rate (/s) counter for totaljpegsoptimized.
		"""
		try :
	...
	@property
	def imgstojxrrate(self) :
		r"""Rate (/s) counter for totalimgstojxr.
		"""
		try :
			return self._imgstojxrrate
		except Exception as e:
			raise e

	@property
	def datasavingsrate(self) :
		r"""Rate (/s) counter for totaldatasavings.
		"""
		try :
	...
	def cacheextendedrate(self) :
		r"""Rate (/s) counter for totalcacheextended.
		"""
		try :
	...
	def totalcssmin(self) :
		r"""The total number of CSS files minified.
		"""
		try :
	...
	def totalinlinedimgs(self) :
		r"""Total number of inlined images in HTML.
		"""
		try :
	...
	def totalimporttolink(self) :
		r"""The total number of CSS imports converted to links.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all feo_stats resources that are configured on netscaler.
