...
class protocolhttp_stats(base_resource) :
	r""" Statistics for HTTP resource.
	"""
	def __init__(self) :
	...
	def httptotclenresponses(self) :
		r"""Total number of HTTP responses sent in which the Content-length field of the HTTP header has been set. Content-length specifies the length of the content, in bytes, in the associated HTTP body.
		"""
		try :
	...
	def httperrnoreusemultipart(self) :
		r"""Total number of HTTP multi-part responses sent. In multi-part responses, one or more entities are encapsulated within the body of a single message.
		"""
		try :
	...
	def spdyv3streamsrate(self) :
		r"""Rate (/s) counter for spdyv3totstreams.
		"""
		try :
	...
	def httprxrequestbytesrate(self) :
		r"""Rate (/s) counter for httptotrxrequestbytes.
		"""
		try :
	...
	def httptotrxresponsebytes(self) :
		r"""Total number of bytes of HTTP response data received.
		"""
		try :
	...
	def httperrincompleterequests(self) :
		r"""Total number of HTTP requests received in which the header spans more than one packet.
		"""
		try :
	...
	def httptot10requests(self) :
		r"""Total number of HTTP/1.0 requests received.
		"""
		try :
	...
	def httptotgets(self) :
		r"""Total number of HTTP requests received with the GET method.
		"""
		try :
	...
	def httperrlargecontent(self) :
		r"""Total number of requests and responses received with large body.
		"""
		try :
	...
	def http10responsesrate(self) :
		r"""Rate (/s) counter for httptot10responses.
		"""
		try :
	...
	def httperrserverbusy(self) :
		r"""Total number of HTTP error responses received. Some of the error responses are: 
	...
	def httptxrequestbytesrate(self) :
		r"""Rate (/s) counter for httptottxrequestbytes.
		"""
		try :
	...
	def httptotposts(self) :
		r"""Total number of HTTP requests received with the POST method.
		"""
		try :
	...
	def httptotclenrequests(self) :
		r"""Total number of HTTP requests in which the Content-length field of the HTTP header has been set. Content-length specifies the length of the content, in bytes, in the associated HTTP body.
		"""
		try :
	...
	def httprxresponsebytesrate(self) :
		r"""Rate (/s) counter for httptotrxresponsebytes.
		"""
		try :
	...
	def spdyv2streamsrate(self) :
		r"""Rate (/s) counter for spdyv2totstreams.
		"""
		try :
	...
	def httperrincompleteresponsesrate(self) :
		r"""Rate (/s) counter for httperrincompleteresponses.
		"""
		try :
	...
	def httpnoclenchunkresponsesrate(self) :
		r"""Rate (/s) counter for httptotnoclenchunkresponses.
		"""
		try :
	...
	def httpchunkedrequestsrate(self) :
		r"""Rate (/s) counter for httptotchunkedrequests.
		"""
		try :
	...
	def http11responsesrate(self) :
		r"""Rate (/s) counter for httptot11responses.
		"""
		try :
	...
	def httptotrequests(self) :
		r"""Total number of HTTP requests received.
		"""
		try :
	...
	def httptotresponses(self) :
		r"""Total number of HTTP responses sent.
		"""
		try :
	...
	def httperrincompleteresponses(self) :
		r"""Total number of HTTP responses received in which the header spans more than one packet.
		"""
		try :
	...
	def spdytotstreams(self) :
		r"""Total number of requests received over SPDYv2 and SPDYv3.
		"""
		try :
	...
	def httptottxrequestbytes(self) :
		r"""Total number of bytes of HTTP request data transmitted.
		"""
		try :
	...
	def httperrserverbusyrate(self) :
		r"""Rate (/s) counter for httperrserverbusy.
		"""
		try :
	...
	def http11requestsrate(self) :
		r"""Rate (/s) counter for httptot11requests.
		"""
		try :
	...
	def spdystreamsrate(self) :
		r"""Rate (/s) counter for spdytotstreams.
		"""
		try :
	...
	def httptxresponsebytesrate(self) :
		r"""Rate (/s) counter for httptottxresponsebytes.
		"""
		try :
	...
	def httptohersrate(self) :
		r"""Rate (/s) counter for httptotothers.
		"""
		try :
	...
	def httpchunkedresponsesrate(self) :
		r"""Rate (/s) counter for httptotchunkedresponses.
		"""
		try :
	...
	def httptot11responses(self) :
		r"""Total number of HTTP/1.1 responses sent.
		"""
		try :
	...
	def http10requestsrate(self) :
		r"""Rate (/s) counter for httptot10requests.
		"""
		try :
	...
	def httprequestsrate(self) :
		r"""Rate (/s) counter for httptotrequests.
		"""
		try :
	...
	def httpresponsesrate(self) :
		r"""Rate (/s) counter for httptotresponses.
		"""
		try :
	...
	def httptot10responses(self) :
		r"""Total number of HTTP/1.0 responses sent.
		"""
		try :
	...
	def httptotnoclenchunkresponses(self) :
		r"""Total number of FIN-terminated responses sent. In FIN-terminated responses, the server finishes sending the data and closes the connection.
		"""
		try :
	...
	def httperrlargechunk(self) :
		r"""Total number of requests received with large chunk size, in which the Transfer-Encoding field of the HTTP header has been set to chunked.
		"""
		try :
	...
	def httperrnoreusemultipartrate(self) :
		r"""Rate (/s) counter for httperrnoreusemultipart.
		"""
		try :
	...
	def spdyv3totstreams(self) :
		r"""Total number of requests received over SPDYv3.
		"""
		try :
	...
	def httperrincompleteheaders(self) :
		r"""Total number of HTTP requests and responses received in which the HTTP header spans more than one packet.
		"""
		try :
	...
	def httptot11requests(self) :
		r"""Total number of HTTP/1.1 requests received.
		"""
		try :
	...
	def httppostsrate(self) :
		r"""Rate (/s) counter for httptotposts.
		"""
		try :
	...
	def httpgetsrate(self) :
		r"""Rate (/s) counter for httptotgets.
		"""
		try :
	...
	def httpclenresponsesrate(self) :
		r"""Rate (/s) counter for httptotclenresponses.
		"""
		try :
	...
	def httperrlargectlen(self) :
		r"""Total number of requests received with large content, in which the Content-length field of the HTTP header has been set. Content-length specifies the length of the content, in bytes, in the associated HTTP body.
		"""
		try :
	...
	def httptottxresponsebytes(self) :
		r"""Total number of bytes of HTTP response data transmitted.
		"""
		try :
	...
	def spdyv2totstreams(self) :
		r"""Total number of requests received over SPDYv2.
		"""
		try :
	...
	def httptotchunkedrequests(self) :
		r"""Total number of HTTP requests in which the Transfer-Encoding field of the HTTP header has been set to chunked.
		"""
		try :
	...
	def httperrincompleterequestsrate(self) :
		r"""Rate (/s) counter for httperrincompleterequests.
		"""
		try :
	...
	def httpclenrequestsrate(self) :
		r"""Rate (/s) counter for httptotclenrequests.
		"""
		try :
	...
	def httptotrxrequestbytes(self) :
		r"""Total number of bytes of HTTP request data received.
		"""
		try :
	...
	def httptotothers(self) :
		r"""Total number of HTTP requests received with methods other than GET and POST. Some of the other well-defined HTTP methods are HEAD, PUT, DELETE, OPTIONS, and TRACE. User-defined methods are also allowed.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all protocolhttp_stats resources that are configured on netscaler.
