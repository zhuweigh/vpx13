...
class lldp_stats(base_resource) :
	...
	@property
	def ifnum(self) :
		r"""LLDP Statistics per interfaces.
		"""
		try :
			return self._ifnum
	...
	def rxporttlvsdiscardedtotal(self) :
		r"""Total discarded LLDP packets.
		"""
		try :
	...
	def rxportframeserrors(self) :
		r"""Total errors in LLDP packets.
		"""
		try :
	...
	def rxportframeserrorsrate(self) :
		r"""Rate (/s) counter for rxportframeserrors.
		"""
		try :
	...
	def txportbytestotal(self) :
		r"""Total LLDP bytes transmitted.
		"""
		try :
	...
	def txportframestotal(self) :
		r"""Total LLDP Packets transmitted.
		"""
		try :
	...
	def rxportbytesrate(self) :
		r"""Rate (/s) counter for rxportbytestotal.
		"""
		try :
	...
	def rxporttlvsdiscardedrate(self) :
		r"""Rate (/s) counter for rxporttlvsdiscardedtotal.
		"""
		try :
	...
	def txportbytesrate(self) :
		r"""Rate (/s) counter for txportbytestotal.
		"""
		try :
	...
	def rxporttlvsunrecognizedrate(self) :
		r"""Rate (/s) counter for rxporttlvsunrecognizedtotal.
		"""
		try :
	...
	def rxportframesrate(self) :
		r"""Rate (/s) counter for rxportframestotal.
		"""
		try :
	...
	def txportframesrate(self) :
		r"""Rate (/s) counter for txportframestotal.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all lldp_stats resources that are configured on netscaler.
