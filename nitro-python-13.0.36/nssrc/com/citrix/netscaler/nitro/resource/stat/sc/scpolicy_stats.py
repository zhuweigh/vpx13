...
class scpolicy_stats(base_resource) :
	r""" Statistics for SureConnect policy resource.
	"""
	def __init__(self) :
		self._name = None
	...
	@property
	def name(self) :
		r"""Name of the policy about which to display statistics. To display statistics about all SureConnect policies, do not set this parameter.<br/>Minimum length =  1<br/>Maximum length =  31.
		"""
		try :
			return self._name
	...
	@name.setter
	def name(self, name) :
		r"""Name of the policy about which to display statistics. To display statistics about all SureConnect policies, do not set this parameter.
		"""
		try :
			self._name = name
		except Exception as e:
	...
	def sctotalresponsesreceived(self) :
		r"""Total number of server responses received by this SureConnect policy.
		"""
		try :
	...
	def sccurrentwaitingtime(self) :
		r"""Value of the currently estimated waiting time in seconds for the configured URL.
		"""
		try :
	...
	def clienttransactionrate(self) :
		r"""Rate (/s) counter for totclienttransaction.
		"""
		try :
	...
	def sccurrentwaitingtimerate(self) :
		r"""Rate (/s) counter for sccurrentwaitingtime.
		"""
		try :
	...
	def sccurrentwaitingclients(self) :
		r"""Current number of SureConnect priority clients that are waiting for a server connection.
		"""
		try :
	...
	def sctotalrequestsreceived(self) :
		r"""Total number of requests received by this SureConnect policy.
		"""
		try :
	...
	def screquestsreceivedrate(self) :
		r"""Rate (/s) counter for sctotalrequestsreceived.
		"""
		try :
	...
	def scresponsebytesrate(self) :
		r"""Rate (/s) counter for sctotalresponsebytes.
		"""
		try :
	...
	def screquestbytesrate(self) :
		r"""Rate (/s) counter for sctotalrequestbytes.
		"""
		try :
	...
	def sctotalresponsebytes(self) :
		r"""Total number of response bytes received by this SureConnect policy.
		"""
		try :
	...
	def scserverconnectionsrate(self) :
		r"""Rate (/s) counter for sctotalserverconnections.
		"""
		try :
	...
	def sctotalservertransactions(self) :
		r"""Number of 200 OK responses received from the web server by this SureConnect policy.
		"""
		try :
	...
	def sccurrentwaitingclientsrate(self) :
		r"""Rate (/s) counter for sccurrentwaitingclients.
		"""
		try :
	...
	def scaverageclientttlb(self) :
		r"""Average value of the client Time-To-Last-Byte in seconds for this SureConnect policy.
		"""
		try :
	...
	def avgservertransactiontime(self) :
		r"""Average server transaction time in seconds for this SureConnect Policy.
		"""
		try :
	...
	def scphysicalserviceip(self) :
		r"""IP address of the service in dotted notation for which these statistics are maintained.
		"""
		try :
	...
	def sccurrentclientconnectionsrate(self) :
		r"""Rate (/s) counter for sccurrentclientconnections.
		"""
		try :
	...
	def sccurrentclientconnections(self) :
		r"""Number of clients currently  allowed a server connection by this SureConnect policy.
		"""
		try :
	...
	def openconnrate(self) :
		r"""Rate (/s) counter for totopenconn.
		"""
		try :
	...
	def scclientconnectionsrate(self) :
		r"""Rate (/s) counter for sctotalclientconnections.
		"""
		try :
	...
	def scaverageclientttlbrate(self) :
		r"""Rate (/s) counter for scaverageclientttlb.
		"""
		try :
	...
	def totclienttransaction(self) :
		r"""Total number of client transactions processed by this SureConnect policy.
		"""
		try :
	...
	def scservertransactionsrate(self) :
		r"""Rate (/s) counter for sctotalservertransactions.
		"""
		try :
	...
	def sctotalclientconnections(self) :
		r"""Total number of clients that were allowed a server connection by this SureConnect policy.
		"""
		try :
	...
	def scphysicalserviceport(self) :
		r"""Port of the service for which these statistics are maintained.
		"""
		try :
	...
	def totopenconn(self) :
		r"""Current number of open connections to the servers matching this policy.
		"""
		try :
	...
	def avgservertransactiontimerate(self) :
		r"""Rate (/s) counter for avgservertransactiontime.
		"""
		try :
	...
	def scresponsesreceivedrate(self) :
		r"""Rate (/s) counter for sctotalresponsesreceived.
		"""
		try :
	...
	def sctotalrequestbytes(self) :
		r"""Total number of request bytes received by this SureConnect policy.
		"""
		try :
	...
	def sctotalserverconnections(self) :
		r"""Total number of server connections that were established through this SureConnect policy.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all scpolicy_stats resources that are configured on netscaler.
