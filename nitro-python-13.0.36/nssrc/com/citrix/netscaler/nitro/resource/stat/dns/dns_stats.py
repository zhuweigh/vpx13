...
class dns_stats(base_resource) :
	def __init__(self) :
		...
		self._dnscurcachesize = 0
		self._dnscurnegcachesize = 0
		self._dnstotjumboqueries = 0
		self._dnsjumboqueriesrate = 0
		self._dnstotjumboanswers = 0
		self._dnsjumboanswersrate = 0
		self._dnstotjumboserverresponses = 0
		self._dnsjumboserverresponsesrate = 0
	...
	def dnstotcnameresponse(self) :
		r"""Total number of CNAME responses received.
		"""
		try :
	...
	@property
	def dnstotjumboserverresponses(self) :
		r"""Total number of Jumbo DNS responses received over UDP.
		"""
		try :
			return self._dnstotjumboserverresponses
		except Exception as e:
			raise e

	@property
	def dnsaresponserate(self) :
		r"""Rate (/s) counter for dnstotaresponse.
		"""
		try :
	...
	def dns64rwanswersrate(self) :
		r"""Rate (/s) counter for dns64totrwanswers.
		"""
		try :
	...
	def dnstotaaaarecupdate(self) :
		r"""Total number of AAAA record updates.
		"""
		try :
	...
	def dnstotptrrecupdate(self) :
		r"""Total number of PTR record updates.
		"""
		try :
	...
	def dns64nodataresprate(self) :
		r"""Rate (/s) counter for dns64totnodataresp.
		"""
		try :
	...
	def dnserrnullattack(self) :
		r"""Total number of queries received where all the counts are 0.
		"""
		try :
	...
	def dnstotunsupportedqueries(self) :
		r"""Total number of requests for which query type requested was unsupported.
		"""
		try :
	...
	@property
	def dnstotjumboqueries(self) :
		r"""Total number of Jumbo DNS queries received over UDP.
		"""
		try :
			return self._dnstotjumboqueries
		except Exception as e:
			raise e

	@property
	def dnstotauthnonames(self) :
		r"""Number of queries for which no record was found.
		"""
		try :
	...
	def dnstotmxrecupdate(self) :
		r"""Total number of MX record updates.
		"""
		try :
	...
	def dnstotanyqueries(self) :
		r"""Total number of ANY queries received.
		"""
		try :
	...
	def dns64totrwanswers(self) :
		r"""Total number of DNS64 answers served after rewriting the response.
		"""
		try :
	...
	def dnstotstrayanswer(self) :
		r"""Total number of stray answers.
		"""
		try :
	...
	def dnstotptrrecfailed(self) :
		r"""Total number of times PTR record lookup failed.
		"""
		try :
	...
	def dns64activepolicies(self) :
		r"""Total number of active dns64 policies.
		"""
		try :
	...
	def dnstotcnamerecupdate(self) :
		r"""Total number of CNAME record updates.
		"""
		try :
	...
	def dnstotcacheentriesflush(self) :
		r"""Total number of cache entries flushed.
		"""
		try :
	...
	def dnsaaaaresponserate(self) :
		r"""Rate (/s) counter for dnstotaaaaresponse.
		"""
		try :
	...
	def dnsaaaarecqueriesrate(self) :
		r"""Rate (/s) counter for dnstotaaaarecqueries.
		"""
		try :
	...
	def dnstotmxrecqueries(self) :
		r"""Total number of MX queries received.
		"""
		try :
	...
	def dnstotsoarecqueries(self) :
		r"""Total number of SOA queries received.
		"""
		try :
	...
	def dnstotinvalidqueryformat(self) :
		r"""Total number of queries whose format was invalid.
		"""
		try :
	...
	def dnstotsrvrecfailed(self) :
		r"""Total number of times SRV record lookup failed.
		"""
		try :
	...
	def dnsarecqueriesrate(self) :
		r"""Rate (/s) counter for dnstotarecqueries.
		"""
		try :
	...
	def dnstotsoaresponse(self) :
		r"""Total number of SOA responses received.
		"""
		try :
	...
	def dnstotserverresponse(self) :
		r"""Total number of Server responses received.
		"""
		try :
	...
	def dnsanyqueriesrate(self) :
		r"""Rate (/s) counter for dnstotanyqueries.
		"""
		try :
	...
	def dnscurauthentries(self) :
		r"""Total number of authoritative entries.
		"""
		try :
	...
	def dnstotmxresponse(self) :
		r"""Total number of MX responses received.
		"""
		try :
	...
	def dnstotptrrecqueries(self) :
		r"""Total number of PTR queries received.
		"""
		try :
	...
	def dnstotunsupportedqueryclass(self) :
		r"""Total number of queries for which query class was unsupported.
		"""
		try :
	...
	def dnsptrresponserate(self) :
		r"""Rate (/s) counter for dnstotptrresponse.
		"""
		try :
	...
	def dnssoarecqueriesrate(self) :
		r"""Rate (/s) counter for dnstotsoarecqueries.
		"""
		try :
	...
	def dns64totgslbanswers(self) :
		r"""Total number of DNS64 queries served.
		"""
		try :
	...
	def dns64answersrate(self) :
		r"""Rate (/s) counter for dns64totanswers.
		"""
		try :
	...
	def dns64totqueries(self) :
		r"""Total number of DNS64 queries recieved.
		"""
		try :
	...
	def dnsptrrecqueriesrate(self) :
		r"""Rate (/s) counter for dnstotptrrecqueries.
		"""
		try :
	...
	def dnstotsoarecfailed(self) :
		r"""Total number of times SOA record lookup failed.
		"""
		try :
	...
	def dns64tottcpqueries(self) :
		r"""Total number of dns64 queries over TCP.
		"""
		try :
	...
	def dnstotaaaarecqueries(self) :
		r"""Total number of AAAA queries received.
		"""
		try :
	...
	def dns64responsesrate(self) :
		r"""Rate (/s) counter for dns64totresponses.
		"""
		try :
	...
	def dnstotmxrecfailed(self) :
		r"""Total number of times MX record lookup failed.
		"""
		try :
	...
	def dns64tottcanswers(self) :
		r"""Total number of Answers served with TC bit set in DNS64 context.
		"""
		try :
	...
	def dnstotaaaarecfailed(self) :
		r"""Total number of times AAAA record lookup failed.
		"""
		try :
	...
	def dnssrvresponserate(self) :
		r"""Rate (/s) counter for dnstotsrvresponse.
		"""
		try :
	...
	def dnsnsrecqueriesrate(self) :
		r"""Rate (/s) counter for dnstotnsrecqueries.
		"""
		try :
	...
	def dnstotserverquery(self) :
		r"""Total number of Server queries sent.
		"""
		try :
	...
	def dnssoaresponserate(self) :
		r"""Rate (/s) counter for dnstotsoaresponse.
		"""
		try :
	...
	def dnstotmultiquery(self) :
		r"""Total number of Multi Query request received.
		"""
		try :
	...
	def dnscuraaaarecord(self) :
		r"""Total number of AAAA records.
		"""
		try :
	...
	def dnsqueriesrate(self) :
		r"""Rate (/s) counter for dnstotqueries.
		"""
		try :
	...
	def dns64gslbqueriesrate(self) :
		r"""Rate (/s) counter for dns64totgslbqueries.
		"""
		try :
	...
	def dnsanyresponserate(self) :
		r"""Rate (/s) counter for dnstotanyresponse.
		"""
		try :
	...
	def dnsanswersrate(self) :
		r"""Rate (/s) counter for dnstotanswers.
		"""
		try :
	...
	def dnstotarecupdate(self) :
		r"""Total number of A record updates.
		"""
		try :
	...
	def dnscnameresponserate(self) :
		r"""Rate (/s) counter for dnstotcnameresponse.
		"""
		try :
	...
	def dnstotothererrors(self) :
		r"""Total number of other errors. .
		"""
		try :
	...
	def dnstotnsrecfailed(self) :
		r"""Total number of times NS record lookup failed.
		"""
		try :
	...
	def dnscurcnamerecord(self) :
		r"""Total number of CNAME records.
		"""
		try :
	...
	def dnscurnoauthentries(self) :
		r"""Total number of non-authoritative entries.
		"""
		try :
	...
	def dnstotresponsebadlen(self) :
		r"""Number of DNS responses received with invalid resoure data length.
		"""
		try :
	...
	def dns64totaaaabypass(self) :
		r"""Total number of times AAAA query has been bypassed in DNS64 trnsaction.
		"""
		try :
	...
	def dns64tcpqueriesrate(self) :
		r"""Rate (/s) counter for dns64tottcpqueries.
		"""
		try :
	...
	def dnstotaaaaresponse(self) :
		r"""Total number of AAAA responses received.
		"""
		try :
	...
	def dns64gslbanswersrate(self) :
		r"""Rate (/s) counter for dns64totgslbanswers.
		"""
		try :
	...
	def dnstotunsupportedresponsetype(self) :
		r"""Total number of responses for which response type requested was unsupported.
		"""
		try :
	...
	def dns64totsvraqueries(self) :
		r"""Total number of Queries sent by DNS64 module to backend.
		"""
		try :
	...
	def dns64totresponses(self) :
		r"""Total number of responses recieved from backend in DNS64 context.
		"""
		try :
	...
	def dnstotnsrecqueries(self) :
		r"""Total number of NS queries received.
		"""
		try :
	...
	def dns64totanswers(self) :
		r"""Total number of DNS64 answers served.
		"""
		try :
	...
	def dnstotanyresponse(self) :
		r"""Total number of ANY responses received.
		"""
		try :
	...
	def dnstotanyrecfailed(self) :
		r"""Total number of times ANY query lookup failed.
		"""
		try :
	...
	def dns64aaaabypassrate(self) :
		r"""Rate (/s) counter for dns64totaaaabypass.
		"""
		try :
	...
	def dnstotnsresponse(self) :
		r"""Total number of NS responses received.
		"""
		try :
	...
	@property
	def dnscurcachesize(self) :
		r"""Current DNS cache size.
		"""
		try :
			return self._dnscurcachesize
		except Exception as e:
			raise e

	@property
	def dnscurnegcachesize(self) :
		r"""Current Negative DNS cache size.
		"""
		try :
			return self._dnscurnegcachesize
		except Exception as e:
			raise e

	@property
	def dnssrvrecqueriesrate(self) :
		r"""Rate (/s) counter for dnstotsrvrecqueries.
		"""
		try :
	...
	@property
	def dnsjumboqueriesrate(self) :
		r"""Rate (/s) counter for dnstotjumboqueries.
		"""
		try :
			return self._dnsjumboqueriesrate
		except Exception as e:
			raise e

	@property
	def dnstotnsrecupdate(self) :
		r"""Total number of NS record updates.
		"""
		try :
	...
	def dnstotcnamerecqueries(self) :
		r"""Total number of CNAME queries received.
		"""
		try :
	...
	def dnstotmultiquerydisableerror(self) :
		r"""Total number of times a multi query was disabled and received a multi query.
		"""
		try :
	...
	def dnstotarecqueries(self) :
		r"""Total number of A queries received.
		"""
		try :
	...
	def dnsserverresponserate(self) :
		r"""Rate (/s) counter for dnstotserverresponse.
		"""
		try :
	...
	def dnsnsresponserate(self) :
		r"""Rate (/s) counter for dnstotnsresponse.
		"""
		try :
	...
	def dnstotanswers(self) :
		r"""Total number of DNS responses received.
		"""
		try :
	...
	def dnsmxrecqueriesrate(self) :
		r"""Rate (/s) counter for dnstotmxrecqueries.
		"""
		try :
	...
	def dnstotcnamerecfailed(self) :
		r"""Total number of times CNAME record lookup failed.
		"""
		try :
	...
	def dnstotsrvrecqueries(self) :
		r"""Total number of SRV queries received.
		"""
		try :
	...
	def dnstotaresponse(self) :
		r"""Total number of A responses received.
		"""
		try :
	...
	def dnscnamerecqueriesrate(self) :
		r"""Rate (/s) counter for dnstotcnamerecqueries.
		"""
		try :
	...
	def dns64totnodataresp(self) :
		r"""Total number of responses recieved from backend with ancount 0.
		"""
		try :
	...
	def dnstotqueries(self) :
		r"""Total number of DNS queries received.
		"""
		try :
	...
	def dnstotsrvresponse(self) :
		r"""Total number of SRV responses received.
		"""
		try :
	...
	def dnstotunsupportedresponseclass(self) :
		r"""Total number of responses for which response types were unsupported.
		"""
		try :
	...
	@property
	def dnstotjumboanswers(self) :
		r"""Total number of Jumbo DNS responses sent over UDP.
		"""
		try :
			return self._dnstotjumboanswers
		except Exception as e:
			raise e

	@property
	def dnstotcacheflush(self) :
		r"""Total number of times cache was flushed.
		"""
		try :
	...
	def dnstotarecfailed(self) :
		r"""Total number of times A record lookup failed.
		"""
		try :
	...
	def dnstotsrvrecupdate(self) :
		r"""Total number of SRV record updates.
		"""
		try :
	...
	def dns64svraqueriesrate(self) :
		r"""Rate (/s) counter for dns64totsvraqueries.
		"""
		try :
	...
	def dnsserverqueryrate(self) :
		r"""Rate (/s) counter for dnstotserverquery.
		"""
		try :
	...
	@property
	def dnsjumboanswersrate(self) :
		r"""Rate (/s) counter for dnstotjumboanswers.
		"""
		try :
			return self._dnsjumboanswersrate
		except Exception as e:
			raise e

	@property
	def dnsjumboserverresponsesrate(self) :
		r"""Rate (/s) counter for dnstotjumboserverresponses.
		"""
		try :
			return self._dnsjumboserverresponsesrate
		except Exception as e:
			raise e

	@property
	def dnscurnsrecord(self) :
		r"""Total number of NS records.
		"""
		try :
	...
	def dnstotsoarecupdate(self) :
		r"""Total number of SOA record updates.
		"""
		try :
	...
	def dns64queriesrate(self) :
		r"""Rate (/s) counter for dns64totqueries.
		"""
		try :
	...
	def dnstotnonauthnodatas(self) :
		r"""Total number of responses for which there was a format error.
		"""
		try :
	...
	def dnstotauthans(self) :
		r"""Number of queries which were authoritatively answered.
		"""
		try :
	...
	def dnstotreqrefusals(self) :
		r"""Number of DNS requests refused.
		"""
		try :
	...
	def dns64tcanswersrate(self) :
		r"""Rate (/s) counter for dns64tottcanswers.
		"""
		try :
	...
	def dnstotrecupdate(self) :
		r"""Total number of record updates.
		"""
		try :
	...
	def dns64totgslbqueries(self) :
		r"""Total number of DNS64 queries for GSLB domain.
		"""
		try :
	...
	def dnstotnodataresps(self) :
		r"""Number of DNS responses received without answer.
		"""
		try :
	...
	def dnstotptrresponse(self) :
		r"""Total number of PTR responses received.
		"""
		try :
	...
	def dnsmxresponserate(self) :
		r"""Rate (/s) counter for dnstotmxresponse.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all dns_stats resources that are configured on netscaler.
