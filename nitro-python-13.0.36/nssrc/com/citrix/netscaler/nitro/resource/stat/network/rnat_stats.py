...
class rnat_stats(base_resource) :
	r""" Statistics for RNAT configured route resource.
	"""
	def __init__(self) :
	...
	def rnattottxpkts(self) :
		r"""Packets sent during RNAT sessions.
		"""
		try :
	...
	def rnatrxbytesrate(self) :
		r"""Rate (/s) counter for rnattotrxbytes.
		"""
		try :
	...
	def rnattxsynrate(self) :
		r"""Rate (/s) counter for rnattottxsyn.
		"""
		try :
	...
	def rnattxpktsrate(self) :
		r"""Rate (/s) counter for rnattottxpkts.
		"""
		try :
	...
	def rnattottxsyn(self) :
		r"""Requests for connections sent during RNAT sessions.
		"""
		try :
	...
	def rnattxbytesrate(self) :
		r"""Rate (/s) counter for rnattottxbytes.
		"""
		try :
	...
	def rnatrxpktsrate(self) :
		r"""Rate (/s) counter for rnattotrxpkts.
		"""
		try :
	...
	def rnatcursessions(self) :
		r"""Currently active RNAT sessions.
		"""
		try :
	...
	def rnattotrxpkts(self) :
		r"""Packets received during RNAT sessions.
		"""
		try :
	...
	def rnattotrxbytes(self) :
		r"""Bytes received during RNAT sessions.
		"""
		try :
	...
	def rnattottxbytes(self) :
		r"""Bytes sent during RNAT sessions.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all rnat_stats resources that are configured on netscaler.
