...
class sc_stats(base_resource) :
	...
	@property
	def scpopups(self) :
		r"""Total number of in-memory java script  served which throws the pop-up window.
		"""
		try :
	...
	def scfaultycookiesrate(self) :
		r"""Rate (/s) counter for scfaultycookies.
		"""
		try :
	...
	def screissuedrequestsrate(self) :
		r"""Rate (/s) counter for sctotreissuedrequests.
		"""
		try :
	...
	@property
	def scpostreqs(self) :
		r"""Total number of   HTTP POST requests that triggered SureConnect feature.
		"""
		try :
	...
	def scaltconturls(self) :
		r"""Total number of alternate content served which throws the pop-up window.
		"""
		try :
	...
	def scresetstatsrate(self) :
		r"""Rate (/s) counter for scresetstats.
		"""
		try :
	...
	def sctotreissuedrequests(self) :
		r"""Total number of reissued SureConnect requests.
		"""
		try :
	...
	def scunsupbrow(self) :
		r"""Total number of requests that came from all unsupported browsers.
		"""
		try :
	...
	def scpolicyurlhitsrate(self) :
		r"""Rate (/s) counter for scpolicyurlhits.
		"""
		try :
	...
	def sccondtriggeredrate(self) :
		r"""Rate (/s) counter for sctotcondtriggered.
		"""
		try :
	...
	def scpolicyurlhits(self) :
		r"""Total number of incoming requests that matched configured sureconnect policies.
		"""
		try :
	...
	def scsessionreqsrate(self) :
		r"""Rate (/s) counter for scsessionreqs.
		"""
		try :
	...
	def scresetstats(self) :
		r"""Toal number of times that SureConnect statistics were reset.
		"""
		try :
	...
	def sctotcondtriggered(self) :
		r"""Number of times that SureConnect conditions were triggered.
		"""
		try :
	...
	def scfaultycookies(self) :
		r"""Total number of corrupted SureConnect cookies.
		"""
		try :
	...
	def scsessionreqs(self) :
		r"""Total number of requests that were  handled in a single SureConnect session.
		"""
		try :
	...
	def scaltconturlsrate(self) :
		r"""Rate (/s) counter for scaltconturls.
		"""
		try :
	...
	def scunsupbrowrate(self) :
		r"""Rate (/s) counter for scunsupbrow.
		"""
		try :
	...
	def scpostreqsrate(self) :
		r"""Rate (/s) counter for scpostreqs.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all sc_stats resources that are configured on netscaler.
