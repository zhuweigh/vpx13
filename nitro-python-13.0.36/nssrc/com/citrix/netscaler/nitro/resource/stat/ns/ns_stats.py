...
class ns_stats(base_resource) :
	...
	def hacurmasterstate(self) :
		r"""Indicates the high availability state of the node. Possible values are: 
	...
	@property
	def starttime(self) :
		r"""Time when the Citrix ADC  was last started.
		"""
		try :
	...
	@property
	def transtime(self) :
		r"""Time when the last master state transition occurred. You can use this statistic for debugging.
		"""
		try :
	...
	@property
	def totrxmbits(self) :
		r"""Number of megabytes received by the Citrix ADC.
		"""
		try :
	...
	@property
	def tottxmbits(self) :
		r"""Number of megabytes transmitted by the Citrix ADC.
		"""
		try :
	...
	@property
	def numcpus(self) :
		r"""The number of CPUs on the Citrix ADC.
		"""
		try :
	...
	def txmbitsrate(self) :
		r"""Rate (/s) counter for tottxmbits.
		"""
		try :
	...
	@property
	def hacurstate(self) :
		r"""State of the HA node, based on its health, in a high availability setup. Possible values are: 
	...
	def rxmbitsrate(self) :
		r"""Rate (/s) counter for totrxmbits.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all ns_stats resources that are configured on netscaler.
