...
class ipseccounters_stats(base_resource) :
	...
	def ipsecrxbytesrate(self) :
		r"""Rate (/s) counter for ipsectotrxbytes.
		"""
		try :
	...
	def ipsectxbytesrate(self) :
		r"""Rate (/s) counter for ipsectottxbytes.
		"""
		try :
	...
	def ipsectottxbytes(self) :
		r"""Bytes sent during IPsec sessions.
		"""
		try :
	...
	def ipsecrxpktsrate(self) :
		r"""Rate (/s) counter for ipsectotrxpkts.
		"""
		try :
	...
	def ipsectotrxpkts(self) :
		r"""Packets received during IPsec sessions.
		"""
		try :
	...
	def ipsectottxpkts(self) :
		r"""Packets sent during IPsec sessions.
		"""
		try :
	...
	def ipsectotrxbytes(self) :
		r"""Bytes received during IPsec sessions.
		"""
		try :
	...
	def ipsectxpktsrate(self) :
		r"""Rate (/s) counter for ipsectottxpkts.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all ipseccounters_stats resources that are configured on netscaler.
