...
class protocolipv6_stats(base_resource) :
	...
	def ipv6toticmpnsrx(self) :
		r"""Number of ICMPv6 NS packets received by Citrix ADC (OBSOLETE).
		"""
		try :
	...
	def ipv6toticmpnarx(self) :
		r"""Number of ICMPv6 NA packets received by Citrix ADC (OBSOLETE).
		"""
		try :
	...
	def ipv6toticmpnatx(self) :
		r"""Number of ICMPv6 NA packets transmitted by Citrix ADC (OBSOLETE).
		"""
		try :
	...
	def ipv6toticmprstx(self) :
		r"""Number of ICMPv6 RS packets transmitted by Citrix ADC (OBSOLETE).
		"""
		try :
	...
	def ipv6toticmprx(self) :
		r"""Number of ICMPv6 packets received by Citrix ADC (OBSOLETE).
		"""
		try :
	...
	def ipv6toticmptx(self) :
		r"""Number of ICMPv6 packets transmitted by Citrix ADC (OBSOLETE).
		"""
		try :
	...
	def ipv6toticmpnstx(self) :
		r"""Number of ICMPv6 NS packets transmitted by Citrix ADC (OBSOLETE).
		"""
		try :
	...
	def ipv6toticmprarx(self) :
		r"""Number of ICMPv6 RA packets received by Citrix ADC (OBSOLETE).
		"""
		try :
