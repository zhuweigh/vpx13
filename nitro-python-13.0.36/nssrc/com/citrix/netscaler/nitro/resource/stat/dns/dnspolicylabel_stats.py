...
class dnspolicylabel_stats(base_resource) :
	r""" Statistics for dns policy label resource.
	"""
	def __init__(self) :
	...
	@property
	def labelname(self) :
		r"""The name of the dns policy label for which statistics will be displayed.  If not given statistics are shown for all dns policylabels.<br/>Minimum length =  1.
		"""
		try :
	...
	def labelname(self, labelname) :
		r"""The name of the dns policy label for which statistics will be displayed.  If not given statistics are shown for all dns policylabels.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all dnspolicylabel_stats resources that are configured on netscaler.
