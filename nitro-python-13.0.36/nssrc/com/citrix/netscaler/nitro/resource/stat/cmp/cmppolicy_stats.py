...
class cmppolicy_stats(base_resource) :
	r""" Statistics for compression policy resource.
	"""
	def __init__(self) :
		self._name = None
	...
	@property
	def name(self) :
		r"""Name of the advanced compression policy for which to display statistics. If no name is specified, statistics for all advanced compression polices are shown.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	@name.setter
	def name(self, name) :
		r"""Name of the advanced compression policy for which to display statistics. If no name is specified, statistics for all advanced compression polices are shown.
		"""
		try :
			self._name = name
		except Exception as e:
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all cmppolicy_stats resources that are configured on netscaler.
