...
class system_stats(base_resource) :
	...
	def starttimelocal(self) :
		r"""Time (in local timezone format) when the Citrix ADC  was last started.
		"""
		try :
			return self._starttimelocal
		except Exception as e:
			raise e
	...
	def timesincestart(self) :
		r"""Seconds since the Citrix ADC started.
		"""
		try :
