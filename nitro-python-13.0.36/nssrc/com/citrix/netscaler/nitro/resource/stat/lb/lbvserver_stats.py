...
class lbvserver_stats(base_resource) :
	...
	def __init__(self) :
		...
		self._curbackuppersistencesessions = 0
		self._surgecount = 0
		...
		self._totalsvrbusyerr = 0
		self._svrbusyerrrate = 0
		...
		self.videooptimizationpacingpolicy = []
		self.cachepolicy = []
	...
	@property
	def svrbusyerrrate(self) :
		r"""Rate (/s) counter for totalsvrbusyerr.
		"""
		try :
			return self._svrbusyerrrate
		except Exception as e:
			raise e
	...
	@property
	def totalsvrbusyerr(self) :
		r"""Total no of server busy error.
		"""
		try :
			return self._totalsvrbusyerr
		except Exception as e:
			raise e
	...
	@property
	def curbackuppersistencesessions(self) :
		r"""current vserver owned backup persistence sessions.
		"""
		try :
			return self._curbackuppersistencesessions
		except Exception as e:
			raise e
	...
	@property
	def videooptimizationdetectionpolicy(self) :
		r"""videooptimizationdetectionpolicy that are bound to lbvserver.
		"""
		try :
			return self._videooptimizationdetectionpolicy
		except Exception as e:
			raise e

	@videooptimizationdetectionpolicy.setter
	def videooptimizationdetectionpolicy(self, videooptimizationdetectionpolicy) :
		r"""videooptimizationdetectionpolicy that are bound to lbvserver.
		"""
		try :
			self._videooptimizationdetectionpolicy = videooptimizationdetectionpolicy
		except Exception as e:
			raise e
	...
	@property
	def contentinspectionpolicy(self) :
		r"""contentinspectionpolicy that are bound to lbvserver.
		"""
		try :
			return self._contentinspectionpolicy
		except Exception as e:
			raise e

	@contentinspectionpolicy.setter
	def contentinspectionpolicy(self, contentinspectionpolicy) :
		r"""contentinspectionpolicy that are bound to lbvserver.
		"""
		try :
			self._contentinspectionpolicy = contentinspectionpolicy
		except Exception as e:
			raise e

	@property
	def videooptimizationpacingpolicy(self) :
		r"""videooptimizationpacingpolicy that are bound to lbvserver.
		"""
		try :
			return self._videooptimizationpacingpolicy
		except Exception as e:
			raise e

	@videooptimizationpacingpolicy.setter
	def videooptimizationpacingpolicy(self, videooptimizationpacingpolicy) :
		r"""videooptimizationpacingpolicy that are bound to lbvserver.
		"""
		try :
			self._videooptimizationpacingpolicy = videooptimizationpacingpolicy
		except Exception as e:
			raise e
