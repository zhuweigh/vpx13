...
class cache_stats(base_resource) :
	...
	def cachehitsrate(self) :
		r"""Rate (/s) counter for cachetothits.
		"""
		try :
	...
	def cachepethitsrate(self) :
		r"""Rate (/s) counter for cachetotpethits.
		"""
		try :
	...
	def cachetotexpireatlastbyte(self) :
		r"""Instances of content expiring immediately after receiving the last body byte due to the Expire at Last Byte setting for the content group.
		"""
		try :
	...
	def cachenummarker(self) :
		r"""Marker objects created when a response exceeds the maximum or minimum size for entries in its content group or has not yet received the minimum number of hits required for items in its content group.
		"""
		try :
	...
	def cacheresponsebytesrate(self) :
		r"""Rate (/s) counter for cachetotresponsebytes.
		"""
		try :
	...
	def cacheutilizedmemorykb(self) :
		r"""Amount of memory the integrated cache is currently using.
		"""
		try :
	...
	def cachetotnonparameterizedinvalidationrequests(self) :
		r"""Requests that match an invalidation policy where the invalGroups parameter is configured and expires one or more content groups.
		"""
		try :
	...
	def cachepercentpethits(self) :
		r"""Percentage of cache hits in content groups that have Poll Every Time enabled, relative to all searches of content groups with Poll Every Time enabled. .
		"""
		try :
	...
	def cachebytesserved(self) :
		r"""Total number of bytes served from the integrated cache.
		"""
		try :
	...
	def cachetotparameterizednon304hits(self) :
		r"""Parameterized requests resulting in a full response (not status code 304: Object Not Updated) served from the cache.
		"""
		try :
	...
	def cachebytesservedrate(self) :
		r"""Rate (/s) counter for cachebytesserved.
		"""
		try :
	...
	def cachepercent304hits(self) :
		r"""304 responses as a percentage of all responses that the Citrix ADC served.
		"""
		try :
	...
	def cachepercentbytehit(self) :
		r"""Bytes served from the cache divided by total bytes served to the client. If compression is On in the Citrix ADC, this ratio may not reflect the bytes served by the compression module. If the compression is Off, this ratio is the same as cachePercentOriginBandwidthSaved.
		"""
		try :
	...
	def cachepercentstoreablemiss(self) :
		r"""Responses that were fetched from the origin, stored in the cache, and then served to the client, as a percentage of all cache misses.
		"""
		try :
	...
	def cachetotpetrequests(self) :
		r"""Requests that triggered a search of a content group that has Poll Every Time (PET) enabled (always consult the origin server before serving cached data).
		"""
		try :
	...
	def cachecompressedbytesserved(self) :
		r"""Number of compressed bytes served from the cache.
		"""
		try :
	...
	def cachetotresponsebytes(self) :
		r"""Total number of HTTP response bytes served by Citrix ADC from both the origin and the cache.
		"""
		try :
	...
	def cachelargestresponsereceived(self) :
		r"""Size, in bytes, of largest response sent to client from the cache or the origin server.
		"""
		try :
	...
	def cachenonparameterizedinvalidationrequestsrate(self) :
		r"""Rate (/s) counter for cachetotnonparameterizedinvalidationrequests.
		"""
		try :
	...
	def cacherecentpercentsuccessfulrevalidation(self) :
		r"""Recently recorded percentage of times stored content was successfully revalidated by a 304 response rather than by a full response.
		"""
		try :
	...
	def cachesuccessfulrevalidationrate(self) :
		r"""Rate (/s) counter for cachetotsuccessfulrevalidation.
		"""
		try :
	...
	def cachesqlhitsrate(self) :
		r"""Rate (/s) counter for cachetotsqlhits.
		"""
		try :
	...
	def cacherequestsrate(self) :
		r"""Rate (/s) counter for cachetotrequests.
		"""
		try :
	...
	def cachemissesrate(self) :
		r"""Rate (/s) counter for cachetotmisses.
		"""
		try :
	...
	def cachemaxmemorykb(self) :
		r"""Largest amount of memory the Citrix ADC can dedicate to caching, up to 50% of available memory. A 0 value disables caching, but the caching module continues to run. .
		"""
		try :
	...
	def cachenumcached(self) :
		r"""Responses currently in integrated cache. Includes responses fully downloaded, in the process of being downloaded, and expired or flushed but not yet removed.
		"""
		try :
	...
	def cachetothits(self) :
		r"""Responses served from the integrated cache. These responses match a policy with a CACHE action.
		"""
		try :
	...
	def cachetotsuccessfulrevalidation(self) :
		r"""Total number of times stored content was successfully revalidated by a 304 Not Modified response from the origin.
		"""
		try :
	...
	def cachepercentparameterized304hits(self) :
		r"""Percentage of parameterized 304 hits relative to all parameterized hits.
		"""
		try :
	...
	def cacheflashcachehitsrate(self) :
		r"""Rate (/s) counter for cachetotflashcachehits.
		"""
		try :
	...
	def cachestoreablemissesrate(self) :
		r"""Rate (/s) counter for cachetotstoreablemisses.
		"""
		try :
	...
	def cachetotflashcachehits(self) :
		r"""Number of requests to a content group with flash cache enabled that were cache hits. The flash cache setting queues requests that arrive simultaneously and distributes the response to all the clients in the queue.
		"""
		try :
	...
	def cachetotsqlhits(self) :
		r"""sql response served from cache.
		"""
		try :
	...
	def cachetotrevalidationmiss(self) :
		r"""Responses that an intervening cache revalidated with the integrated cache before serving, as determined by a Cache-Control: Max-Age header configurable in the integrated cache.
		"""
		try :
	...
	def cachemaxmemoryactivekb(self) :
		r"""Currently active value of maximum memory.
		"""
		try :
	...
	def cachetotstoreablemisses(self) :
		r"""Cache misses for which the fetched response is stored in the cache before serving it to the client. Storable misses conform to a built-in or user-defined caching policy that contains a CACHE action.
		"""
		try :
	...
	def cacheparameterizedhitsrate(self) :
		r"""Rate (/s) counter for cachetotparameterizedhits.
		"""
		try :
	...
	def cacheparameterized304hitsrate(self) :
		r"""Rate (/s) counter for cachetotparameterized304hits.
		"""
		try :
	...
	def cacheexpireatlastbyterate(self) :
		r"""Rate (/s) counter for cachetotexpireatlastbyte.
		"""
		try :
	...
	def cachecurmisses(self) :
		r"""Responses fetched from the origin and served from the cache. Should approximate storable misses. Does not include non-storable misses.
		"""
		try :
	...
	def cacherevalidationmissrate(self) :
		r"""Rate (/s) counter for cachetotrevalidationmiss.
		"""
		try :
	...
	def cachenon304hitsrate(self) :
		r"""Rate (/s) counter for cachetotnon304hits.
		"""
		try :
	...
	def cachepercentsuccessfulrevalidation(self) :
		r"""Percentage of times stored content was successfully revalidated by a 304 (Object Not Modifed) response rather than by a full response.
		"""
		try :
	...
	def cachetotnon304hits(self) :
		r"""Total number of full (non-304) responses served from the cache. A 304 status code indicates that a response has not been modified since the last time it was served.
		"""
		try :
	...
	def cachefulltoconditionalrequestrate(self) :
		r"""Rate (/s) counter for cachetotfulltoconditionalrequest.
		"""
		try :
	...
	def cacherecentpercentoriginbandwidthsaved(self) :
		r"""Bytes served from cache divided by total bytes served to client. This ratio can be greater than 1 because of the assumption that all compression has been done in the Citrix ADC.
		"""
		try :
	...
	def cacherecentpercentparameterizedhits(self) :
		r"""Recently recorded ratio of parameterized 304 hits to all parameterized hits expressed as a percentage.
		"""
		try :
	...
	def cachetotparameterizedinvalidationrequests(self) :
		r"""Requests matching a policy with an invalidation (INVAL) action and a content group that uses an invalidation selector or parameters.
		"""
		try :
	...
	def cachetotflashcachemisses(self) :
		r"""Number of requests to a content group with flash cache enabled that were cache misses. Flash cache distributes the response to all the clients in aqueue.
		"""
		try :
	...
	def cacheparameterizedrequestsrate(self) :
		r"""Rate (/s) counter for cachetotparameterizedrequests.
		"""
		try :
	...
	def cacheerrmemalloc(self) :
		r"""Total number of times the cache failed to allocate memory to store responses.
		"""
		try :
	...
	def cacherecentpercenthit(self) :
		r"""Recently recorded cache hit ratio expressed as percentage.
		"""
		try :
	...
	def cachecompressedbytesservedrate(self) :
		r"""Rate (/s) counter for cachecompressedbytesserved.
		"""
		try :
	...
	def cache304hitsrate(self) :
		r"""Rate (/s) counter for cachetot304hits.
		"""
		try :
	...
	def cachepercenthit(self) :
		r"""Cache hits as percentage of the total number of requests.
		"""
		try :
	...
	def cachenonstoreablemissesrate(self) :
		r"""Rate (/s) counter for cachetotnonstoreablemisses.
		"""
		try :
	...
	def cachetotinvalidationrequests(self) :
		r"""Requests that match an invalidation policy and result in expiration of specific cached responses or entire content groups.
		"""
		try :
	...
	def cachetot304hits(self) :
		r"""Object not modified responses served from the cache. (Status code 304 served instead of the full response.).
		"""
		try :
	...
	def cachetotfulltoconditionalrequest(self) :
		r"""Number of user-agent requests for a cached  Poll Every Time (PET) response that were sent to the origin server as conditional requests. .
		"""
		try :
	...
	def cachetotparameterizedhits(self) :
		r"""Parameterized requests resulting in either a 304 or non-304 hit.
		"""
		try :
	...
	def cachepetrequestsrate(self) :
		r"""Rate (/s) counter for cachetotpetrequests.
		"""
		try :
	...
	def cacherecentpercent304hits(self) :
		r"""Recently recorded ratio of 304 hits to all hits expressed as percentage.
		"""
		try :
	...
	def cachetotnonstoreablemisses(self) :
		r"""Cache misses for which the fetched response is not stored in the cache. These responses match policies with a NOCACHE action or are affected by Poll Every Time.
		"""
		try :
	...
	def cachetotparameterizedrequests(self) :
		r"""Total number of requests where the content group has hit and invalidation parameters or selectors.
		"""
		try :
	...
	def cachepercentoriginbandwidthsaved(self) :
		r"""Percentage of origin bandwidth saved, expressed as number of bytes served from the integrated cache divided by all bytes served. The assumption is that all compression is done in the Citrix ADC.
		"""
		try :
	...
	def cachetotrequests(self) :
		r"""Total cache hits plus total cache misses.
		"""
		try :
	...
	def cacheparameterizednon304hitsrate(self) :
		r"""Rate (/s) counter for cachetotparameterizednon304hits.
		"""
		try :
	...
	def cachetotmisses(self) :
		r"""Intercepted HTTP requests requiring fetches from origin server.
		"""
		try :
	...
	def cachetotpethits(self) :
		r"""Number of times a cache hit was found during a search of a content group that has Poll Every Time enabled.
		"""
		try :
	...
	def cacheparameterizedinvalidationrequestsrate(self) :
		r"""Rate (/s) counter for cachetotparameterizedinvalidationrequests.
		"""
		try :
	...
	def cacherecentpercentstoreablemiss(self) :
		r"""Recently recorded ratio of store-able misses to all misses expressed as percentage.
		"""
		try :
	...
	def cacheflashcachemissesrate(self) :
		r"""Rate (/s) counter for cachetotflashcachemisses.
		"""
		try :
	...
	def cacheinvalidationrequestsrate(self) :
		r"""Rate (/s) counter for cachetotinvalidationrequests.
		"""
		try :
	...
	def cachetotparameterized304hits(self) :
		r"""Parameterized requests resulting in an object not modified (status code 304) response. .
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all cache_stats resources that are configured on netscaler.
