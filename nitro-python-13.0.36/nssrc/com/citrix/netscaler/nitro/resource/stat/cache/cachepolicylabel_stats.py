...
class cachepolicylabel_stats(base_resource) :
	r""" Statistics for cache policy label resource.
	"""
	def __init__(self) :
	...
	@property
	def labelname(self) :
		r"""Name of the cache-policy label for which to display statistics. If you do not set this parameter statistics are shown for all cache-policy labels.<br/>Minimum length =  1.
		"""
		try :
	...
	def labelname(self, labelname) :
		r"""Name of the cache-policy label for which to display statistics. If you do not set this parameter statistics are shown for all cache-policy labels.
		"""
		try :
	...
	def cachepolicy(self) :
		r"""cachepolicy that are bound to cachepolicylabel.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all cachepolicylabel_stats resources that are configured on netscaler.
