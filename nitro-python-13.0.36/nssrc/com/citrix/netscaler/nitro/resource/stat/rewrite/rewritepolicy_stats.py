...
class rewritepolicy_stats(base_resource) :
	r""" Statistics for rewrite policy resource.
	"""
	def __init__(self) :
		self._name = None
	...
	@property
	def name(self) :
		r"""Name of the rewrite policy.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all rewritepolicy_stats resources that are configured on netscaler.
