...
class protocolicmpv6_stats(base_resource) :
	r""" Statistics for icmpv6 resource.
	"""
	def __init__(self) :
	...
	def icmpv6tottxns(self) :
		r"""ICMPv6 neighbor solicitation packets transmitted. These packets are sent to get the link layer addresses of neighboring nodes or to confirm that they are reachable.
		"""
		try :
	...
	def icmpv6txpktsrate(self) :
		r"""Rate (/s) counter for icmpv6tottxpkts.
		"""
		try :
	...
	def icmpv6unspt(self) :
		r"""ICMPv6 packets received that are not supported by the Citrix ADC.
		"""
		try :
	...
	def icmpv6totrxechoreply(self) :
		r"""ICMPv6 Ping Echo Reply packets received.
		"""
		try :
	...
	def icmpv6tottxra(self) :
		r"""ICMPv6 router advertisement packets transmitted. These packets are sent at regular intervals or in response to a router solicitation packet from a neighbor.
		"""
		try :
	...
	def icmpv6tottxechoreply(self) :
		r"""ICMP Ping Echo Reply packets transmitted.
		"""
		try :
	...
	def icmpv6badchecksums(self) :
		r"""Packets received with an ICMPv6 checksum error.
		"""
		try :
	...
	def icmpv6txnarate(self) :
		r"""Rate (/s) counter for icmpv6tottxna.
		"""
		try :
	...
	def icmpv6txrsrate(self) :
		r"""Rate (/s) counter for icmpv6tottxrs.
		"""
		try :
	...
	def icmpv6tottxna(self) :
		r"""ICMPv6 neighbor advertisement packets transmitted. These packets are sent in response to a neighbor solicitation packet, or if the link layer address of this node has changed.
		"""
		try :
	...
	def icmpv6totrxra(self) :
		r"""ICMPv6 router advertisement packets received. These are received at defined intervals or in response to a router solicitation message.
		"""
		try :
	...
	def icmpv6tottxrs(self) :
		r"""ICMPv6 router solicitation packets transmitted. These packets are sent to request neighboring routers to generate router advertisements immediately rather than wait for the next defined time.
		"""
		try :
	...
	def icmpv6rxpktsrate(self) :
		r"""Rate (/s) counter for icmpv6totrxpkts.
		"""
		try :
	...
	def icmpv6totrxns(self) :
		r"""ICMPv6 neighbor solicitation packets received. These packets are received if the link layer address of a neighbor has changed, or in response to a neighbor solicitation message sent out by this node.
		"""
		try :
	...
	def icmpv6rxechoreplyrate(self) :
		r"""Rate (/s) counter for icmpv6totrxechoreply.
		"""
		try :
	...
	def icmpv6txechoreqrate(self) :
		r"""Rate (/s) counter for icmpv6tottxechoreq.
		"""
		try :
	...
	def icmpv6rxrsrate(self) :
		r"""Rate (/s) counter for icmpv6totrxrs.
		"""
		try :
	...
	def icmpv6errna(self) :
		r"""ICMPv6 neighbor advertisement error packets received that contain an error in the header, such as an incorrect source IP address, destination IP address, or packet length.
		"""
		try :
	...
	def icmpv6rxnsrate(self) :
		r"""Rate (/s) counter for icmpv6totrxns.
		"""
		try :
	...
	def icmpv6rxbytesrate(self) :
		r"""Rate (/s) counter for icmpv6totrxbytes.
		"""
		try :
	...
	def icmpv6rtthsld(self) :
		r"""Packets dropped because the default threshold of 100 requests per 10 milliseconds has been exceeded.
	...
	def icmpv6totrxrs(self) :
		r"""ICMPv6 router solicitation packets received. These could be sent by a neighboring router to initiate address resolution.
		"""
		try :
	...
	def icmpv6totrxna(self) :
		r"""ICMPv6 neighbor advertisement packets received. These packets are received in response to a neighbor solicitation message sent out by this node, or if the link layer address of a neighbor has changed.
		"""
		try :
	...
	def icmpv6txechoreplyrate(self) :
		r"""Rate (/s) counter for icmpv6tottxechoreply.
		"""
		try :
	...
	def icmpv6totrxbytes(self) :
		r"""Bytes of ICMPv6 data received.
		"""
		try :
	...
	def icmpv6txrarate(self) :
		r"""Rate (/s) counter for icmpv6tottxra.
		"""
		try :
	...
	def icmpv6errns(self) :
		r"""ICMPv6 neighbor solicitation error packets received that contain an error in the header, such as an incorrect source IP address, destination IP address, or packet length.
		"""
		try :
	...
	def icmpv6totrxechoreq(self) :
		r"""ICMPv6 Ping Echo Request packets received.
		"""
		try :
	...
	def icmpv6tottxechoreq(self) :
		r"""ICMPv6 Ping Echo Request packets transmitted.
		"""
		try :
	...
	def icmpv6rxrarate(self) :
		r"""Rate (/s) counter for icmpv6totrxra.
		"""
		try :
	...
	def icmpv6rxechoreqrate(self) :
		r"""Rate (/s) counter for icmpv6totrxechoreq.
		"""
		try :
	...
	def icmpv6tottxbytes(self) :
		r"""Bytes of ICMPv6 data transmitted.
		"""
		try :
	...
	def icmpv6rxnarate(self) :
		r"""Rate (/s) counter for icmpv6totrxna.
		"""
		try :
	...
	def icmpv6txnsrate(self) :
		r"""Rate (/s) counter for icmpv6tottxns.
		"""
		try :
	...
	def icmpv6errra(self) :
		r"""ICMPv6 router advertisement error packets received that contain an error in the header, such as an incorrect source IP address, destination IP address, or packet length.
		"""
		try :
	...
	def icmpv6txbytesrate(self) :
		r"""Rate (/s) counter for icmpv6tottxbytes.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all protocolicmpv6_stats resources that are configured on netscaler.
