...
class qos_stats(base_resource) :
	def __init__(self) :
		...
		self._snmpqosqos_flows_available = 0
		self._snmpqosqos_flows_availablerate = 0
		...
		self._snmpqosqos_error_no_flows = 0
		self._snmpqosqos_error_no_flowsrate = 0
		self._snmpqosqos_error_no_sessions = 0
		self._snmpqosqos_error_no_sessionsrate = 0
	...
	@property
	def snmpqosqos_error_no_sessions(self) :
		r"""Libqos out of session memory.
		"""
		try :
			return self._snmpqosqos_error_no_sessions
		except Exception as e:
			raise e

	@property
	def snmpqosqos_flows_available(self) :
		r"""Flows free list size.
		"""
		try :
			return self._snmpqosqos_flows_available
		except Exception as e:
			raise e
	...
	def snmpqosqos_recycle_failed_backlog(self) :
		r"""Recycle failed due to backlog.
		"""
		try :
	...
	@property
	def snmpqosqos_flows_availablerate(self) :
		r"""Rate (/s) counter for snmpqosqos_flows_available.
		"""
		try :
			return self._snmpqosqos_flows_availablerate
		except Exception as e:
			raise e
	...
	def snmpqosqos_recycle_failed_session(self) :
		r"""Recycle failed due to session attachment.
		"""
		try :
	...
	@property
	def snmpqosqos_error_no_sessionsrate(self) :
		r"""Rate (/s) counter for snmpqosqos_error_no_sessions.
		"""
		try :
			return self._snmpqosqos_error_no_sessionsrate
		except Exception as e:
			raise e
	...
	@property
	def snmpqosqos_error_no_flowsrate(self) :
		r"""Rate (/s) counter for snmpqosqos_error_no_flows.
		"""
		try :
			return self._snmpqosqos_error_no_flowsrate
		except Exception as e:
			raise e
	...
	@property
	def snmpqosqos_error_no_flows(self) :
		r"""Libqos out of flow memory.
		"""
		try :
			return self._snmpqosqos_error_no_flows
		except Exception as e:
			raise e
