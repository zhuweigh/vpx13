...
class dnsrecords_stats(base_resource) :
	...
	def dnsrecordtype(self) :
		r"""Display statistics for the specified DNS record or query type or, if a record or query type is not specified, statistics for all record types supported on the Citrix ADC.
		"""
		try :
	...
	def dnscurentries(self) :
		r"""Current number of DNS entries.
		"""
		try :
	...
	def dnstotupdates(self) :
		r"""Total number of DNS proactive updates.
		"""
		try :
	...
	def dnstotrequests(self) :
		r"""Total number of DNS queries recieved.
		"""
		try :
	...
	def dnstoterraliasex(self) :
		r"""Total number of times we have recieved non-cname record for a domain for which an alias exists.
		"""
		try :
	...
	def dnstoterrrespform(self) :
		r"""Total number of times we have recieved malformed responses from the backend.
		"""
		try :
	...
	def dnstotentries(self) :
		r"""Total number of DNS record entries.
		"""
		try :
	...
	def dnscurrecords(self) :
		r"""Current number of DNS Records.
		"""
		try :
	...
	def dnstoterrnodomains(self) :
		r"""Total number of cache misses.
		"""
		try :
	...
	def dnstoterrlimits(self) :
		r"""Total number of times we have recieved dns record with more entries than we support.
		"""
		try :
	...
	def dnstotresponses(self) :
		r"""Total number of DNS server responses.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all dnsrecords_stats resources that are configured on netscaler.
