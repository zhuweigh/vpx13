...
class responderpolicy_stats(base_resource) :
	r""" Statistics for responder policy resource.
	"""
	def __init__(self) :
		self._name = None
	...
	@property
	def name(self) :
		r"""Name of the responder policy for which to show detailed statistics.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	@name.setter
	def name(self, name) :
		r"""Name of the responder policy for which to show detailed statistics.
		"""
		try :
			self._name = name
		except Exception as e:
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all responderpolicy_stats resources that are configured on netscaler.
