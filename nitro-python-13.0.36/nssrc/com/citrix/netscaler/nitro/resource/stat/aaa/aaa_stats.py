...
class aaa_stats(base_resource) :
	...
	def aaatotsessiontimeout(self) :
		r"""Count of AAA sessions that have timed out.
		"""
		try :
	...
	def aaaauthfail(self) :
		r"""Count of authentication failures.
		"""
		try :
	...
	def aaaauthsuccess(self) :
		r"""Count of authentication successes.
		"""
		try :
	...
	def aaaauthonlyhttpfailrate(self) :
		r"""Rate (/s) counter for aaaauthonlyhttpfail.
		"""
		try :
	...
	def aaaauthnonhttpsuccess(self) :
		r"""Count of non HTTP connections that succeeded authorization.
		"""
		try :
	...
	def aaacuricaonlyconnrate(self) :
		r"""Rate (/s) counter for aaacuricaonlyconn.
		"""
		try :
	...
	def aaaauthonlyhttpsuccessrate(self) :
		r"""Rate (/s) counter for aaaauthonlyhttpsuccess.
		"""
		try :
	...
	def aaacurtmsessions(self) :
		r"""Count of current AAATM sessions.
		"""
		try :
	...
	def aaacuricasessions(self) :
		r"""Count of current Basic ICA only sessions.
		"""
		try :
	...
	def aaatotsessions(self) :
		r"""Count of all SmartAccess AAA sessions.
		"""
		try :
	...
	def aaaauthonlyhttpfail(self) :
		r"""Count of HTTP connections that failed authorization.
		"""
		try :
	...
	def aaacuricaonlyconn(self) :
		r"""Count of current Basic ICA only connections.
		"""
		try :
	...
	def aaatmsessionsrate(self) :
		r"""Rate (/s) counter for aaatottmsessions.
		"""
		try :
	...
	def aaaauthfailrate(self) :
		r"""Rate (/s) counter for aaaauthfail.
		"""
		try :
	...
	def aaacursessionsrate(self) :
		r"""Rate (/s) counter for aaacursessions.
		"""
		try :
	...
	def aaaauthnonhttpsuccessrate(self) :
		r"""Rate (/s) counter for aaaauthnonhttpsuccess.
		"""
		try :
	...
	def aaacuricaconn(self) :
		r"""Count of current SmartAccess ICA connections.
		"""
		try :
	...
	def aaaauthnonhttpfailrate(self) :
		r"""Rate (/s) counter for aaaauthnonhttpfail.
		"""
		try :
	...
	def aaaauthnonhttpfail(self) :
		r"""Count of non HTTP connections that failed authorization.
		"""
		try :
	...
	def aaacuricaconnrate(self) :
		r"""Rate (/s) counter for aaacuricaconn.
		"""
		try :
	...
	def aaaauthsuccessrate(self) :
		r"""Rate (/s) counter for aaaauthsuccess.
		"""
		try :
	...
	def aaaauthonlyhttpsuccess(self) :
		r"""Count of HTTP connections that succeeded authorization.
		"""
		try :
	...
	def aaacurtmsessionsrate(self) :
		r"""Rate (/s) counter for aaacurtmsessions.
		"""
		try :
	...
	def aaasessiontimeoutrate(self) :
		r"""Rate (/s) counter for aaatotsessiontimeout.
		"""
		try :
	...
	def aaacuricasessionsrate(self) :
		r"""Rate (/s) counter for aaacuricasessions.
		"""
		try :
	...
	def aaacursessions(self) :
		r"""Count of current SmartAccess AAA sessions.
		"""
		try :
	...
	def aaasessionsrate(self) :
		r"""Rate (/s) counter for aaatotsessions.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all aaa_stats resources that are configured on netscaler.
