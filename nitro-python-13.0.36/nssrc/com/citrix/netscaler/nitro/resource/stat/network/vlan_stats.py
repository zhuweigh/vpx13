...
class vlan_stats(base_resource) :
	r""" Statistics for "VLAN" resource.
	"""
	def __init__(self) :
		self._id = None
	...
	@property
	def id(self) :
		r"""An integer specifying the VLAN identification number (VID). Possible values: 1 through 4094.<br/>Minimum value =  1<br/>Maximum value =  4094.
		"""
		try :
			return self._id
	...
	def vlanrxbytesrate(self) :
		r"""Rate (/s) counter for vlantotrxbytes.
		"""
		try :
	...
	def vlantottxpkts(self) :
		r"""Packets transmitted on the VLAN.
		"""
		try :
	...
	def vlantotdroppedpkts(self) :
		r"""Inbound packets dropped by the VLAN upon reception.
		"""
		try :
	...
	def vlanrxpktsrate(self) :
		r"""Rate (/s) counter for vlantotrxpkts.
		"""
		try :
	...
	def vlantotrxpkts(self) :
		r"""Packets received on the VLAN.
		"""
		try :
	...
	def vlantotbroadcastpkts(self) :
		r"""Broadcast packets sent and received on the VLAN.
		"""
		try :
	...
	def vlantxbytesrate(self) :
		r"""Rate (/s) counter for vlantottxbytes.
		"""
		try :
	...
	def vlantotrxbytes(self) :
		r"""Bytes of data received on the VLAN.
		"""
		try :
	...
	def vlantxpktsrate(self) :
		r"""Rate (/s) counter for vlantottxpkts.
		"""
		try :
	...
	def vlantottxbytes(self) :
		r"""Bytes of data transmitted on the VLAN.
		"""
		try :
	...
	@property
	def Interface(self) :
		r"""Interface that are bound to vlan.
		"""
		try :
	...
	def  get(cls, service, name="", option_="") :
		r""" Use this API to fetch the statistics of all vlan_stats resources that are configured on netscaler.
